...
wire   [31:0] co_cast5_fu_210_p1;
reg   [31:0] co_cast5_reg_592;
wire    ap_CS_fsm_state2;
wire   [3:0] co_32_fu_228_p2;
reg   [3:0] co_32_reg_600;
reg   [31:0] weight_V_addr_reg_605;
wire   [0:0] exitcond21_fu_222_p2;
wire   [9:0] ci_8_fu_260_p2;
reg   [9:0] ci_8_reg_614;
wire    ap_CS_fsm_state10;
wire   [0:0] exitcond_fu_254_p2;
reg   [7:0] weight_V_addr_read_reg_629;
reg   [7:0] avgpool_output_V_loa_reg_634;
wire   [15:0] p_Val2_63_fu_272_p2;
reg   [15:0] p_Val2_63_reg_639;
wire    ap_CS_fsm_state12;
reg   [0:0] tmp_1526_reg_644;
wire   [15:0] p_Val2_64_fu_298_p2;
reg   [15:0] p_Val2_64_reg_649;
wire    ap_CS_fsm_state13;
reg   [0:0] signbit_reg_654;
wire   [7:0] p_Val2_66_fu_332_p2;
reg   [7:0] p_Val2_66_reg_661;
wire   [0:0] newsignbit_fu_338_p3;
reg   [0:0] newsignbit_reg_667;
wire   [0:0] carry_fu_352_p2;
reg   [0:0] carry_reg_673;
reg   [1:0] tmp_108_reg_680;
wire   [0:0] p_38_i_i_fu_410_p2;
reg   [0:0] p_38_i_i_reg_686;
wire    ap_CS_fsm_state14;
wire   [0:0] tmp_145_fu_426_p2;
reg   [0:0] tmp_145_reg_691;
wire   [0:0] brmerge40_demorgan_i_fu_437_p2;
reg   [0:0] brmerge40_demorgan_i_reg_696;
wire   [0:0] underflow_fu_454_p2;
reg   [0:0] underflow_reg_701;
wire   [0:0] brmerge_i_i_i_fu_459_p2;
reg   [0:0] brmerge_i_i_i_reg_706;
wire   [7:0] sum_V_fu_486_p3;
wire    ap_CS_fsm_state15;
reg   [7:0] p_Val2_60_reg_716;
wire    ap_CS_fsm_state16;
wire   [7:0] result_1_fu_574_p3;
reg   [7:0] result_1_reg_722;
wire    ap_CS_fsm_state17;
reg   [3:0] co_reg_169;
reg    ap_sig_ioackin_m_axi_output_V_WREADY;
reg   [7:0] p_Val2_s_reg_180;
wire    ap_CS_fsm_state9;
reg   [9:0] ci_reg_192;
wire   [31:0] ci_cast4_fu_249_p1;
wire   [31:0] tmp_1522_fu_238_p2;
...
wire   [12:0] tmp_534_fu_214_p3;
wire   [31:0] tmp_1521_fu_234_p1;
wire  signed [7:0] p_Val2_63_fu_272_p0;
wire  signed [7:0] p_Val2_63_fu_272_p1;
wire   [13:0] tmp_136_fu_286_p3;
wire  signed [15:0] tmp_136_cast_fu_294_p1;
wire   [7:0] tmp_139_fu_321_p1;
wire   [7:0] p_Val2_65_fu_311_p4;
wire   [0:0] tmp_1527_fu_324_p3;
wire   [0:0] tmp_142_fu_346_p2;
wire   [0:0] Range1_all_ones_fu_375_p2;
wire   [0:0] Range1_all_zeros_fu_380_p2;
wire   [0:0] tmp_1529_fu_368_p3;
wire   [0:0] tmp_143_fu_392_p2;
wire   [0:0] p_41_i_i_fu_398_p2;
wire   [0:0] deleted_zeros_fu_385_p3;
wire   [0:0] p_not_i_i_fu_415_p2;
wire   [0:0] brmerge_i_i6_fu_421_p2;
wire   [0:0] deleted_ones_fu_403_p3;
wire   [0:0] tmp2_demorgan_fu_442_p2;
wire   [0:0] tmp2_fu_448_p2;
wire   [0:0] overflow_fu_431_p2;
wire   [0:0] tmp3_fu_465_p2;
wire   [0:0] underflow_not_fu_469_p2;
wire   [7:0] p_Val2_119_mux_fu_474_p3;
wire   [7:0] p_Val2_s_353_fu_480_p3;
wire  signed [8:0] tmp_s_fu_498_p1;
wire  signed [8:0] tmp_fu_494_p1;
wire   [8:0] p_Val2_61_fu_501_p2;
wire   [7:0] result_V_fu_515_p2;
wire   [0:0] newsignbit_10_fu_520_p3;
wire   [0:0] isneg_fu_507_p3;
wire   [0:0] tmp_141_fu_528_p2;
wire   [0:0] isneg_not_fu_546_p2;
wire   [0:0] brmerge_i_i_fu_540_p2;
wire   [0:0] underflow_10_fu_534_p2;
wire   [0:0] brmerge1_fu_552_p2;
wire   [7:0] result_V_mux_fu_558_p3;
wire   [7:0] p_result_V_fu_566_p3;
reg   [21:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        ...
        newsignbit_reg_667 <= p_Val2_66_fu_332_p2[32'd7];
        p_Val2_64_reg_649 <= p_Val2_64_fu_298_p2;
        p_Val2_66_reg_661 <= p_Val2_66_fu_332_p2;
        signbit_reg_654 <= p_Val2_64_fu_298_p2[32'd15];
        tmp_108_reg_680 <= {{p_Val2_64_fu_298_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        co_cast5_reg_592[3 : 0] <= co_cast5_fu_210_p1[3 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        tmp_1526_reg_644 <= p_Val2_63_fu_272_p2[32'd5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == exitcond21_fu_222_p2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (exitcond21_fu_222_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state10 : begin
            if (((1'b1 == ap_CS_fsm_state10) & (exitcond_fu_254_p2 == 1'd1))) begin
...
assign Range1_all_ones_fu_375_p2 = ((tmp_108_reg_680 == 2'd3) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_380_p2 = ((tmp_108_reg_680 == 2'd0) ? 1'b1 : 1'b0);
...
assign avgpool_output_V_address0 = ci_cast4_fu_249_p1;

assign bias_V_address0 = co_cast5_reg_592;

assign brmerge1_fu_552_p2 = (newsignbit_10_fu_520_p3 | isneg_not_fu_546_p2);

assign brmerge40_demorgan_i_fu_437_p2 = (newsignbit_reg_667 & deleted_ones_fu_403_p3);

assign brmerge_i_i6_fu_421_p2 = (newsignbit_reg_667 | p_not_i_i_fu_415_p2);

assign brmerge_i_i_fu_540_p2 = (isneg_fu_507_p3 ^ newsignbit_10_fu_520_p3);

assign brmerge_i_i_i_fu_459_p2 = (underflow_fu_454_p2 | overflow_fu_431_p2);

assign carry_fu_352_p2 = (tmp_1527_fu_324_p3 & tmp_142_fu_346_p2);

assign ci_8_fu_260_p2 = (ci_reg_192 + 10'd1);

assign ci_cast4_fu_249_p1 = ci_reg_192;

assign co_32_fu_228_p2 = (co_reg_169 + 4'd1);

assign co_cast5_fu_210_p1 = co_reg_169;

assign deleted_ones_fu_403_p3 = ((carry_reg_673[0:0] === 1'b1) ? p_41_i_i_fu_398_p2 : Range1_all_ones_fu_375_p2);

assign deleted_zeros_fu_385_p3 = ((carry_reg_673[0:0] === 1'b1) ? Range1_all_ones_fu_375_p2 : Range1_all_zeros_fu_380_p2);

assign exitcond21_fu_222_p2 = ((co_reg_169 == 4'd10) ? 1'b1 : 1'b0);

assign exitcond_fu_254_p2 = ((ci_reg_192 == 10'd512) ? 1'b1 : 1'b0);

assign isneg_fu_507_p3 = p_Val2_61_fu_501_p2[32'd8];

assign isneg_not_fu_546_p2 = (isneg_fu_507_p3 ^ 1'd1);
...
assign m_axi_output_V_AWADDR = fc_output_V29;
...
assign m_axi_output_V_WDATA = result_1_reg_722;
...
assign m_axi_weight_V_ARADDR = weight_V_addr_reg_605;
...
assign newsignbit_10_fu_520_p3 = result_V_fu_515_p2[32'd7];

assign newsignbit_fu_338_p3 = p_Val2_66_fu_332_p2[32'd7];

assign overflow_fu_431_p2 = (brmerge_i_i6_fu_421_p2 & tmp_145_fu_426_p2);

assign p_38_i_i_fu_410_p2 = (carry_reg_673 & Range1_all_ones_fu_375_p2);

assign p_41_i_i_fu_398_p2 = (signbit_reg_654 & tmp_143_fu_392_p2);

assign p_Val2_119_mux_fu_474_p3 = ((brmerge_i_i_i_reg_706[0:0] === 1'b1) ? 8'd127 : p_Val2_66_reg_661);

assign p_Val2_61_fu_501_p2 = ($signed(tmp_s_fu_498_p1) + $signed(tmp_fu_494_p1));

assign p_Val2_63_fu_272_p0 = avgpool_output_V_loa_reg_634;

assign p_Val2_63_fu_272_p1 = weight_V_addr_read_reg_629;

assign p_Val2_63_fu_272_p2 = ($signed(p_Val2_63_fu_272_p0) * $signed(p_Val2_63_fu_272_p1));

assign p_Val2_64_fu_298_p2 = ($signed(p_Val2_63_reg_639) + $signed(tmp_136_cast_fu_294_p1));

assign p_Val2_65_fu_311_p4 = {{p_Val2_64_fu_298_p2[13:6]}};

assign p_Val2_66_fu_332_p2 = (tmp_139_fu_321_p1 + p_Val2_65_fu_311_p4);

assign p_Val2_s_353_fu_480_p3 = ((underflow_reg_701[0:0] === 1'b1) ? 8'd128 : p_Val2_66_reg_661);

assign p_not_i_i_fu_415_p2 = (deleted_zeros_fu_385_p3 ^ 1'd1);

assign p_result_V_fu_566_p3 = ((underflow_10_fu_534_p2[0:0] === 1'b1) ? 8'd128 : result_V_fu_515_p2);

assign result_1_fu_574_p3 = ((brmerge1_fu_552_p2[0:0] === 1'b1) ? result_V_mux_fu_558_p3 : p_result_V_fu_566_p3);

assign result_V_fu_515_p2 = (p_Val2_60_reg_716 + p_Val2_s_reg_180);

assign result_V_mux_fu_558_p3 = ((brmerge_i_i_fu_540_p2[0:0] === 1'b1) ? 8'd127 : result_V_fu_515_p2);

assign sum_V_fu_486_p3 = ((underflow_not_fu_469_p2[0:0] === 1'b1) ? p_Val2_119_mux_fu_474_p3 : p_Val2_s_353_fu_480_p3);

assign tmp2_demorgan_fu_442_p2 = (p_38_i_i_fu_410_p2 | brmerge40_demorgan_i_fu_437_p2);

assign tmp2_fu_448_p2 = (tmp2_demorgan_fu_442_p2 ^ 1'd1);

assign tmp3_fu_465_p2 = (brmerge40_demorgan_i_reg_696 | tmp_145_reg_691);

assign tmp_136_cast_fu_294_p1 = $signed(tmp_136_fu_286_p3);

assign tmp_136_fu_286_p3 = {{p_Val2_s_reg_180}, {6'd0}};

assign tmp_139_fu_321_p1 = tmp_1526_reg_644;

assign tmp_141_fu_528_p2 = (newsignbit_10_fu_520_p3 ^ 1'd1);

assign tmp_142_fu_346_p2 = (newsignbit_fu_338_p3 ^ 1'd1);

assign tmp_143_fu_392_p2 = (tmp_1529_fu_368_p3 ^ 1'd1);

assign tmp_145_fu_426_p2 = (signbit_reg_654 ^ 1'd1);

assign tmp_1521_fu_234_p1 = tmp_534_fu_214_p3;

assign tmp_1522_fu_238_p2 = (tmp_1521_fu_234_p1 + fc_weight_V25);

assign tmp_1527_fu_324_p3 = p_Val2_64_fu_298_p2[32'd13];

assign tmp_1529_fu_368_p3 = p_Val2_64_reg_649[32'd14];

assign tmp_534_fu_214_p3 = {{co_reg_169}, {9'd0}};

assign tmp_fu_494_p1 = $signed(p_Val2_s_reg_180);

assign tmp_s_fu_498_p1 = $signed(p_Val2_60_reg_716);

assign underflow_10_fu_534_p2 = (isneg_fu_507_p3 & tmp_141_fu_528_p2);

assign underflow_fu_454_p2 = (signbit_reg_654 & tmp2_fu_448_p2);

assign underflow_not_fu_469_p2 = (tmp3_fu_465_p2 | p_38_i_i_reg_686);

always @ (posedge ap_clk) begin
    co_cast5_reg_592[31:4] <= 28'b0000000000000000000000000000;
end
