...
u8 image[1][3][32][32] = {0};

u8 fc_output[10] = {0};

u8 conv1_weight[24][3][3][3] = {0};

u8 conv_last_weight[512][192][1][1] = {0};

u8 fc_weight[10][512] = {0};

u8 bias[3618] = {0};

u8 shuffle_conv_1x1[5496][24][1][1] = {0};

u8 shuffle_conv_3x3[1080][1][3][3] = {0};
...
//------------new parse-----------
	...
	XShufflenetv2_Set_conv_last_weight_V(&accelerator, (u32)conv_last_weight);
