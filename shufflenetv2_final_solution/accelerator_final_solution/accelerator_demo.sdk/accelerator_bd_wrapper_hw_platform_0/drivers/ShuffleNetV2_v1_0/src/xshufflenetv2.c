...
void XShufflenetv2_Set_conv_last_weight_0_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_0_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_0_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_0_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_1_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_1_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_1_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_1_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_2_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_2_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_2_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_2_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_3_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_3_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_3_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_3_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_4_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_4_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_4_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_4_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_5_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_5_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_5_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_5_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_6_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_6_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_6_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_6_V_DATA);
    return Data;
}

void XShufflenetv2_Set_conv_last_weight_7_V(XShufflenetv2 *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XShufflenetv2_WriteReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_7_V_DATA, Data);
}

u32 XShufflenetv2_Get_conv_last_weight_7_V(XShufflenetv2 *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XShufflenetv2_ReadReg(InstancePtr->Ctl_BaseAddress, XSHUFFLENETV2_CTL_ADDR_CONV_LAST_WEIGHT_7_V_DATA);
    return Data;
}
