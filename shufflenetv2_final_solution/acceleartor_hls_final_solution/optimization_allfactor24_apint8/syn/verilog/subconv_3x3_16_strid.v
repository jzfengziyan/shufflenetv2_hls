...
wire   [10:0] tmp_134_fu_228_p2;
reg   [10:0] tmp_134_reg_530;
wire    ap_CS_fsm_state2;
wire  signed [9:0] tmp_171_cast_fu_252_p1;
reg  signed [9:0] tmp_171_cast_reg_535;
wire   [9:0] tmp_138_fu_268_p2;
reg   [9:0] tmp_138_reg_540;
wire   [5:0] co_5_fu_280_p2;
reg   [5:0] co_5_reg_548;
reg   [5:0] bias_V_addr_reg_553;
wire   [0:0] exitcond8_fu_274_p2;
wire   [13:0] tmp_140_fu_319_p2;
reg   [13:0] tmp_140_reg_558;
...
wire   [9:0] tmp_143_fu_388_p2;
reg   [9:0] tmp_143_reg_589;
wire    ap_CS_fsm_state5;
wire   [1:0] m_5_fu_400_p2;
reg   [1:0] m_5_reg_597;
wire   [14:0] tmp_145_fu_450_p2;
reg   [14:0] tmp_145_reg_602;
...
reg  signed [7:0] input_V_load_reg_635;
...
wire   [31:0] tmp_179_cast_fu_348_p1;
wire   [31:0] tmp_187_cast_fu_471_p1;
wire   [31:0] tmp_188_cast_fu_512_p1;
wire   [9:0] tmp_132_fu_200_p3;
wire   [6:0] tmp_133_fu_212_p3;
wire   [10:0] p_shl4_cast_fu_224_p1;
wire   [10:0] p_shl3_cast_fu_208_p1;
wire   [7:0] tmp_135_fu_234_p3;
wire   [8:0] p_shl2_cast_fu_242_p1;
wire   [8:0] co_cast7_cast_fu_196_p1;
wire   [8:0] tmp_136_fu_246_p2;
wire   [8:0] tmp_137_fu_256_p3;
wire   [9:0] p_shl4_cast1_fu_220_p1;
wire   [9:0] p_shl_cast_fu_264_p1;
wire   [9:0] h_cast6_cast_fu_286_p1;
wire   [9:0] tmp_139_fu_290_p2;
wire   [12:0] tmp_94_fu_295_p3;
wire   [10:0] tmp_95_fu_307_p3;
wire   [13:0] p_shl5_cast_fu_303_p1;
wire   [13:0] p_shl6_cast_fu_315_p1;
wire   [13:0] w_cast5_cast_fu_339_p1;
wire   [13:0] tmp_141_fu_343_p2;
wire   [9:0] m_cast4_cast_fu_373_p1;
wire   [9:0] tmp_142_fu_377_p2;
wire   [9:0] tmp_96_fu_382_p2;
wire   [1:0] tmp1_fu_406_p2;
wire  signed [4:0] tmp1_cast_fu_412_p1;
wire   [4:0] tmp_7_fu_416_p2;
wire   [10:0] tmp_7_cast_cast_fu_421_p1;
wire   [10:0] tmp_144_fu_425_p2;
wire   [11:0] tmp_97_fu_438_p3;
wire   [14:0] p_shl8_cast_fu_430_p3;
wire   [14:0] p_shl9_cast_fu_446_p1;
wire   [9:0] n_cast3_cast_fu_462_p1;
wire   [9:0] tmp_146_fu_466_p2;
wire   [1:0] tmp2_fu_488_p2;
wire  signed [4:0] tmp2_cast_fu_494_p1;
wire   [4:0] tmp_8_fu_498_p2;
wire   [14:0] tmp_8_cast_cast_fu_503_p1;
wire   [14:0] tmp_147_fu_507_p2;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_134_reg_530[10 : 1] <= tmp_134_fu_228_p2[10 : 1];
        tmp_138_reg_540[9 : 1] <= tmp_138_fu_268_p2[9 : 1];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        output_V_addr_reg_571 <= tmp_179_cast_fu_348_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        tmp_140_reg_558[13 : 1] <= tmp_140_fu_319_p2[13 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond4_fu_394_p2))) begin
        tmp_145_reg_602[14 : 1] <= tmp_145_fu_450_p2[14 : 1];
    end
end
...
assign input_V_address0 = tmp_188_cast_fu_512_p1;
...
assign p_shl2_cast_fu_242_p1 = tmp_135_fu_234_p3;

assign p_shl3_cast_fu_208_p1 = tmp_132_fu_200_p3;

assign p_shl4_cast1_fu_220_p1 = tmp_133_fu_212_p3;

assign p_shl4_cast_fu_224_p1 = tmp_133_fu_212_p3;

assign p_shl5_cast_fu_303_p1 = tmp_94_fu_295_p3;

assign p_shl6_cast_fu_315_p1 = tmp_95_fu_307_p3;

assign p_shl8_cast_fu_430_p3 = {{tmp_144_fu_425_p2}, {4'd0}};

assign p_shl9_cast_fu_446_p1 = tmp_97_fu_438_p3;

assign p_shl_cast_fu_264_p1 = tmp_137_fu_256_p3;
...
assign tmp_132_fu_200_p3 = {{co_reg_110}, {4'd0}};

assign tmp_133_fu_212_p3 = {{co_reg_110}, {1'd0}};

assign tmp_134_fu_228_p2 = (p_shl4_cast_fu_224_p1 + p_shl3_cast_fu_208_p1);

assign tmp_135_fu_234_p3 = {{co_reg_110}, {2'd0}};

assign tmp_136_fu_246_p2 = (p_shl2_cast_fu_242_p1 - co_cast7_cast_fu_196_p1);

assign tmp_137_fu_256_p3 = {{co_reg_110}, {3'd0}};

assign tmp_138_fu_268_p2 = (p_shl4_cast1_fu_220_p1 + p_shl_cast_fu_264_p1);

assign tmp_139_fu_290_p2 = (h_cast6_cast_fu_286_p1 + tmp_138_reg_540);

assign tmp_140_fu_319_p2 = (p_shl5_cast_fu_303_p1 + p_shl6_cast_fu_315_p1);

assign tmp_141_fu_343_p2 = (tmp_140_reg_558 + w_cast5_cast_fu_339_p1);

assign tmp_142_fu_377_p2 = ($signed(m_cast4_cast_fu_373_p1) + $signed(tmp_171_cast_reg_535));

assign tmp_143_fu_388_p2 = (tmp_96_fu_382_p2 - tmp_142_fu_377_p2);

assign tmp_144_fu_425_p2 = (tmp_7_cast_cast_fu_421_p1 + tmp_134_reg_530);

assign tmp_145_fu_450_p2 = (p_shl8_cast_fu_430_p3 + p_shl9_cast_fu_446_p1);

assign tmp_146_fu_466_p2 = (tmp_143_reg_589 + n_cast3_cast_fu_462_p1);

assign tmp_147_fu_507_p2 = (tmp_145_reg_602 + tmp_8_cast_cast_fu_503_p1);

assign tmp_171_cast_fu_252_p1 = $signed(tmp_136_fu_246_p2);

assign tmp_179_cast_fu_348_p1 = tmp_141_fu_343_p2;

assign tmp_187_cast_fu_471_p1 = tmp_146_fu_466_p2;

assign tmp_188_cast_fu_512_p1 = tmp_147_fu_507_p2;
...
assign tmp_94_fu_295_p3 = {{tmp_139_fu_290_p2}, {3'd0}};

assign tmp_95_fu_307_p3 = {{tmp_139_fu_290_p2}, {1'd0}};

assign tmp_96_fu_382_p2 = tmp_142_fu_377_p2 << 10'd2;

assign tmp_97_fu_438_p3 = {{tmp_144_fu_425_p2}, {1'd0}};
...
assign weight_V_address0 = tmp_187_cast_fu_471_p1;

always @ (posedge ap_clk) begin
    tmp_134_reg_530[0] <= 1'b0;
    tmp_138_reg_540[0] <= 1'b0;
    tmp_140_reg_558[0] <= 1'b0;
    tmp_reg_566[0] <= 1'b0;
    tmp_s_reg_579[0] <= 1'b0;
    tmp_145_reg_602[0] <= 1'b0;
end
