...
#ifndef __ShuffleNetV2_uremlbW__HH__
#define __ShuffleNetV2_uremlbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremlbW) {
    ...
    SC_CTOR(ShuffleNetV2_uremlbW):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
