...
#ifndef __ShuffleNetV2_uremesQ__HH__
#define __ShuffleNetV2_uremesQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremesQ) {
    ...
    SC_CTOR(ShuffleNetV2_uremesQ):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
