...
#ifndef __ShuffleNetV2_uremhbi__HH__
#define __ShuffleNetV2_uremhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremhbi) {
    ...
    SC_CTOR(ShuffleNetV2_uremhbi):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
