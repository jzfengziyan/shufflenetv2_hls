...
#ifndef __ShuffleNetV2_mac_cud__HH__
#define __ShuffleNetV2_mac_cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_mac_cud) {
    ...
    SC_CTOR(ShuffleNetV2_mac_cud):  simcore_mac_0_U ("simcore_mac_0_U") {
