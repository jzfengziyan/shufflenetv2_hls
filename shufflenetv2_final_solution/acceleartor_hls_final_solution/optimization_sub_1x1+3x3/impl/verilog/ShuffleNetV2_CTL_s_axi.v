...
#(parameter
    ...
    output wire [31:0]                   conv_last_weight_V,
...
localparam
    ...
    ADDR_IMAGE_V_DATA_0            = 7'h18,
    ADDR_IMAGE_V_CTRL              = 7'h1c,
    ADDR_CONV1_WEIGHT_V_DATA_0     = 7'h20,
    ADDR_CONV1_WEIGHT_V_CTRL       = 7'h24,
    ADDR_SHUFFLE_CONV_3X3_V_DATA_0 = 7'h28,
    ADDR_SHUFFLE_CONV_3X3_V_CTRL   = 7'h2c,
    ADDR_SHUFFLE_CONV_1X1_V_DATA_0 = 7'h30,
    ADDR_SHUFFLE_CONV_1X1_V_CTRL   = 7'h34,
    ADDR_CONV_LAST_WEIGHT_V_DATA_0 = 7'h38,
    ADDR_CONV_LAST_WEIGHT_V_CTRL   = 7'h3c,
    ADDR_FC_WEIGHT_V_DATA_0        = 7'h40,
    ADDR_FC_WEIGHT_V_CTRL          = 7'h44,
    ADDR_BIAS_V_DATA_0             = 7'h48,
    ADDR_BIAS_V_CTRL               = 7'h4c,
    ADDR_FC_OUTPUT_V_DATA_0        = 7'h50,
    ADDR_FC_OUTPUT_V_CTRL          = 7'h54,
    WRIDLE                         = 2'd0,
    WRDATA                         = 2'd1,
    WRRESP                         = 2'd2,
    WRRESET                        = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_conv_last_weight_V = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_CONV_LAST_WEIGHT_V_DATA_0: begin
                    rdata <= int_conv_last_weight_V[31:0];
                end
...
assign conv_last_weight_V = int_conv_last_weight_V;
...
// int_conv_last_weight_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_conv_last_weight_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CONV_LAST_WEIGHT_V_DATA_0)
            int_conv_last_weight_V[31:0] <= (WDATA[31:0] & wmask) | (int_conv_last_weight_V[31:0] & ~wmask);
    end
end
