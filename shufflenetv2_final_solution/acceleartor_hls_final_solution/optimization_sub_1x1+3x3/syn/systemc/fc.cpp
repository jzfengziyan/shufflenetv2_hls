...
fc::fc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ShuffleNetV2_mac_cud_x_U1629 = new ShuffleNetV2_mac_cud<1,1,8,8,8,8>("ShuffleNetV2_mac_cud_x_U1629");
    ShuffleNetV2_mac_cud_x_U1629->din0(avgpool_output_V_loa_reg_294);
    ShuffleNetV2_mac_cud_x_U1629->din1(weight_V_addr_read_reg_289);
    ShuffleNetV2_mac_cud_x_U1629->din2(p_s_reg_144);
    ShuffleNetV2_mac_cud_x_U1629->dout(grp_fu_236_p3);
    ...
    SC_METHOD(thread_tmp_519_fu_198_p1);
    sensitive << ( tmp_s_fu_178_p3 );

    SC_METHOD(thread_tmp_520_fu_202_p2);
    sensitive << ( fc_weight_V11 );
    sensitive << ( tmp_519_fu_198_p1 );
    ...
    sc_trace(mVcdFile, tmp_520_fu_202_p2, "tmp_520_fu_202_p2");
    ...
    sc_trace(mVcdFile, tmp_519_fu_198_p1, "tmp_519_fu_198_p1");
...
fc::~fc() {
    ...
    delete ShuffleNetV2_mac_cud_x_U1629;
}
...
void fc::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond42_fu_186_p2.read()))) {
        weight_V_addr_reg_265 = tmp_520_fu_202_p2.read();
    }
}
...
void fc::thread_tmp_519_fu_198_p1() {
    tmp_519_fu_198_p1 = esl_zext<32,13>(tmp_s_fu_178_p3.read());
}

void fc::thread_tmp_520_fu_202_p2() {
    tmp_520_fu_202_p2 = (!tmp_519_fu_198_p1.read().is_01() || !fc_weight_V11.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_519_fu_198_p1.read()) + sc_biguint<32>(fc_weight_V11.read()));
}
