...
MUL_DP::MUL_DP(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_289_fu_108_p1);
    sensitive << ( tmp_1405_reg_147 );
    ...
    sc_trace(mVcdFile, tmp_1405_reg_147, "tmp_1405_reg_147");
    ...
    sc_trace(mVcdFile, tmp_289_fu_108_p1, "tmp_289_fu_108_p1");
...
void MUL_DP::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_ce.read(), ap_const_logic_1))) {
        ...
        tmp_1405_reg_147 = grp_fu_80_p2.read().range(15, 15);
...
void MUL_DP::thread_loc_V_fu_111_p2() {
    loc_V_fu_111_p2 = (!tmp_289_fu_108_p1.read().is_01() || !p_Result_s_reg_152.read().is_01())? sc_lv<16>(): (sc_biguint<16>(tmp_289_fu_108_p1.read()) + sc_biguint<16>(p_Result_s_reg_152.read()));
}
...
void MUL_DP::thread_tmp_289_fu_108_p1() {
    tmp_289_fu_108_p1 = esl_zext<16,1>(tmp_1405_reg_147.read());
}
