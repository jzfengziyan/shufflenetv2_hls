...
#ifndef __ShuffleNetV2_mul_dEe__HH__
#define __ShuffleNetV2_mul_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_mul_dEe) {
    ...
    SC_CTOR(ShuffleNetV2_mul_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
