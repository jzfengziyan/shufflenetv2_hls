...
set C_modelArgMapList {[ 
	{ "Name" : "weight_V", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "fc_weight_V11", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "fc_output_V15", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fc_weight_V11 sc_in sc_lv 32 signal 1 } 
	...
	{ fc_output_V15 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fc_weight_V11", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fc_weight_V11", "role": "default" }} , 
 	...
 	{ "name": "fc_output_V15", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fc_output_V15", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ShuffleNetV2_mac_cud_x_U1629", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15475", "Max" : "15475"}
	, {"Name" : "Interval", "Min" : "15475", "Max" : "15475"}
]}
...
set Spec2ImplPortList { 
	...
	fc_weight_V11 { ap_none {  { fc_weight_V11 in_data 0 32 } } }
	...
	fc_output_V15 { ap_none {  { fc_output_V15 in_data 0 32 } } }
