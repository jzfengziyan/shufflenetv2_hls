...
wire  signed [9:0] tmp_153_cast_fu_369_p1;
reg  signed [9:0] tmp_153_cast_reg_1024;
wire   [0:0] exitcond8_fu_330_p2;
wire   [9:0] tmp_141_fu_397_p2;
reg   [9:0] tmp_141_reg_1029;
wire   [2:0] tmp_142_fu_403_p1;
reg   [2:0] tmp_142_reg_1034;
wire   [7:0] tmp_145_fu_441_p2;
reg   [7:0] tmp_145_reg_1039;
reg   [5:0] bias_V_addr_reg_1044;
wire   [4:0] tmp_s_fu_453_p3;
reg   [4:0] tmp_s_reg_1052;
wire    ap_CS_fsm_state3;
wire   [0:0] exitcond9_fu_447_p2;
wire   [13:0] tmp_149_fu_494_p2;
reg   [13:0] tmp_149_reg_1057;
wire   [4:0] tmp_80_fu_506_p3;
reg   [4:0] tmp_80_reg_1065;
...
wire   [9:0] tmp_153_fu_547_p2;
reg   [9:0] tmp_153_reg_1083;
wire   [0:0] exitcond2_fu_520_p2;
wire   [11:0] tmp_156_fu_597_p2;
reg   [11:0] tmp_156_reg_1088;
wire   [13:0] tmp_150_fu_607_p2;
reg   [13:0] tmp_150_reg_1093;
...
wire   [7:0] tmp_78_fu_680_p10;
reg   [7:0] tmp_78_reg_1161;
wire   [15:0] p_Val2_4_fu_707_p2;
reg   [15:0] p_Val2_4_reg_1166;
wire    ap_CS_fsm_state8;
reg   [0:0] tmp_160_reg_1171;
wire   [15:0] p_Val2_43_fu_733_p2;
reg   [15:0] p_Val2_43_reg_1176;
wire    ap_CS_fsm_state9;
reg   [0:0] signbit_reg_1181;
wire   [7:0] p_Val2_45_fu_767_p2;
reg   [7:0] p_Val2_45_reg_1188;
wire   [0:0] newsignbit_fu_773_p3;
reg   [0:0] newsignbit_reg_1194;
wire   [0:0] carry_fu_787_p2;
reg   [0:0] carry_reg_1200;
reg   [1:0] tmp_96_reg_1207;
wire   [0:0] p_38_i_i_fu_845_p2;
reg   [0:0] p_38_i_i_reg_1213;
wire    ap_CS_fsm_state10;
wire   [0:0] tmp_97_fu_861_p2;
reg   [0:0] tmp_97_reg_1218;
...
reg   [1:0] m_reg_296;
reg   [7:0] p_Val2_42_reg_307;
reg   [1:0] n_reg_319;
wire   [63:0] tmp_fu_342_p1;
wire   [63:0] tmp_172_cast_fu_639_p1;
wire   [63:0] tmp_173_cast_fu_668_p1;
wire   [63:0] tmp_164_cast_fu_1012_p1;
wire   [7:0] tmp_137_fu_351_p3;
wire   [8:0] p_shl4_cast_fu_359_p1;
wire   [8:0] tmp_cast_fu_347_p1;
wire   [8:0] tmp_138_fu_363_p2;
wire   [8:0] tmp_139_fu_373_p3;
wire   [6:0] tmp_140_fu_385_p3;
wire   [9:0] p_shl2_cast_fu_381_p1;
wire   [9:0] p_shl3_cast_fu_393_p1;
wire   [2:0] newIndex_fu_407_p4;
wire   [6:0] tmp_143_fu_417_p3;
wire   [3:0] tmp_144_fu_429_p3;
wire   [7:0] p_shl_cast_fu_425_p1;
wire   [7:0] p_shl1_cast_fu_437_p1;
wire   [9:0] tmp_79_cast_fu_461_p1;
wire   [9:0] tmp_146_fu_465_p2;
wire   [12:0] tmp_147_fu_470_p3;
wire   [10:0] tmp_148_fu_482_p3;
wire   [13:0] p_shl6_cast_fu_490_p1;
wire   [13:0] p_shl5_cast_fu_478_p1;
wire   [9:0] tmp_85_cast_fu_532_p1;
wire   [9:0] tmp_151_fu_536_p2;
wire   [9:0] tmp_152_fu_541_p2;
wire   [1:0] tmp2_fu_553_p2;
wire  signed [4:0] tmp2_cast_fu_559_p1;
wire   [4:0] tmp_86_fu_563_p2;
wire   [7:0] tmp_87_cast_fu_568_p1;
wire   [7:0] tmp_154_fu_572_p2;
wire   [8:0] tmp_155_fu_585_p3;
wire   [11:0] p_shl8_cast_fu_593_p1;
wire   [11:0] p_shl7_cast_fu_577_p3;
wire   [13:0] tmp_84_cast_fu_603_p1;
wire   [9:0] tmp_88_cast_fu_630_p1;
wire   [9:0] tmp_157_fu_634_p2;
wire   [1:0] tmp3_fu_644_p2;
wire  signed [4:0] tmp3_cast_fu_650_p1;
wire   [4:0] tmp_89_fu_654_p2;
wire   [11:0] tmp_90_cast_fu_659_p1;
wire   [11:0] tmp_158_fu_663_p2;
wire  signed [7:0] p_Val2_4_fu_707_p0;
wire  signed [7:0] p_Val2_4_fu_707_p1;
wire   [13:0] tmp_91_fu_721_p3;
wire  signed [15:0] tmp_113_cast_fu_729_p1;
wire   [7:0] p_Val2_44_fu_746_p4;
wire   [7:0] tmp_93_fu_756_p1;
wire   [0:0] tmp_161_fu_759_p3;
wire   [0:0] tmp_94_fu_781_p2;
wire   [0:0] Range1_all_ones_fu_810_p2;
wire   [0:0] Range1_all_zeros_fu_815_p2;
wire   [0:0] tmp_163_fu_803_p3;
wire   [0:0] tmp_95_fu_827_p2;
...
wire   [7:0] p_Val2_s_55_fu_915_p3;
wire  signed [8:0] tmp_81_fu_929_p1;
wire  signed [8:0] tmp_82_fu_933_p1;
wire   [8:0] p_Val2_40_fu_937_p2;
wire   [0:0] tmp_83_fu_965_p2;
wire   [0:0] isneg_not_fu_979_p2;
wire   [0:0] brmerge_i_i_fu_975_p2;
wire   [0:0] underflow_7_fu_970_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond8_fu_330_p2 == 1'd0))) begin
        ...
        tmp_141_reg_1029[9 : 1] <= tmp_141_fu_397_p2[9 : 1];
        tmp_142_reg_1034 <= tmp_142_fu_403_p1;
        tmp_145_reg_1039[7 : 1] <= tmp_145_fu_441_p2[7 : 1];
        tmp_153_cast_reg_1024 <= tmp_153_cast_fu_369_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        newsignbit_reg_1194 <= p_Val2_45_fu_767_p2[32'd7];
        p_Val2_43_reg_1176 <= p_Val2_43_fu_733_p2;
        p_Val2_45_reg_1188 <= p_Val2_45_fu_767_p2;
        signbit_reg_1181 <= p_Val2_43_fu_733_p2[32'd15];
        tmp_96_reg_1207 <= {{p_Val2_43_fu_733_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        isneg_reg_1243 <= p_Val2_40_fu_937_p2[32'd8];
        newsignbit_7_reg_1256 <= result_V_fu_951_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_160_reg_1171 <= p_Val2_4_fu_707_p2[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond9_fu_447_p2))) begin
        tmp_149_reg_1057[13 : 1] <= tmp_149_fu_494_p2[13 : 1];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd1 == exitcond2_fu_520_p2))) begin
        tmp_150_reg_1093 <= tmp_150_fu_607_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond2_fu_520_p2))) begin
        tmp_153_reg_1083 <= tmp_153_fu_547_p2;
        tmp_156_reg_1088[11 : 1] <= tmp_156_fu_597_p2[11 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (1'd0 == exitcond1_fu_500_p2))) begin
        tmp_80_reg_1065[4 : 1] <= tmp_80_fu_506_p3[4 : 1];
    end
end
...
assign Range1_all_ones_fu_810_p2 = ((tmp_96_reg_1207 == 2'd3) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_815_p2 = ((tmp_96_reg_1207 == 2'd0) ? 1'b1 : 1'b0);

assign ShuffleConvs_1_Downs_1_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_2_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_3_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_4_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_5_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_6_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_7_address0 = tmp_173_cast_fu_668_p1;

assign ShuffleConvs_1_Downs_address0 = tmp_173_cast_fu_668_p1;
...
assign brmerge9_fu_984_p2 = (newsignbit_7_reg_1256 | isneg_not_fu_979_p2);

assign brmerge_i_i5_fu_856_p2 = (newsignbit_reg_1194 | p_not_i_i_fu_850_p2);

assign brmerge_i_i_fu_975_p2 = (isneg_reg_1243 ^ newsignbit_7_reg_1256);

assign brmerge_i_i_i_fu_894_p2 = (underflow_fu_889_p2 | overflow_fu_866_p2);

assign carry_fu_787_p2 = (tmp_161_fu_759_p3 & tmp_94_fu_781_p2);
...
assign newsignbit_fu_773_p3 = p_Val2_45_fu_767_p2[32'd7];

assign output_V_address0 = tmp_164_cast_fu_1012_p1;

assign output_V_d0 = ((brmerge9_fu_984_p2[0:0] === 1'b1) ? result_V_mux_fu_989_p3 : p_result_V_fu_996_p3);

assign overflow_fu_866_p2 = (brmerge_i_i5_fu_856_p2 & tmp_97_fu_861_p2);

assign p_38_i_i_fu_845_p2 = (carry_reg_1200 & Range1_all_ones_fu_810_p2);

assign p_41_i_i_fu_833_p2 = (signbit_reg_1181 & tmp_95_fu_827_p2);

assign p_Val2_40_fu_937_p2 = ($signed(tmp_81_fu_929_p1) + $signed(tmp_82_fu_933_p1));

assign p_Val2_40_mux_fu_909_p3 = ((brmerge_i_i_i_reg_1233[0:0] === 1'b1) ? 8'd127 : p_Val2_45_reg_1188);

assign p_Val2_43_fu_733_p2 = ($signed(tmp_113_cast_fu_729_p1) + $signed(p_Val2_4_reg_1166));

assign p_Val2_44_fu_746_p4 = {{p_Val2_43_fu_733_p2[13:6]}};

assign p_Val2_45_fu_767_p2 = (p_Val2_44_fu_746_p4 + tmp_93_fu_756_p1);

assign p_Val2_4_fu_707_p0 = weight_V_load_reg_1156;

assign p_Val2_4_fu_707_p1 = tmp_78_reg_1161;

assign p_Val2_4_fu_707_p2 = ($signed(p_Val2_4_fu_707_p0) * $signed(p_Val2_4_fu_707_p1));

assign p_Val2_s_55_fu_915_p3 = ((underflow_reg_1228[0:0] === 1'b1) ? 8'd128 : p_Val2_45_reg_1188);

assign p_not_i_i_fu_850_p2 = (deleted_zeros_fu_820_p3 ^ 1'd1);

assign p_result_V_fu_996_p3 = ((underflow_7_fu_970_p2[0:0] === 1'b1) ? 8'd128 : result_V_reg_1250);

assign p_shl1_cast_fu_437_p1 = tmp_144_fu_429_p3;

assign p_shl2_cast_fu_381_p1 = tmp_139_fu_373_p3;

assign p_shl3_cast_fu_393_p1 = tmp_140_fu_385_p3;

assign p_shl4_cast_fu_359_p1 = tmp_137_fu_351_p3;

assign p_shl5_cast_fu_478_p1 = tmp_147_fu_470_p3;

assign p_shl6_cast_fu_490_p1 = tmp_148_fu_482_p3;

assign p_shl7_cast_fu_577_p3 = {{tmp_154_fu_572_p2}, {4'd0}};

assign p_shl8_cast_fu_593_p1 = tmp_155_fu_585_p3;

assign p_shl_cast_fu_425_p1 = tmp_143_fu_417_p3;
...
assign sum_V_fu_921_p3 = ((underflow_not_fu_904_p2[0:0] === 1'b1) ? p_Val2_40_mux_fu_909_p3 : p_Val2_s_55_fu_915_p3);
...
assign tmp5_fu_900_p2 = (brmerge40_demorgan_i_reg_1223 | tmp_97_reg_1218);

assign tmp_113_cast_fu_729_p1 = $signed(tmp_91_fu_721_p3);

assign tmp_137_fu_351_p3 = {{co_reg_249}, {2'd0}};

assign tmp_138_fu_363_p2 = (p_shl4_cast_fu_359_p1 - tmp_cast_fu_347_p1);

assign tmp_139_fu_373_p3 = {{co_reg_249}, {3'd0}};

assign tmp_140_fu_385_p3 = {{co_reg_249}, {1'd0}};

assign tmp_141_fu_397_p2 = (p_shl2_cast_fu_381_p1 + p_shl3_cast_fu_393_p1);

assign tmp_142_fu_403_p1 = co_reg_249[2:0];

assign tmp_143_fu_417_p3 = {{newIndex_fu_407_p4}, {4'd0}};

assign tmp_144_fu_429_p3 = {{newIndex_fu_407_p4}, {1'd0}};

assign tmp_145_fu_441_p2 = (p_shl_cast_fu_425_p1 + p_shl1_cast_fu_437_p1);

assign tmp_146_fu_465_p2 = (tmp_141_reg_1029 + tmp_79_cast_fu_461_p1);

assign tmp_147_fu_470_p3 = {{tmp_146_fu_465_p2}, {3'd0}};

assign tmp_148_fu_482_p3 = {{tmp_146_fu_465_p2}, {1'd0}};

assign tmp_149_fu_494_p2 = (p_shl6_cast_fu_490_p1 + p_shl5_cast_fu_478_p1);

assign tmp_150_fu_607_p2 = (tmp_149_reg_1057 + tmp_84_cast_fu_603_p1);

assign tmp_151_fu_536_p2 = ($signed(tmp_153_cast_reg_1024) + $signed(tmp_85_cast_fu_532_p1));

assign tmp_152_fu_541_p2 = tmp_151_fu_536_p2 << 10'd2;

assign tmp_153_cast_fu_369_p1 = $signed(tmp_138_fu_363_p2);

assign tmp_153_fu_547_p2 = (tmp_152_fu_541_p2 - tmp_151_fu_536_p2);

assign tmp_154_fu_572_p2 = (tmp_145_reg_1039 + tmp_87_cast_fu_568_p1);

assign tmp_155_fu_585_p3 = {{tmp_154_fu_572_p2}, {1'd0}};

assign tmp_156_fu_597_p2 = (p_shl8_cast_fu_593_p1 + p_shl7_cast_fu_577_p3);

assign tmp_157_fu_634_p2 = (tmp_88_cast_fu_630_p1 + tmp_153_reg_1083);

assign tmp_158_fu_663_p2 = (tmp_90_cast_fu_659_p1 + tmp_156_reg_1088);

assign tmp_161_fu_759_p3 = p_Val2_43_fu_733_p2[32'd13];

assign tmp_163_fu_803_p3 = p_Val2_43_reg_1176[32'd14];

assign tmp_164_cast_fu_1012_p1 = tmp_150_reg_1093;

assign tmp_172_cast_fu_639_p1 = tmp_157_fu_634_p2;

assign tmp_173_cast_fu_668_p1 = tmp_158_fu_663_p2;

assign tmp_79_cast_fu_461_p1 = h_reg_260;

assign tmp_80_fu_506_p3 = {{w_reg_272}, {1'd0}};

assign tmp_81_fu_929_p1 = $signed(p_Val2_s_reg_284);

assign tmp_82_fu_933_p1 = $signed(bias_V_q0);

assign tmp_83_fu_965_p2 = (newsignbit_7_reg_1256 ^ 1'd1);

assign tmp_84_cast_fu_603_p1 = w_reg_272;

assign tmp_85_cast_fu_532_p1 = m_reg_296;

assign tmp_86_fu_563_p2 = ($signed(tmp_s_reg_1052) + $signed(tmp2_cast_fu_559_p1));

assign tmp_87_cast_fu_568_p1 = tmp_86_fu_563_p2;

assign tmp_88_cast_fu_630_p1 = n_reg_319;

assign tmp_89_fu_654_p2 = ($signed(tmp3_cast_fu_650_p1) + $signed(tmp_80_reg_1065));

assign tmp_90_cast_fu_659_p1 = tmp_89_fu_654_p2;

assign tmp_91_fu_721_p3 = {{p_Val2_42_reg_307}, {6'd0}};

assign tmp_93_fu_756_p1 = tmp_160_reg_1171;

assign tmp_94_fu_781_p2 = (newsignbit_fu_773_p3 ^ 1'd1);

assign tmp_95_fu_827_p2 = (tmp_163_fu_803_p3 ^ 1'd1);

assign tmp_97_fu_861_p2 = (signbit_reg_1181 ^ 1'd1);
...
assign underflow_7_fu_970_p2 = (isneg_reg_1243 & tmp_83_fu_965_p2);
...
assign weight_V_address0 = tmp_172_cast_fu_639_p1;

always @ (posedge ap_clk) begin
    tmp_141_reg_1029[0] <= 1'b0;
    tmp_145_reg_1039[0] <= 1'b0;
    tmp_s_reg_1052[0] <= 1'b0;
    tmp_149_reg_1057[0] <= 1'b0;
    tmp_80_reg_1065[0] <= 1'b0;
    tmp_156_reg_1088[0] <= 1'b0;
end
