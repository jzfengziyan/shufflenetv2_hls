...
wire  signed [63:0] tmp_563_fu_250_p1;
...
wire   [12:0] tmp_485_fu_233_p3;
wire   [32:0] tmp_561_fu_241_p1;
wire   [32:0] tmp_562_fu_245_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        tmp_567_reg_659 <= p_Val2_56_fu_287_p2[32'd5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == exitcond21_fu_221_p2))) begin
        weight_V_addr_reg_615 <= tmp_563_fu_250_p1;
    end
end
...
assign carry_fu_367_p2 = (tmp_568_fu_339_p3 & tmp_227_fu_361_p2);
...
assign tmp_226_fu_336_p1 = tmp_567_reg_659;

assign tmp_227_fu_361_p2 = (newsignbit_fu_353_p3 ^ 1'd1);

assign tmp_229_fu_407_p2 = (tmp_570_fu_383_p3 ^ 1'd1);

assign tmp_230_fu_441_p2 = (signbit_reg_669 ^ 1'd1);

assign tmp_243_cast_fu_309_p1 = $signed(tmp_225_fu_301_p3);

assign tmp_485_fu_233_p3 = {{co_reg_171}, {9'd0}};

assign tmp_561_fu_241_p1 = tmp_485_fu_233_p3;

assign tmp_562_fu_245_p2 = ($signed(tmp_561_fu_241_p1) + $signed(sext_cast_reg_602));

assign tmp_563_fu_250_p1 = $signed(tmp_562_fu_245_p2);

assign tmp_568_fu_339_p3 = p_Val2_57_fu_313_p2[32'd13];

assign tmp_570_fu_383_p3 = p_Val2_57_reg_664[32'd14];
