...
wire  signed [9:0] tmp_65_cast_fu_363_p1;
reg  signed [9:0] tmp_65_cast_reg_1004;
wire   [0:0] exitcond5_fu_324_p2;
wire   [9:0] tmp_57_fu_391_p2;
reg   [9:0] tmp_57_reg_1009;
wire   [2:0] tmp_59_fu_397_p1;
reg   [2:0] tmp_59_reg_1014;
wire   [6:0] tmp_61_fu_435_p2;
reg   [6:0] tmp_61_reg_1019;
reg   [5:0] bias_V_addr_reg_1024;
wire   [13:0] tmp_65_fu_480_p2;
reg   [13:0] tmp_65_reg_1032;
...
wire   [9:0] tmp_67_fu_514_p2;
reg   [9:0] tmp_67_reg_1053;
wire   [0:0] exitcond8_fu_498_p2;
wire   [6:0] tmp_70_fu_539_p2;
reg   [6:0] tmp_70_reg_1059;
wire   [9:0] tmp_69_fu_549_p2;
reg   [9:0] tmp_69_reg_1065;
wire    ap_CS_fsm_state6;
wire   [10:0] tmp_73_fu_576_p2;
reg   [10:0] tmp_73_reg_1070;
wire   [1:0] n_2_fu_588_p2;
reg   [1:0] n_2_reg_1078;
wire    ap_CS_fsm_state7;
wire   [0:0] exitcond_fu_582_p2;
wire   [10:0] tmp_75_fu_628_p2;
reg   [10:0] tmp_75_reg_1088;
...
wire   [63:0] tmp_84_cast_fu_603_p1;
wire   [63:0] tmp_85_cast_fu_633_p1;
wire   [63:0] tmp_76_cast_fu_985_p1;
wire   [7:0] tmp_s_fu_345_p3;
wire   [8:0] p_shl4_cast_fu_353_p1;
wire   [8:0] tmp_cast_fu_341_p1;
wire   [8:0] tmp_54_fu_357_p2;
wire   [8:0] tmp_55_fu_367_p3;
wire   [6:0] tmp_56_fu_379_p3;
wire   [9:0] p_shl2_cast_fu_375_p1;
wire   [9:0] p_shl3_cast_fu_387_p1;
wire   [2:0] newIndex_fu_401_p4;
wire   [5:0] tmp_58_fu_411_p3;
wire   [3:0] tmp_60_fu_423_p3;
wire   [6:0] p_shl_cast_fu_419_p1;
wire   [6:0] p_shl1_cast_fu_431_p1;
wire   [9:0] tmp_cast_30_fu_447_p1;
wire   [9:0] tmp_62_fu_451_p2;
wire   [12:0] tmp_63_fu_456_p3;
wire   [10:0] tmp_64_fu_468_p3;
...
wire   [9:0] tmp_68_fu_544_p2;
wire   [9:0] tmp_71_fu_554_p3;
wire   [7:0] tmp_72_fu_565_p3;
wire   [10:0] p_shl8_cast_fu_572_p1;
wire   [10:0] p_shl7_cast_fu_561_p1;
wire   [9:0] tmp_33_cast_fu_594_p1;
wire   [9:0] tmp_74_fu_598_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond5_fu_324_p2 == 1'd0))) begin
        ...
        tmp_57_reg_1009[9 : 1] <= tmp_57_fu_391_p2[9 : 1];
        tmp_59_reg_1014 <= tmp_59_fu_397_p1;
        tmp_61_reg_1019[6 : 1] <= tmp_61_fu_435_p2[6 : 1];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        tmp_77_reg_1148 <= p_Val2_1_fu_671_p2[32'd5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond6_fu_441_p2))) begin
        tmp_65_reg_1032[13 : 1] <= tmp_65_fu_480_p2[13 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        tmp_73_reg_1070[10 : 1] <= tmp_73_fu_576_p2[10 : 1];
    end
end
...
assign buffer1_1_48_8x8_p_V_1_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_2_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_3_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_4_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_5_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_6_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_7_address0 = tmp_85_cast_fu_633_p1;

assign buffer1_1_48_8x8_p_V_8_address0 = tmp_85_cast_fu_633_p1;

assign carry_fu_751_p2 = (tmp_78_fu_723_p3 & tmp_38_fu_745_p2);
...
assign output_V_address0 = tmp_76_cast_fu_985_p1;
...
assign p_shl1_cast_fu_431_p1 = tmp_60_fu_423_p3;

assign p_shl2_cast_fu_375_p1 = tmp_55_fu_367_p3;

assign p_shl3_cast_fu_387_p1 = tmp_56_fu_379_p3;

assign p_shl4_cast_fu_353_p1 = tmp_s_fu_345_p3;

assign p_shl5_cast_fu_464_p1 = tmp_63_fu_456_p3;

assign p_shl6_cast_fu_476_p1 = tmp_64_fu_468_p3;

assign p_shl7_cast_fu_561_p1 = tmp_71_fu_554_p3;

assign p_shl8_cast_fu_572_p1 = tmp_72_fu_565_p3;

assign p_shl_cast_fu_419_p1 = tmp_58_fu_411_p3;
...
assign tmp_37_fu_720_p1 = tmp_77_reg_1148;

assign tmp_38_fu_745_p2 = (newsignbit_fu_737_p3 ^ 1'd1);

assign tmp_40_fu_791_p2 = (tmp_80_fu_767_p3 ^ 1'd1);

assign tmp_41_fu_825_p2 = (signbit_reg_1158 ^ 1'd1);

assign tmp_43_cast_fu_693_p1 = $signed(tmp_36_fu_685_p3);

assign tmp_54_fu_357_p2 = (p_shl4_cast_fu_353_p1 - tmp_cast_fu_341_p1);

assign tmp_55_fu_367_p3 = {{co_reg_243}, {3'd0}};

assign tmp_56_fu_379_p3 = {{co_reg_243}, {1'd0}};

assign tmp_57_fu_391_p2 = (p_shl2_cast_fu_375_p1 + p_shl3_cast_fu_387_p1);

assign tmp_58_fu_411_p3 = {{newIndex_fu_401_p4}, {3'd0}};

assign tmp_59_fu_397_p1 = co_reg_243[2:0];

assign tmp_60_fu_423_p3 = {{newIndex_fu_401_p4}, {1'd0}};

assign tmp_61_fu_435_p2 = (p_shl_cast_fu_419_p1 + p_shl1_cast_fu_431_p1);

assign tmp_62_fu_451_p2 = (tmp_cast_30_fu_447_p1 + tmp_57_reg_1009);

assign tmp_63_fu_456_p3 = {{tmp_62_fu_451_p2}, {3'd0}};

assign tmp_64_fu_468_p3 = {{tmp_62_fu_451_p2}, {1'd0}};

assign tmp_65_cast_fu_363_p1 = $signed(tmp_54_fu_357_p2);

assign tmp_65_fu_480_p2 = (p_shl5_cast_fu_464_p1 + p_shl6_cast_fu_476_p1);

assign tmp_66_fu_980_p2 = (tmp_65_reg_1032 + tmp_29_cast_fu_976_p1);

assign tmp_67_fu_514_p2 = ($signed(tmp_65_cast_reg_1004) + $signed(tmp_30_cast_fu_510_p1));

assign tmp_68_fu_544_p2 = tmp_67_reg_1053 << 10'd2;

assign tmp_69_fu_549_p2 = (tmp_68_fu_544_p2 - tmp_67_reg_1053);

assign tmp_70_fu_539_p2 = (tmp_61_reg_1019 + tmp_32_cast_fu_535_p1);

assign tmp_71_fu_554_p3 = {{tmp_70_reg_1059}, {3'd0}};

assign tmp_72_fu_565_p3 = {{tmp_70_reg_1059}, {1'd0}};

assign tmp_73_fu_576_p2 = (p_shl8_cast_fu_572_p1 + p_shl7_cast_fu_561_p1);

assign tmp_74_fu_598_p2 = (tmp_33_cast_fu_594_p1 + tmp_69_reg_1065);

assign tmp_75_fu_628_p2 = (tmp_35_cast_fu_624_p1 + tmp_73_reg_1070);

assign tmp_76_cast_fu_985_p1 = tmp_66_fu_980_p2;

assign tmp_78_fu_723_p3 = p_Val2_15_fu_697_p2[32'd13];

assign tmp_80_fu_767_p3 = p_Val2_15_reg_1153[32'd14];

assign tmp_84_cast_fu_603_p1 = tmp_74_fu_598_p2;

assign tmp_85_cast_fu_633_p1 = tmp_75_reg_1088;
...
assign weight_V_address0 = tmp_84_cast_fu_603_p1;

always @ (posedge ap_clk) begin
    tmp_57_reg_1009[0] <= 1'b0;
    tmp_61_reg_1019[0] <= 1'b0;
    tmp_65_reg_1032[0] <= 1'b0;
    tmp_73_reg_1070[0] <= 1'b0;
end
