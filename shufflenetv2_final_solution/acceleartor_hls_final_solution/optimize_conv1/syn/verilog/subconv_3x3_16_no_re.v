...
wire  signed [8:0] tmp_175_cast_fu_365_p1;
reg  signed [8:0] tmp_175_cast_reg_998;
wire   [0:0] exitcond5_fu_326_p2;
wire   [9:0] tmp_162_fu_393_p2;
reg   [9:0] tmp_162_reg_1003;
wire   [2:0] tmp_164_fu_399_p1;
reg   [2:0] tmp_164_reg_1008;
wire   [6:0] tmp_166_fu_437_p2;
reg   [6:0] tmp_166_reg_1013;
reg   [4:0] bias_V_addr_reg_1018;
wire   [13:0] tmp_169_fu_478_p2;
reg   [13:0] tmp_169_reg_1026;
...
wire   [8:0] tmp_171_fu_512_p2;
reg   [8:0] tmp_171_reg_1047;
wire   [0:0] exitcond8_fu_496_p2;
wire   [6:0] tmp_174_fu_537_p2;
reg   [6:0] tmp_174_reg_1053;
wire   [8:0] tmp_173_fu_547_p2;
reg   [8:0] tmp_173_reg_1059;
wire    ap_CS_fsm_state6;
wire   [10:0] tmp_176_fu_570_p2;
reg   [10:0] tmp_176_reg_1064;
wire   [1:0] n_6_fu_582_p2;
reg   [1:0] n_6_reg_1072;
wire    ap_CS_fsm_state7;
wire   [0:0] exitcond_fu_576_p2;
wire   [10:0] tmp_178_fu_622_p2;
reg   [10:0] tmp_178_reg_1082;
wire    ap_CS_fsm_state8;
reg   [7:0] weight_V_load_reg_1127;
wire   [7:0] tmp_108_fu_638_p10;
reg   [7:0] tmp_108_reg_1132;
wire    ap_CS_fsm_state9;
wire   [15:0] p_Val2_6_fu_665_p2;
reg   [15:0] p_Val2_6_reg_1137;
wire    ap_CS_fsm_state10;
reg   [0:0] tmp_180_reg_1142;
wire   [15:0] p_Val2_50_fu_691_p2;
reg   [15:0] p_Val2_50_reg_1147;
wire    ap_CS_fsm_state11;
reg   [0:0] signbit_reg_1152;
wire   [7:0] p_Val2_52_fu_725_p2;
reg   [7:0] p_Val2_52_reg_1159;
wire   [0:0] newsignbit_fu_731_p3;
reg   [0:0] newsignbit_reg_1165;
wire   [0:0] carry_fu_745_p2;
reg   [0:0] carry_reg_1171;
reg   [1:0] tmp_112_reg_1178;
wire   [0:0] p_38_i_i_fu_803_p2;
reg   [0:0] p_38_i_i_reg_1184;
wire    ap_CS_fsm_state12;
wire   [0:0] tmp_114_fu_819_p2;
reg   [0:0] tmp_114_reg_1189;
...
reg   [1:0] m_reg_292;
reg   [7:0] p_Val2_49_reg_303;
reg   [1:0] n_reg_315;
wire   [63:0] tmp_fu_338_p1;
wire   [63:0] tmp_194_cast_fu_597_p1;
wire   [63:0] tmp_195_cast_fu_627_p1;
wire   [63:0] tmp_186_cast_fu_979_p1;
wire   [6:0] tmp_s_fu_347_p3;
wire   [7:0] p_shl4_cast_fu_355_p1;
wire   [7:0] tmp_cast_fu_343_p1;
wire   [7:0] tmp_159_fu_359_p2;
wire   [8:0] tmp_160_fu_369_p3;
wire   [5:0] tmp_161_fu_381_p3;
wire   [9:0] p_shl2_cast_fu_377_p1;
wire   [9:0] p_shl3_cast_fu_389_p1;
wire   [1:0] newIndex_fu_403_p4;
wire   [5:0] tmp_163_fu_413_p3;
wire   [2:0] tmp_165_fu_425_p3;
wire   [6:0] p_shl_cast_fu_421_p1;
wire   [6:0] p_shl1_cast_fu_433_p1;
wire   [9:0] tmp_cast_57_fu_449_p1;
wire   [9:0] tmp_167_fu_453_p2;
wire   [10:0] tmp_168_fu_466_p3;
wire   [13:0] p_shl5_cast_fu_458_p3;
wire   [13:0] p_shl6_cast_fu_474_p1;
wire   [8:0] tmp_102_cast_fu_508_p1;
wire   [1:0] tmp2_fu_517_p2;
wire  signed [4:0] tmp2_cast_fu_523_p1;
wire   [4:0] tmp_103_fu_527_p2;
wire   [6:0] tmp_104_cast_fu_533_p1;
wire   [8:0] tmp_172_fu_542_p2;
wire   [7:0] tmp_175_fu_559_p3;
wire   [10:0] p_shl8_cast_fu_566_p1;
wire   [10:0] p_shl7_cast_fu_552_p3;
wire   [8:0] tmp_105_cast_fu_588_p1;
wire   [8:0] tmp_177_fu_592_p2;
wire   [1:0] tmp3_fu_602_p2;
wire  signed [4:0] tmp3_cast_fu_608_p1;
wire   [4:0] tmp_106_fu_612_p2;
wire   [10:0] tmp_107_cast_fu_618_p1;
wire  signed [7:0] p_Val2_6_fu_665_p0;
wire  signed [7:0] p_Val2_6_fu_665_p1;
wire   [13:0] tmp_109_fu_679_p3;
wire  signed [15:0] tmp_159_cast_fu_687_p1;
wire   [7:0] p_Val2_51_fu_704_p4;
wire   [7:0] tmp_110_fu_714_p1;
wire   [0:0] tmp_181_fu_717_p3;
wire   [0:0] tmp_111_fu_739_p2;
wire   [0:0] Range1_all_ones_fu_768_p2;
wire   [0:0] Range1_all_zeros_fu_773_p2;
wire   [0:0] tmp_183_fu_761_p3;
wire   [0:0] tmp_113_fu_785_p2;
...
wire   [7:0] p_Val2_s_61_fu_873_p3;
wire  signed [8:0] tmp_98_fu_887_p1;
wire  signed [8:0] tmp_99_fu_891_p1;
wire   [8:0] p_Val2_47_fu_895_p2;
wire   [0:0] tmp_100_fu_923_p2;
wire   [0:0] isneg_not_fu_937_p2;
wire   [0:0] brmerge_i_i_fu_933_p2;
wire   [0:0] underflow_8_fu_928_p2;
wire   [0:0] brmerge9_fu_942_p2;
wire   [7:0] result_V_mux_fu_947_p3;
wire   [7:0] p_result_V_fu_954_p3;
wire   [13:0] tmp_101_cast_fu_970_p1;
wire   [13:0] tmp_170_fu_974_p2;
reg   [14:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond5_fu_326_p2 == 1'd0))) begin
        ...
        tmp_162_reg_1003[9 : 1] <= tmp_162_fu_393_p2[9 : 1];
        tmp_164_reg_1008 <= tmp_164_fu_399_p1;
        tmp_166_reg_1013[6 : 1] <= tmp_166_fu_437_p2[6 : 1];
        tmp_175_cast_reg_998 <= tmp_175_cast_fu_365_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        newsignbit_reg_1165 <= p_Val2_52_fu_725_p2[32'd7];
        p_Val2_50_reg_1147 <= p_Val2_50_fu_691_p2;
        p_Val2_52_reg_1159 <= p_Val2_52_fu_725_p2;
        signbit_reg_1152 <= p_Val2_50_fu_691_p2[32'd15];
        tmp_112_reg_1178 <= {{p_Val2_50_fu_691_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        isneg_reg_1214 <= p_Val2_47_fu_895_p2[32'd8];
        newsignbit_8_reg_1227 <= result_V_fu_909_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        tmp_180_reg_1142 <= p_Val2_6_fu_665_p2[32'd5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond6_fu_443_p2))) begin
        tmp_169_reg_1026[13 : 1] <= tmp_169_fu_478_p2[13 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond8_fu_496_p2))) begin
        tmp_171_reg_1047 <= tmp_171_fu_512_p2;
        tmp_174_reg_1053 <= tmp_174_fu_537_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        tmp_173_reg_1059 <= tmp_173_fu_547_p2;
        tmp_176_reg_1064[10 : 1] <= tmp_176_fu_570_p2[10 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (1'd0 == exitcond_fu_576_p2))) begin
        tmp_178_reg_1082 <= tmp_178_fu_622_p2;
    end
end
...
assign Range1_all_ones_fu_768_p2 = ((tmp_112_reg_1178 == 2'd3) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_773_p2 = ((tmp_112_reg_1178 == 2'd0) ? 1'b1 : 1'b0);
...
assign brmerge9_fu_942_p2 = (newsignbit_8_reg_1227 | isneg_not_fu_937_p2);

assign brmerge_i_i6_fu_814_p2 = (newsignbit_reg_1165 | p_not_i_i_fu_808_p2);

assign brmerge_i_i_fu_933_p2 = (isneg_reg_1214 ^ newsignbit_8_reg_1227);

assign brmerge_i_i_i_fu_852_p2 = (underflow_fu_847_p2 | overflow_fu_824_p2);

assign buffer1_1_24_16x16_p_1_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_2_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_3_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_4_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_5_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_6_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_7_address0 = tmp_195_cast_fu_627_p1;

assign buffer1_1_24_16x16_p_address0 = tmp_195_cast_fu_627_p1;

assign carry_fu_745_p2 = (tmp_181_fu_717_p3 & tmp_111_fu_739_p2);
...
assign newsignbit_fu_731_p3 = p_Val2_52_fu_725_p2[32'd7];

assign output_V_address0 = tmp_186_cast_fu_979_p1;

assign output_V_d0 = ((brmerge9_fu_942_p2[0:0] === 1'b1) ? result_V_mux_fu_947_p3 : p_result_V_fu_954_p3);

assign overflow_fu_824_p2 = (brmerge_i_i6_fu_814_p2 & tmp_114_fu_819_p2);

assign p_38_i_i_fu_803_p2 = (carry_reg_1171 & Range1_all_ones_fu_768_p2);

assign p_41_i_i_fu_791_p2 = (signbit_reg_1152 & tmp_113_fu_785_p2);

assign p_Val2_47_fu_895_p2 = ($signed(tmp_98_fu_887_p1) + $signed(tmp_99_fu_891_p1));

assign p_Val2_48_mux_fu_867_p3 = ((brmerge_i_i_i_reg_1204[0:0] === 1'b1) ? 8'd127 : p_Val2_52_reg_1159);

assign p_Val2_50_fu_691_p2 = ($signed(tmp_159_cast_fu_687_p1) + $signed(p_Val2_6_reg_1137));

assign p_Val2_51_fu_704_p4 = {{p_Val2_50_fu_691_p2[13:6]}};

assign p_Val2_52_fu_725_p2 = (p_Val2_51_fu_704_p4 + tmp_110_fu_714_p1);

assign p_Val2_6_fu_665_p0 = weight_V_load_reg_1127;

assign p_Val2_6_fu_665_p1 = tmp_108_reg_1132;

assign p_Val2_6_fu_665_p2 = ($signed(p_Val2_6_fu_665_p0) * $signed(p_Val2_6_fu_665_p1));

assign p_Val2_s_61_fu_873_p3 = ((underflow_reg_1199[0:0] === 1'b1) ? 8'd128 : p_Val2_52_reg_1159);

assign p_not_i_i_fu_808_p2 = (deleted_zeros_fu_778_p3 ^ 1'd1);

assign p_result_V_fu_954_p3 = ((underflow_8_fu_928_p2[0:0] === 1'b1) ? 8'd128 : result_V_reg_1221);

assign p_shl1_cast_fu_433_p1 = tmp_165_fu_425_p3;

assign p_shl2_cast_fu_377_p1 = tmp_160_fu_369_p3;

assign p_shl3_cast_fu_389_p1 = tmp_161_fu_381_p3;

assign p_shl4_cast_fu_355_p1 = tmp_s_fu_347_p3;

assign p_shl5_cast_fu_458_p3 = {{tmp_167_fu_453_p2}, {4'd0}};

assign p_shl6_cast_fu_474_p1 = tmp_168_fu_466_p3;

assign p_shl7_cast_fu_552_p3 = {{tmp_174_reg_1053}, {4'd0}};

assign p_shl8_cast_fu_566_p1 = tmp_175_fu_559_p3;

assign p_shl_cast_fu_421_p1 = tmp_163_fu_413_p3;
...
assign sum_V_fu_879_p3 = ((underflow_not_fu_862_p2[0:0] === 1'b1) ? p_Val2_48_mux_fu_867_p3 : p_Val2_s_61_fu_873_p3);
...
assign tmp5_fu_858_p2 = (brmerge40_demorgan_i_reg_1194 | tmp_114_reg_1189);

assign tmp_100_fu_923_p2 = (newsignbit_8_reg_1227 ^ 1'd1);

assign tmp_101_cast_fu_970_p1 = w_reg_268;

assign tmp_102_cast_fu_508_p1 = m_reg_292;

assign tmp_103_fu_527_p2 = ($signed(h_reg_256) + $signed(tmp2_cast_fu_523_p1));

assign tmp_104_cast_fu_533_p1 = tmp_103_fu_527_p2;

assign tmp_105_cast_fu_588_p1 = n_reg_315;

assign tmp_106_fu_612_p2 = ($signed(tmp3_cast_fu_608_p1) + $signed(w_reg_268));

assign tmp_107_cast_fu_618_p1 = tmp_106_fu_612_p2;

assign tmp_109_fu_679_p3 = {{p_Val2_49_reg_303}, {6'd0}};

assign tmp_110_fu_714_p1 = tmp_180_reg_1142;

assign tmp_111_fu_739_p2 = (newsignbit_fu_731_p3 ^ 1'd1);

assign tmp_113_fu_785_p2 = (tmp_183_fu_761_p3 ^ 1'd1);

assign tmp_114_fu_819_p2 = (signbit_reg_1152 ^ 1'd1);

assign tmp_159_cast_fu_687_p1 = $signed(tmp_109_fu_679_p3);

assign tmp_159_fu_359_p2 = (p_shl4_cast_fu_355_p1 - tmp_cast_fu_343_p1);

assign tmp_160_fu_369_p3 = {{co_reg_245}, {4'd0}};

assign tmp_161_fu_381_p3 = {{co_reg_245}, {1'd0}};

assign tmp_162_fu_393_p2 = (p_shl2_cast_fu_377_p1 + p_shl3_cast_fu_389_p1);

assign tmp_163_fu_413_p3 = {{newIndex_fu_403_p4}, {4'd0}};

assign tmp_164_fu_399_p1 = co_reg_245[2:0];

assign tmp_165_fu_425_p3 = {{newIndex_fu_403_p4}, {1'd0}};

assign tmp_166_fu_437_p2 = (p_shl_cast_fu_421_p1 + p_shl1_cast_fu_433_p1);

assign tmp_167_fu_453_p2 = (tmp_cast_57_fu_449_p1 + tmp_162_reg_1003);

assign tmp_168_fu_466_p3 = {{tmp_167_fu_453_p2}, {1'd0}};

assign tmp_169_fu_478_p2 = (p_shl5_cast_fu_458_p3 + p_shl6_cast_fu_474_p1);

assign tmp_170_fu_974_p2 = (tmp_169_reg_1026 + tmp_101_cast_fu_970_p1);

assign tmp_171_fu_512_p2 = ($signed(tmp_175_cast_reg_998) + $signed(tmp_102_cast_fu_508_p1));

assign tmp_172_fu_542_p2 = tmp_171_reg_1047 << 9'd2;

assign tmp_173_fu_547_p2 = (tmp_172_fu_542_p2 - tmp_171_reg_1047);

assign tmp_174_fu_537_p2 = (tmp_166_reg_1013 + tmp_104_cast_fu_533_p1);

assign tmp_175_cast_fu_365_p1 = $signed(tmp_159_fu_359_p2);

assign tmp_175_fu_559_p3 = {{tmp_174_reg_1053}, {1'd0}};

assign tmp_176_fu_570_p2 = (p_shl8_cast_fu_566_p1 + p_shl7_cast_fu_552_p3);

assign tmp_177_fu_592_p2 = (tmp_105_cast_fu_588_p1 + tmp_173_reg_1059);

assign tmp_178_fu_622_p2 = (tmp_107_cast_fu_618_p1 + tmp_176_reg_1064);

assign tmp_181_fu_717_p3 = p_Val2_50_fu_691_p2[32'd13];

assign tmp_183_fu_761_p3 = p_Val2_50_reg_1147[32'd14];

assign tmp_186_cast_fu_979_p1 = tmp_170_fu_974_p2;

assign tmp_194_cast_fu_597_p1 = tmp_177_fu_592_p2;

assign tmp_195_cast_fu_627_p1 = tmp_178_reg_1082;

assign tmp_98_fu_887_p1 = $signed(p_Val2_s_reg_280);

assign tmp_99_fu_891_p1 = $signed(bias_V_q0);

assign tmp_cast_57_fu_449_p1 = h_reg_256;
...
assign underflow_8_fu_928_p2 = (isneg_reg_1214 & tmp_100_fu_923_p2);
...
assign weight_V_address0 = tmp_194_cast_fu_597_p1;

always @ (posedge ap_clk) begin
    tmp_162_reg_1003[0] <= 1'b0;
    tmp_166_reg_1013[0] <= 1'b0;
    tmp_169_reg_1026[0] <= 1'b0;
    tmp_176_reg_1064[0] <= 1'b0;
end
