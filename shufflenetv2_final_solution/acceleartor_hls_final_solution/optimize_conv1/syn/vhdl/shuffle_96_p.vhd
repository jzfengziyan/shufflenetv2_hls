...
architecture behav of shuffle_96_p is 
    ...
    signal tmp_438_cast_fu_288_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_438_cast_reg_601 : STD_LOGIC_VECTOR (12 downto 0);
    signal exitcond5_fu_246_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_443_cast_fu_332_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_443_cast_reg_606 : STD_LOGIC_VECTOR (11 downto 0);
    signal arrayNo_reg_611 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_448_cast_fu_386_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_448_cast_reg_616 : STD_LOGIC_VECTOR (8 downto 0);
    signal h_21_fu_396_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_21_reg_624 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_379_fu_439_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_379_reg_629 : STD_LOGIC_VECTOR (12 downto 0);
    signal exitcond4_fu_390_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_381_fu_470_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_381_reg_634 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_383_fu_501_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_383_reg_639 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_461_cast_fu_536_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_462_cast_fu_546_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_463_cast_fu_556_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_258_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_368_fu_270_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl4_cast_fu_266_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl5_cast_fu_278_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_369_fu_282_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_370_fu_292_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_371_fu_302_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_372_fu_314_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl2_cast_fu_310_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl3_cast_fu_322_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_373_fu_326_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_374_fu_346_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_375_fu_356_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_376_fu_368_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal p_shl_cast_fu_364_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl1_cast_fu_376_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_377_fu_380_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_211_cast_fu_410_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_378_fu_414_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_380_fu_445_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_382_fu_476_p2 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_384_fu_531_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_212_cast2_fu_523_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_385_fu_541_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_212_cast1_fu_519_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_386_fu_551_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond5_fu_246_p2 = ap_const_lv1_0))) then
                arrayNo_reg_611 <= co_reg_199(3 downto 1);
                    tmp_438_cast_reg_601(12 downto 1) <= tmp_438_cast_fu_288_p1(12 downto 1);
                    tmp_443_cast_reg_606(11 downto 1) <= tmp_443_cast_fu_332_p1(11 downto 1);
                    tmp_448_cast_reg_616(8 downto 1) <= tmp_448_cast_fu_386_p1(8 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_507_p2))) then
                output_V_addr_reg_657 <= tmp_462_cast_fu_546_p1(13 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond4_fu_390_p2))) then
                    tmp_379_reg_629(12 downto 1) <= tmp_379_fu_439_p2(12 downto 1);
                    tmp_381_reg_634(13 downto 1) <= tmp_381_fu_470_p2(13 downto 1);
                    tmp_383_reg_639(9 downto 1) <= tmp_383_fu_501_p2(9 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_438_cast_reg_601(0) <= '0';
    tmp_443_cast_reg_606(0) <= '0';
    tmp_448_cast_reg_616(0) <= '0';
    tmp_379_reg_629(0) <= '0';
    tmp_381_reg_634(0) <= '0';
    tmp_383_reg_639(0) <= '0';
    ...
    buffer1_1_96_4x4_p_V_1_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_2_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_3_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_4_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_5_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_6_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_7_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_8_address0 <= tmp_463_cast_fu_556_p1(9 - 1 downto 0);
    ...
    left_V_address0 <= tmp_461_cast_fu_536_p1(12 - 1 downto 0);
    ...
    p_shl11_cast_fu_431_p3 <= (tmp_378_fu_414_p2 & ap_const_lv1_0);
    p_shl1_cast_fu_376_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_376_fu_368_p3),8));
    p_shl2_cast_fu_310_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_371_fu_302_p3),11));
    p_shl3_cast_fu_322_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_372_fu_314_p3),11));
    p_shl4_cast_fu_266_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_258_p3),12));
    p_shl5_cast_fu_278_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_368_fu_270_p3),12));
    p_shl6_cast_fu_485_p3 <= (tmp_514_fu_481_p1 & ap_const_lv3_0);
    p_shl7_cast_fu_493_p3 <= (tmp_382_fu_476_p2 & ap_const_lv1_0);
    p_shl8_cast_fu_454_p3 <= (tmp_513_fu_450_p1 & ap_const_lv3_0);
    p_shl9_cast_fu_462_p3 <= (tmp_380_fu_445_p2 & ap_const_lv1_0);
    p_shl_cast_fu_364_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_375_fu_356_p3),8));
    ...
    tmp_368_fu_270_p3 <= (co_reg_199 & ap_const_lv1_0);
    tmp_369_fu_282_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_266_p1) - unsigned(p_shl5_cast_fu_278_p1));
    tmp_370_fu_292_p4 <= co_reg_199(7 downto 1);
    tmp_371_fu_302_p3 <= (tmp_370_fu_292_p4 & ap_const_lv3_0);
    tmp_372_fu_314_p3 <= (tmp_370_fu_292_p4 & ap_const_lv1_0);
    tmp_373_fu_326_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_310_p1) - unsigned(p_shl3_cast_fu_322_p1));
    tmp_374_fu_346_p4 <= co_reg_199(7 downto 4);
    tmp_375_fu_356_p3 <= (tmp_374_fu_346_p4 & ap_const_lv3_0);
    tmp_376_fu_368_p3 <= (tmp_374_fu_346_p4 & ap_const_lv1_0);
    tmp_377_fu_380_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_364_p1) - unsigned(p_shl1_cast_fu_376_p1));
    tmp_378_fu_414_p2 <= std_logic_vector(unsigned(tmp_211_cast_fu_410_p1) + unsigned(tmp_443_cast_reg_606));
    tmp_379_fu_439_p2 <= std_logic_vector(unsigned(p_shl10_cast_fu_423_p3) - unsigned(p_shl11_cast_fu_431_p3));
    tmp_380_fu_445_p2 <= std_logic_vector(unsigned(tmp_211_cast2_fu_406_p1) + unsigned(tmp_438_cast_reg_601));
    tmp_381_fu_470_p2 <= std_logic_vector(unsigned(p_shl8_cast_fu_454_p3) - unsigned(p_shl9_cast_fu_462_p3));
    tmp_382_fu_476_p2 <= std_logic_vector(unsigned(tmp_211_cast1_fu_402_p1) + unsigned(tmp_448_cast_reg_616));
    tmp_383_fu_501_p2 <= std_logic_vector(unsigned(p_shl6_cast_fu_485_p3) - unsigned(p_shl7_cast_fu_493_p3));
    tmp_384_fu_531_p2 <= std_logic_vector(unsigned(tmp_379_reg_629) + unsigned(tmp_212_cast_fu_527_p1));
    tmp_385_fu_541_p2 <= std_logic_vector(unsigned(tmp_381_reg_634) + unsigned(tmp_212_cast2_fu_523_p1));
    tmp_386_fu_551_p2 <= std_logic_vector(unsigned(tmp_383_reg_639) + unsigned(tmp_212_cast1_fu_519_p1));
        tmp_438_cast_fu_288_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_369_fu_282_p2),13));

        tmp_443_cast_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_373_fu_326_p2),12));

        tmp_448_cast_fu_386_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_377_fu_380_p2),9));

    tmp_461_cast_fu_536_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_384_fu_531_p2),64));
    tmp_462_cast_fu_546_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_385_fu_541_p2),64));
    tmp_463_cast_fu_556_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_386_fu_551_p2),64));
    tmp_511_fu_242_p1 <= co_reg_199(1 - 1 downto 0);
    tmp_512_fu_419_p1 <= tmp_378_fu_414_p2(10 - 1 downto 0);
    tmp_513_fu_450_p1 <= tmp_380_fu_445_p2(11 - 1 downto 0);
    tmp_514_fu_481_p1 <= tmp_382_fu_476_p2(7 - 1 downto 0);
