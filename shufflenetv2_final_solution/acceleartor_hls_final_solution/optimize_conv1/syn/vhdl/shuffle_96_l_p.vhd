...
architecture behav of shuffle_96_l_p is 
    ...
    signal tmp_466_cast_fu_257_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_466_cast_reg_476 : STD_LOGIC_VECTOR (12 downto 0);
    signal exitcond3_fu_215_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal arrayNo_reg_481 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_471_cast_fu_311_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_471_cast_reg_486 : STD_LOGIC_VECTOR (8 downto 0);
    signal h_22_fu_321_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_22_reg_494 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_394_fu_360_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_394_reg_499 : STD_LOGIC_VECTOR (13 downto 0);
    signal exitcond2_fu_315_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_396_fu_391_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_396_reg_504 : STD_LOGIC_VECTOR (9 downto 0);
    signal w_27_fu_403_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal w_27_reg_512 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp_397_fu_417_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_397_reg_517 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_481_cast_fu_427_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_480_cast_fu_460_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_227_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_387_fu_239_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl2_cast_fu_235_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl3_cast_fu_247_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_388_fu_251_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_389_fu_271_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_390_fu_281_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_391_fu_293_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal p_shl_cast_fu_289_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl1_cast_fu_301_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_392_fu_305_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_213_cast_fu_331_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_393_fu_335_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_395_fu_366_p2 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_398_fu_422_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond3_fu_215_p2 = ap_const_lv1_0))) then
                arrayNo_reg_481 <= co_reg_178(3 downto 1);
                    tmp_466_cast_reg_476(12 downto 1) <= tmp_466_cast_fu_257_p1(12 downto 1);
                    tmp_471_cast_reg_486(8 downto 1) <= tmp_471_cast_fu_311_p1(8 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond2_fu_315_p2))) then
                    tmp_394_reg_499(13 downto 1) <= tmp_394_fu_360_p2(13 downto 1);
                    tmp_396_reg_504(9 downto 1) <= tmp_396_fu_391_p2(9 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_397_p2) and (tmp_515_reg_464 = ap_const_lv1_0))) then
                tmp_397_reg_517 <= tmp_397_fu_417_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_466_cast_reg_476(0) <= '0';
    tmp_471_cast_reg_486(0) <= '0';
    tmp_394_reg_499(0) <= '0';
    tmp_396_reg_504(0) <= '0';
    ...
    buffer1_1_96_4x4_p_V_1_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_2_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_3_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_4_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_5_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_6_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_7_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_8_address0 <= tmp_481_cast_fu_427_p1(9 - 1 downto 0);
    ...
    output_V_address0 <= tmp_480_cast_fu_460_p1(13 - 1 downto 0);
    ...
    p_shl1_cast_fu_301_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_391_fu_293_p3),8));
    p_shl2_cast_fu_235_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_227_p3),12));
    p_shl3_cast_fu_247_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_387_fu_239_p3),12));
    p_shl4_cast_fu_375_p3 <= (tmp_517_fu_371_p1 & ap_const_lv3_0);
    p_shl5_cast_fu_383_p3 <= (tmp_395_fu_366_p2 & ap_const_lv1_0);
    p_shl6_cast_fu_344_p3 <= (tmp_516_fu_340_p1 & ap_const_lv3_0);
    p_shl7_cast_fu_352_p3 <= (tmp_393_fu_335_p2 & ap_const_lv1_0);
    p_shl_cast_fu_289_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_390_fu_281_p3),8));
    ...
    tmp_387_fu_239_p3 <= (co_reg_178 & ap_const_lv1_0);
    tmp_388_fu_251_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_235_p1) - unsigned(p_shl3_cast_fu_247_p1));
    tmp_389_fu_271_p4 <= co_reg_178(7 downto 4);
    tmp_390_fu_281_p3 <= (tmp_389_fu_271_p4 & ap_const_lv3_0);
    tmp_391_fu_293_p3 <= (tmp_389_fu_271_p4 & ap_const_lv1_0);
    tmp_392_fu_305_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_289_p1) - unsigned(p_shl1_cast_fu_301_p1));
    tmp_393_fu_335_p2 <= std_logic_vector(unsigned(tmp_213_cast_fu_331_p1) + unsigned(tmp_466_cast_reg_476));
    tmp_394_fu_360_p2 <= std_logic_vector(unsigned(p_shl6_cast_fu_344_p3) - unsigned(p_shl7_cast_fu_352_p3));
    tmp_395_fu_366_p2 <= std_logic_vector(unsigned(tmp_213_cast9_fu_327_p1) + unsigned(tmp_471_cast_reg_486));
    tmp_396_fu_391_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_375_p3) - unsigned(p_shl5_cast_fu_383_p3));
    tmp_397_fu_417_p2 <= std_logic_vector(unsigned(tmp_394_reg_499) + unsigned(tmp_214_cast_fu_413_p1));
    tmp_398_fu_422_p2 <= std_logic_vector(unsigned(tmp_396_reg_504) + unsigned(tmp_214_cast8_fu_409_p1));
        tmp_466_cast_fu_257_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_388_fu_251_p2),13));

        tmp_471_cast_fu_311_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_392_fu_305_p2),9));

    tmp_480_cast_fu_460_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_397_reg_517),64));
    tmp_481_cast_fu_427_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_398_fu_422_p2),64));
    tmp_515_fu_211_p1 <= co_reg_178(1 - 1 downto 0);
    tmp_516_fu_340_p1 <= tmp_393_fu_335_p2(11 - 1 downto 0);
    tmp_517_fu_371_p1 <= tmp_395_fu_366_p2(7 - 1 downto 0);
