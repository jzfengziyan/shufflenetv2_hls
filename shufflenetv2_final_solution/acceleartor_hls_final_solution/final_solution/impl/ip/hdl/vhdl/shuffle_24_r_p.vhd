...
architecture behav of shuffle_24_r_p is 
    ...
    signal tmp_1514_fu_426_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1514_reg_675 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_502_fu_454_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_502_reg_679 : STD_LOGIC_VECTOR (10 downto 0);
    signal co_29_fu_466_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal co_29_reg_687 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_58_reg_692 : STD_LOGIC_VECTOR (4 downto 0);
    signal exitcond3_fu_460_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_504_fu_511_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_504_reg_697 : STD_LOGIC_VECTOR (14 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_507_fu_541_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_507_reg_702 : STD_LOGIC_VECTOR (9 downto 0);
    signal h_26_fu_553_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal h_26_reg_710 : STD_LOGIC_VECTOR (4 downto 0);
    signal output_V_addr_reg_715 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal w_32_fu_616_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal w_32_reg_843 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_1483_cast_fu_572_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1484_cast_fu_582_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_fu_430_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_501_fu_442_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_503_fu_486_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_1515_fu_499_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl4_cast_fu_491_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal p_shl5_cast_fu_507_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_505_fu_517_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_506_fu_529_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_508_fu_567_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal w_cast1_cast6_fu_559_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_509_fu_577_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ShuffleNetV2_mux_qcK_x_U210 : component ShuffleNetV2_mux_qcK
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                co_29_reg_687 <= co_29_fu_466_p2;
                tmp_1514_reg_675 <= tmp_1514_fu_426_p1;
                    tmp_502_reg_679(10 downto 1) <= tmp_502_fu_454_p2(10 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                h_26_reg_710 <= h_26_fu_553_p2;
                    tmp_504_reg_697(14 downto 1) <= tmp_504_fu_511_p2(14 downto 1);
                    tmp_507_reg_702(9 downto 1) <= tmp_507_fu_541_p2(9 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                output_V_addr_reg_715 <= tmp_1483_cast_fu_572_p1(14 - 1 downto 0);
                w_32_reg_843 <= w_32_fu_616_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond3_fu_460_p2 = ap_const_lv1_0))) then
                tmp_58_reg_692 <= co_reg_393(5 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, tmp_1514_reg_675, ap_CS_fsm_state2, exitcond3_fu_460_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, exitcond2_fu_547_p2, exitcond_fu_610_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_1 = exitcond_fu_610_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_610_p2) and (tmp_1514_reg_675 = ap_const_lv1_0))) then
    ...
    buffer1_1_24_16x16_p_10_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_11_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_12_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_13_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_14_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_15_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_16_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_17_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_18_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_19_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_1_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_20_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_21_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_22_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_23_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_2_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_3_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_4_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_5_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_6_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_7_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_8_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_9_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_address0 <= tmp_1484_cast_fu_582_p1(9 - 1 downto 0);
    ...
    co_29_fu_466_p2 <= std_logic_vector(unsigned(ap_const_lv6_1) + unsigned(co_reg_393));
    ...
    h_26_fu_553_p2 <= std_logic_vector(unsigned(h_reg_404) + unsigned(ap_const_lv5_1));
    ...
    output_V_we0_assign_proc : process(tmp_1514_reg_675, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) and (tmp_1514_reg_675 = ap_const_lv1_1))) then 
    ...
    p_shl1_cast_fu_450_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_501_fu_442_p3),11));
    p_shl2_cast_fu_525_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_505_fu_517_p3),10));
    p_shl3_cast_fu_537_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_506_fu_529_p3),10));
    p_shl4_cast_fu_491_p3 <= (tmp_503_fu_486_p2 & ap_const_lv4_0);
    p_shl5_cast_fu_507_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1515_fu_499_p3),15));
    p_shl_cast_fu_438_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_430_p3),11));
    tmp_1483_cast_fu_572_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_508_fu_567_p2),32));
    tmp_1484_cast_fu_582_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_509_fu_577_p2),32));
    tmp_1514_fu_426_p1 <= co_reg_393(1 - 1 downto 0);
    tmp_1515_fu_499_p3 <= (tmp_503_fu_486_p2 & ap_const_lv1_0);
    tmp_501_fu_442_p3 <= (co_reg_393 & ap_const_lv1_0);
    tmp_502_fu_454_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_438_p1) + unsigned(p_shl1_cast_fu_450_p1));
    tmp_503_fu_486_p2 <= std_logic_vector(unsigned(h_cast2_cast_fu_482_p1) + unsigned(tmp_502_reg_679));
    tmp_504_fu_511_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_491_p3) + unsigned(p_shl5_cast_fu_507_p1));
    tmp_505_fu_517_p3 <= (h_reg_404 & ap_const_lv4_0);
    tmp_506_fu_529_p3 <= (h_reg_404 & ap_const_lv1_0);
    tmp_507_fu_541_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_525_p1) + unsigned(p_shl3_cast_fu_537_p1));
    tmp_508_fu_567_p2 <= std_logic_vector(unsigned(tmp_504_reg_697) + unsigned(w_cast1_cast_fu_563_p1));
    tmp_509_fu_577_p2 <= std_logic_vector(unsigned(tmp_507_reg_702) + unsigned(w_cast1_cast6_fu_559_p1));
    tmp_s_fu_430_p3 <= (co_reg_393 & ap_const_lv4_0);
    w_32_fu_616_p2 <= std_logic_vector(unsigned(w_reg_415) + unsigned(ap_const_lv5_1));
