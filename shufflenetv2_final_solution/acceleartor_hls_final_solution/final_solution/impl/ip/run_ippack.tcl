...
set Library     "hls"
set IPName      "ShuffleNetV2"
set Version     "1.0"
set DisplayName "Shufflenetv2"
set Revision    "1812220417"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "ShuffleNetV2"
...
set Interfaces {
    s_axi_CTL {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_CTL"
        param_prefix "C_S_AXI_CTL"
        addr_bits "8"
        port_width "AWADDR 8 WDATA 32 WSTRB 4 ARADDR 8 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 ap_return R 0x0 "Data signal of ap_return" {{0 32 ap_return R 0 "Bit 31 to 0 Data signal of ap_return"}}} {0x18 image_V W 0x0 "Data signal of image_V" {{0 32 image_V W 0 "Bit 31 to 0 Data signal of image_V"}}} {0x20 conv1_weight_V W 0x0 "Data signal of conv1_weight_V" {{0 32 conv1_weight_V W 0 "Bit 31 to 0 Data signal of conv1_weight_V"}}} {0x28 shuffle_conv_3x3_V W 0x0 "Data signal of shuffle_conv_3x3_V" {{0 32 shuffle_conv_3x3_V W 0 "Bit 31 to 0 Data signal of shuffle_conv_3x3_V"}}} {0x30 shuffle_conv_1x1_V W 0x0 "Data signal of shuffle_conv_1x1_V" {{0 32 shuffle_conv_1x1_V W 0 "Bit 31 to 0 Data signal of shuffle_conv_1x1_V"}}} {0x38 conv_last_weight_0_V W 0x0 "Data signal of conv_last_weight_0_V" {{0 32 conv_last_weight_0_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_0_V"}}} {0x40 conv_last_weight_1_V W 0x0 "Data signal of conv_last_weight_1_V" {{0 32 conv_last_weight_1_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_1_V"}}} {0x48 conv_last_weight_2_V W 0x0 "Data signal of conv_last_weight_2_V" {{0 32 conv_last_weight_2_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_2_V"}}} {0x50 conv_last_weight_3_V W 0x0 "Data signal of conv_last_weight_3_V" {{0 32 conv_last_weight_3_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_3_V"}}} {0x58 conv_last_weight_4_V W 0x0 "Data signal of conv_last_weight_4_V" {{0 32 conv_last_weight_4_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_4_V"}}} {0x60 conv_last_weight_5_V W 0x0 "Data signal of conv_last_weight_5_V" {{0 32 conv_last_weight_5_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_5_V"}}} {0x68 conv_last_weight_6_V W 0x0 "Data signal of conv_last_weight_6_V" {{0 32 conv_last_weight_6_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_6_V"}}} {0x70 conv_last_weight_7_V W 0x0 "Data signal of conv_last_weight_7_V" {{0 32 conv_last_weight_7_V W 0 "Bit 31 to 0 Data signal of conv_last_weight_7_V"}}} {0x78 fc_weight_V W 0x0 "Data signal of fc_weight_V" {{0 32 fc_weight_V W 0 "Bit 31 to 0 Data signal of fc_weight_V"}}} {0x80 bias_V W 0x0 "Data signal of bias_V" {{0 32 bias_V W 0 "Bit 31 to 0 Data signal of bias_V"}}} {0x88 fc_output_V W 0x0 "Data signal of fc_output_V" {{0 32 fc_output_V W 0 "Bit 31 to 0 Data signal of fc_output_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTL m_axi_DATA_INPUT_OUTPUT m_axi_DATA_OTHER_WEIGHTS m_axi_p3X3_1X1_WEIGHTS m_axi_DATA_BIAS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_DATA_INPUT_OUTPUT {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_INPUT_OUTPUT"
        data_width "32"
        param_prefix "C_M_AXI_DATA_INPUT_OUTPUT"
        ...
        has_dependant_on "1"
        offset_slave_name "s_axi_CTL"
        NUM_READ_OUTSTANDING "16"
        NUM_WRITE_OUTSTANDING "16"
        MAX_READ_BURST_LENGTH "16"
        MAX_WRITE_BURST_LENGTH "16"
    }
    m_axi_DATA_OTHER_WEIGHTS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_OTHER_WEIGHTS"
        data_width "32"
        param_prefix "C_M_AXI_DATA_OTHER_WEIGHTS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_p3X3_1X1_WEIGHTS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_p3X3_1X1_WEIGHTS"
        data_width "32"
        param_prefix "C_M_AXI_P3X3_1X1_WEIGHTS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_DATA_BIAS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_BIAS"
        data_width "32"
        param_prefix "C_M_AXI_DATA_BIAS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 14920202 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/lyh67/Downloads/shufflenetv2_final_solution/acceleartor_hls_final_solution/components.cpp C:/Users/lyh67/Downloads/shufflenetv2_final_solution/acceleartor_hls_final_solution/shufflenet.cpp C:/Users/lyh67/Downloads/shufflenetv2_final_solution/acceleartor_hls_final_solution/test.cpp}
if {$enable_xo_gen} {
