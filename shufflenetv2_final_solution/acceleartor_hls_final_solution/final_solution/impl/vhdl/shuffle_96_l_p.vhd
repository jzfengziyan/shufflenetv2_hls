...
architecture behav of shuffle_96_l_p is 
    ...
    signal tmp_1481_fu_270_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1481_reg_566 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_1393_cast_fu_304_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_1393_cast_reg_570 : STD_LOGIC_VECTOR (12 downto 0);
    signal co_25_fu_314_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal co_25_reg_578 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_lshr_f_cast_fu_320_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal exitcond3_fu_308_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1482_reg_588 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_1398_cast_fu_396_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_1398_cast_reg_599 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_457_fu_433_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_457_reg_604 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state13 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state13 : signal is "none";
    signal tmp_459_fu_468_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_459_reg_609 : STD_LOGIC_VECTOR (9 downto 0);
    signal h_22_fu_480_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_22_reg_617 : STD_LOGIC_VECTOR (2 downto 0);
    signal output_V_addr_reg_622 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_CS_fsm_state14 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state14 : signal is "none";
    signal w_28_fu_531_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal w_28_reg_690 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_1407_cast_fu_499_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1408_cast_fu_509_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_fu_274_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_451_fu_286_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl_cast_fu_282_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl1_cast_fu_294_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_452_fu_298_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_1483_fu_360_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_453_fu_367_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_1484_fu_375_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_454_fu_382_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl2_cast_fu_371_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl3_cast_fu_386_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_455_fu_390_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal h_cast2_cast_fu_404_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_456_fu_408_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_1485_fu_413_p1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_458_fu_439_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_1486_fu_444_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_1487_fu_456_p1 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_460_fu_494_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal w_cast1_cast8_fu_486_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_461_fu_504_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ShuffleNetV2_uremxdS_U613 : component ShuffleNetV2_uremxdS
    generic map (
        ID => 1,
        NUM_STAGE => 11,
        din0_WIDTH => 7,
    ...
    ShuffleNetV2_mux_yd2_U614 : component ShuffleNetV2_mux_yd2
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                    ...
                    tmp_1398_cast_reg_599(11 downto 1) <= tmp_1398_cast_fu_396_p1(11 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                co_25_reg_578 <= co_25_fu_314_p2;
                    tmp_1393_cast_reg_570(12 downto 1) <= tmp_1393_cast_fu_304_p1(12 downto 1);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state13)) then
                h_22_reg_617 <= h_22_fu_480_p2;
                    tmp_457_reg_604(13 downto 1) <= tmp_457_fu_433_p2(13 downto 1);
                    tmp_459_reg_609(9 downto 1) <= tmp_459_fu_468_p2(9 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state14)) then
                output_V_addr_reg_622 <= tmp_1407_cast_fu_499_p1(13 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond3_fu_308_p2 = ap_const_lv1_0))) then
                tmp_1482_reg_588 <= mul_fu_340_p2(15 downto 11);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_1393_cast_reg_570(0) <= '0';
    arrayNo_cast_reg_594(8 downto 7) <= "00";
    tmp_1398_cast_reg_599(0) <= '0';
    tmp_457_reg_604(0) <= '0';
    tmp_459_reg_609(0) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, tmp_1481_reg_566, ap_CS_fsm_state2, exitcond3_fu_308_p2, ap_CS_fsm_state13, ap_CS_fsm_state14, exitcond2_fu_474_p2, exitcond_fu_525_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state14 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state14) and (ap_const_lv1_1 = exitcond_fu_525_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state13;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state14) and (ap_const_lv1_0 = exitcond_fu_525_p2) and (tmp_1481_reg_566 = ap_const_lv1_1))) then
    ...
    buffer1_1_96_4x4_p_V_10_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_11_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_12_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_1_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_2_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_3_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_4_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_5_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_6_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_7_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_8_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    buffer1_1_96_4x4_p_V_9_address0 <= tmp_1408_cast_fu_509_p1(9 - 1 downto 0);
    ...
    co_25_fu_314_p2 <= std_logic_vector(unsigned(ap_const_lv8_1) + unsigned(co_reg_237));
    ...
    h_22_fu_480_p2 <= std_logic_vector(unsigned(ap_const_lv3_1) + unsigned(h_reg_248));
    ...
    output_V_we0_assign_proc : process(tmp_1481_reg_566, ap_CS_fsm_state16)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state16) and (tmp_1481_reg_566 = ap_const_lv1_0))) then 
    ...
    p_shl1_cast_fu_294_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_451_fu_286_p3),12));
    p_shl2_cast_fu_371_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_453_fu_367_p1),11));
    p_shl3_cast_fu_386_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_454_fu_382_p1),11));
    p_shl4_cast_fu_448_p3 <= (tmp_1486_fu_444_p1 & ap_const_lv3_0);
    p_shl5_cast_fu_460_p3 <= (tmp_1487_fu_456_p1 & ap_const_lv1_0);
    p_shl6_cast_fu_417_p3 <= (tmp_1485_fu_413_p1 & ap_const_lv3_0);
    p_shl7_cast_fu_425_p3 <= (tmp_456_fu_408_p2 & ap_const_lv1_0);
    p_shl_cast_fu_282_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_274_p3),12));
        tmp_1393_cast_fu_304_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_452_fu_298_p2),13));

        tmp_1398_cast_fu_396_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_455_fu_390_p2),12));

    tmp_1407_cast_fu_499_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_460_fu_494_p2),32));
    tmp_1408_cast_fu_509_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_461_fu_504_p2),32));
    tmp_1481_fu_270_p1 <= co_reg_237(1 - 1 downto 0);
    tmp_1483_fu_360_p3 <= (tmp_1482_reg_588 & ap_const_lv3_0);
    tmp_1484_fu_375_p3 <= (tmp_1482_reg_588 & ap_const_lv1_0);
    tmp_1485_fu_413_p1 <= tmp_456_fu_408_p2(11 - 1 downto 0);
    tmp_1486_fu_444_p1 <= tmp_458_fu_439_p2(7 - 1 downto 0);
    tmp_1487_fu_456_p1 <= tmp_458_fu_439_p2(9 - 1 downto 0);
    tmp_451_fu_286_p3 <= (co_reg_237 & ap_const_lv1_0);
    tmp_452_fu_298_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_282_p1) - unsigned(p_shl1_cast_fu_294_p1));
        tmp_453_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_1483_fu_360_p3),10));

        tmp_454_fu_382_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_1484_fu_375_p3),8));

    tmp_455_fu_390_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_371_p1) - unsigned(p_shl3_cast_fu_386_p1));
    tmp_456_fu_408_p2 <= std_logic_vector(unsigned(h_cast2_cast_fu_404_p1) + unsigned(tmp_1393_cast_reg_570));
    tmp_457_fu_433_p2 <= std_logic_vector(unsigned(p_shl6_cast_fu_417_p3) - unsigned(p_shl7_cast_fu_425_p3));
    tmp_458_fu_439_p2 <= std_logic_vector(unsigned(h_cast2_cast9_fu_400_p1) + unsigned(tmp_1398_cast_reg_599));
    tmp_459_fu_468_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_448_p3) - unsigned(p_shl5_cast_fu_460_p3));
    tmp_460_fu_494_p2 <= std_logic_vector(unsigned(tmp_457_reg_604) + unsigned(w_cast1_cast_fu_490_p1));
    tmp_461_fu_504_p2 <= std_logic_vector(unsigned(tmp_459_reg_609) + unsigned(w_cast1_cast8_fu_486_p1));
    tmp_s_fu_274_p3 <= (co_reg_237 & ap_const_lv3_0);
    w_28_fu_531_p2 <= std_logic_vector(unsigned(w_reg_259) + unsigned(ap_const_lv3_1));
