...
HD_PWD='C:/Users/lyh67/Downloads/shufflenetv2_final_solution/acceleartor_hls_final_solution/final_solution/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShuffleNetV2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShuffleNetV2.tcl
