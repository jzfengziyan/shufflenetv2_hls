...
wire   [9:0] co_33_fu_253_p2;
reg   [9:0] co_33_reg_526;
wire   [2:0] tmp_1758_fu_259_p1;
reg   [2:0] tmp_1758_reg_531;
wire   [0:0] exitcond35_fu_247_p2;
wire   [9:0] tmp_1703_cast_fu_281_p1;
reg   [9:0] tmp_1703_cast_reg_536;
wire   [11:0] tmp_1706_cast_fu_294_p3;
reg   [11:0] tmp_1706_cast_reg_541;
wire    ap_CS_fsm_state3;
wire   [2:0] h_31_fu_308_p2;
reg   [2:0] h_31_reg_549;
reg   [4:0] tmp_657_reg_554;
wire   [0:0] exitcond34_fu_302_p2;
wire    ap_CS_fsm_state4;
wire   [2:0] w_37_fu_361_p2;
reg   [2:0] w_37_reg_602;
reg   [0:0] isneg_reg_607;
wire    ap_CS_fsm_state5;
wire   [7:0] p_Val2_71_fu_410_p2;
reg   [7:0] p_Val2_71_reg_614;
...
reg   [2:0] h_reg_209;
reg   [7:0] p_Val2_68_reg_220;
reg   [2:0] w_reg_232;
wire   [31:0] tmp_1708_cast_fu_343_p1;
...
wire   [11:0] tmp_658_fu_338_p2;
wire   [7:0] p_Val2_69_fu_371_p10;
wire  signed [8:0] tmp_151_fu_392_p1;
wire  signed [8:0] tmp_150_fu_367_p1;
wire   [8:0] p_Val2_70_fu_396_p2;
wire   [0:0] tmp_153_fu_424_p2;
wire   [0:0] isneg_not_fu_438_p2;
wire   [0:0] brmerge_i_i_i_fu_434_p2;
wire   [0:0] underflow_fu_429_p2;
wire   [0:0] brmerge_fu_443_p2;
wire   [7:0] p_Val2_143_mux_fu_448_p3;
wire   [7:0] p_Val2_1_fu_455_p3;
wire   [5:0] p_lshr_cast_fu_478_p1;
wire   [3:0] tmp_76_fu_487_p4;
wire  signed [4:0] tmp_77_fu_497_p1;
wire   [0:0] tmp_1759_fu_470_p3;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        tmp_1706_cast_reg_541[11 : 2] <= tmp_1706_cast_fu_294_p3[11 : 2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        isneg_reg_607 <= p_Val2_70_fu_396_p2[32'd8];
        newsignbit_reg_620 <= p_Val2_71_fu_410_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond35_fu_247_p2 == 1'd0))) begin
        tmp_1703_cast_reg_536[8 : 2] <= tmp_1703_cast_fu_281_p1[8 : 2];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (exitcond34_fu_302_p2 == 1'd1))) begin
        tmp_657_reg_554 <= {{p_neg_fu_318_p2[8:4]}};
    end
end
...
assign co_33_fu_253_p2 = (co_reg_186 + 10'd1);

assign co_cast4_fu_243_p1 = co_reg_186;

assign conv_last_output_V_0_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_1_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_2_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_3_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_4_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_5_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_6_address0 = tmp_1708_cast_fu_343_p1;

assign conv_last_output_V_7_address0 = tmp_1708_cast_fu_343_p1;
...
assign h_31_fu_308_p2 = (h_reg_209 + 3'd1);
...
assign p_Val2_143_mux_fu_448_p3 = ((brmerge_i_i_i_fu_434_p2[0:0] === 1'b1) ? 8'd127 : p_Val2_71_reg_614);

assign p_Val2_1_fu_455_p3 = ((underflow_fu_429_p2[0:0] === 1'b1) ? 8'd128 : p_Val2_71_reg_614);

assign p_Val2_70_fu_396_p2 = ($signed(tmp_151_fu_392_p1) + $signed(tmp_150_fu_367_p1));

assign p_Val2_71_fu_410_p2 = (p_Val2_68_reg_220 + p_Val2_69_fu_371_p10);

assign p_lshr_cast_fu_478_p1 = tmp_657_reg_554;
...
assign sum_V_fu_462_p3 = ((brmerge_fu_443_p2[0:0] === 1'b1) ? p_Val2_143_mux_fu_448_p3 : p_Val2_1_fu_455_p3);

assign tmp_150_fu_367_p1 = $signed(p_Val2_68_reg_220);

assign tmp_151_fu_392_p1 = $signed(p_Val2_69_fu_371_p10);

assign tmp_153_fu_424_p2 = (newsignbit_reg_620 ^ 1'd1);

assign tmp_1703_cast_fu_281_p1 = tmp_fu_273_p3;

assign tmp_1706_cast_fu_294_p3 = {{tmp_s_fu_289_p2}, {2'd0}};

assign tmp_1708_cast_fu_343_p1 = tmp_658_fu_338_p2;

assign tmp_1758_fu_259_p1 = co_reg_186[2:0];

assign tmp_1759_fu_470_p3 = p_Val2_s_reg_197[32'd7];

assign tmp_658_fu_338_p2 = (tmp_1706_cast_reg_541 + w_cast2_cast_fu_334_p1);

assign tmp_76_fu_487_p4 = {{p_Val2_s_reg_197[7:4]}};

assign tmp_77_fu_497_p1 = $signed(tmp_76_fu_487_p4);

assign tmp_78_fu_505_p3 = ((tmp_1759_fu_470_p3[0:0] === 1'b1) ? p_neg_t_fu_481_p2 : p_lshr_f_cast_fu_501_p1);

assign tmp_fu_273_p3 = {{newIndex_fu_263_p4}, {2'd0}};

assign tmp_s_fu_289_p2 = (h_cast3_cast_fu_285_p1 + tmp_1703_cast_reg_536);

assign tmp_tr_fu_314_p1 = $signed(p_Val2_s_reg_197);

assign underflow_fu_429_p2 = (isneg_reg_607 & tmp_153_fu_424_p2);

assign w_37_fu_361_p2 = (w_reg_232 + 3'd1);

assign w_cast2_cast_fu_334_p1 = w_reg_232;

always @ (posedge ap_clk) begin
    co_cast4_reg_518[31:10] <= 22'b0000000000000000000000;
    tmp_1703_cast_reg_536[1:0] <= 2'b00;
    tmp_1703_cast_reg_536[9] <= 1'b0;
    tmp_1706_cast_reg_541[1:0] <= 2'b00;
end
