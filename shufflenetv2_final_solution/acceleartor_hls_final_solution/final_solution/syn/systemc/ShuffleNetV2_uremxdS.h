...
#ifndef __ShuffleNetV2_uremxdS__HH__
#define __ShuffleNetV2_uremxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremxdS) {
    ...
    SC_CTOR(ShuffleNetV2_uremxdS):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
