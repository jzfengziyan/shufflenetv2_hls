...
#ifndef __ShuffleNetV2_uremtde__HH__
#define __ShuffleNetV2_uremtde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremtde) {
    ...
    SC_CTOR(ShuffleNetV2_uremtde):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
