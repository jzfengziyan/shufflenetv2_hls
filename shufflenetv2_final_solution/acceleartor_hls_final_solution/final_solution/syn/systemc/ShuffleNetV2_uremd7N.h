...
#ifndef __ShuffleNetV2_uremd7N__HH__
#define __ShuffleNetV2_uremd7N__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremd7N) {
    ...
    SC_CTOR(ShuffleNetV2_uremd7N):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
