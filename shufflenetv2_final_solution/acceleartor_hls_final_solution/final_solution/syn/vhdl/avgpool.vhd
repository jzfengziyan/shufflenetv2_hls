...
architecture behav of avgpool is 
    ...
    signal co_33_fu_253_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal co_33_reg_526 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_1758_fu_259_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_1758_reg_531 : STD_LOGIC_VECTOR (2 downto 0);
    signal exitcond35_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1703_cast_fu_281_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_1703_cast_reg_536 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_1706_cast_fu_294_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_1706_cast_reg_541 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal h_31_fu_308_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_31_reg_549 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_657_reg_554 : STD_LOGIC_VECTOR (4 downto 0);
    signal exitcond34_fu_302_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal w_37_fu_361_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal w_37_reg_602 : STD_LOGIC_VECTOR (2 downto 0);
    signal isneg_reg_607 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal p_Val2_71_fu_410_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_71_reg_614 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_68_reg_220 : STD_LOGIC_VECTOR (7 downto 0);
    signal w_reg_232 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_1708_cast_fu_343_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_658_fu_338_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_Val2_69_fu_371_p10 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_151_fu_392_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_150_fu_367_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_Val2_70_fu_396_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_153_fu_424_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_143_mux_fu_448_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_1759_fu_470_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ShuffleNetV2_mux_zec_x_U699 : component ShuffleNetV2_mux_zec
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    port map (
        ...
        din9 => tmp_1758_reg_531,
        dout => p_Val2_69_fu_371_p10);
    ...
    p_Val2_68_reg_220_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond34_fu_302_p2))) then 
                p_Val2_68_reg_220 <= p_Val2_s_reg_197;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
                p_Val2_68_reg_220 <= sum_V_fu_462_p3;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_1 = exitcond_fu_355_p2))) then 
                p_Val2_s_reg_197 <= p_Val2_68_reg_220;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond35_fu_247_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                h_31_reg_549 <= h_31_fu_308_p2;
                    tmp_1706_cast_reg_541(11 downto 2) <= tmp_1706_cast_fu_294_p3(11 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                isneg_reg_607 <= p_Val2_70_fu_396_p2(8 downto 8);
                newsignbit_reg_620 <= p_Val2_71_fu_410_p2(7 downto 7);
                p_Val2_71_reg_614 <= p_Val2_71_fu_410_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond35_fu_247_p2 = ap_const_lv1_0))) then
                    tmp_1703_cast_reg_536(8 downto 2) <= tmp_1703_cast_fu_281_p1(8 downto 2);
                tmp_1758_reg_531 <= tmp_1758_fu_259_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (exitcond34_fu_302_p2 = ap_const_lv1_1))) then
                tmp_657_reg_554 <= p_neg_fu_318_p2(8 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                w_37_reg_602 <= w_37_fu_361_p2;
            end if;
        end if;
    end process;
    co_cast4_reg_518(31 downto 10) <= "0000000000000000000000";
    tmp_1703_cast_reg_536(1 downto 0) <= "00";
    tmp_1703_cast_reg_536(9) <= '0';
    tmp_1706_cast_reg_541(1 downto 0) <= "00";
    ...
    co_33_fu_253_p2 <= std_logic_vector(unsigned(co_reg_186) + unsigned(ap_const_lv10_1));
    co_cast4_fu_243_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(co_reg_186),32));
    conv_last_output_V_0_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_1_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_2_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_3_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_4_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_5_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_6_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_7_address0 <= tmp_1708_cast_fu_343_p1(10 - 1 downto 0);
    ...
    h_31_fu_308_p2 <= std_logic_vector(unsigned(h_reg_209) + unsigned(ap_const_lv3_1));
    ...
    p_Val2_143_mux_fu_448_p3 <= 
        ap_const_lv8_7F when (brmerge_i_i_i_fu_434_p2(0) = '1') else 
        p_Val2_71_reg_614;
    p_Val2_1_fu_455_p3 <= 
        ap_const_lv8_80 when (underflow_fu_429_p2(0) = '1') else 
        p_Val2_71_reg_614;
    p_Val2_70_fu_396_p2 <= std_logic_vector(signed(tmp_151_fu_392_p1) + signed(tmp_150_fu_367_p1));
    p_Val2_71_fu_410_p2 <= std_logic_vector(unsigned(p_Val2_68_reg_220) + unsigned(p_Val2_69_fu_371_p10));
    p_lshr_cast_fu_478_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_657_reg_554),6));
    ...
    sum_V_fu_462_p3 <= 
        p_Val2_143_mux_fu_448_p3 when (brmerge_fu_443_p2(0) = '1') else 
        p_Val2_1_fu_455_p3;
        tmp_150_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_68_reg_220),9));

        tmp_151_fu_392_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_69_fu_371_p10),9));

    tmp_153_fu_424_p2 <= (newsignbit_reg_620 xor ap_const_lv1_1);
    tmp_1703_cast_fu_281_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_273_p3),10));
    tmp_1706_cast_fu_294_p3 <= (tmp_s_fu_289_p2 & ap_const_lv2_0);
    tmp_1708_cast_fu_343_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_658_fu_338_p2),32));
    tmp_1758_fu_259_p1 <= co_reg_186(3 - 1 downto 0);
    tmp_1759_fu_470_p3 <= p_Val2_s_reg_197(7 downto 7);
    tmp_658_fu_338_p2 <= std_logic_vector(unsigned(tmp_1706_cast_reg_541) + unsigned(w_cast2_cast_fu_334_p1));
    ...
    tmp_78_fu_505_p3 <= 
        p_neg_t_fu_481_p2 when (tmp_1759_fu_470_p3(0) = '1') else 
        p_lshr_f_cast_fu_501_p1;
    tmp_fu_273_p3 <= (newIndex_fu_263_p4 & ap_const_lv2_0);
    tmp_s_fu_289_p2 <= std_logic_vector(unsigned(h_cast3_cast_fu_285_p1) + unsigned(tmp_1703_cast_reg_536));
        tmp_tr_fu_314_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_s_reg_197),9));

    underflow_fu_429_p2 <= (isneg_reg_607 and tmp_153_fu_424_p2);
    w_37_fu_361_p2 <= std_logic_vector(unsigned(w_reg_232) + unsigned(ap_const_lv3_1));
