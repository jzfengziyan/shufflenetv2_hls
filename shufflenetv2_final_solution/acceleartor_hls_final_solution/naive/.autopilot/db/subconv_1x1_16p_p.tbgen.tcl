...
set C_modelArgList {
	{ weight_V int 8 regular {array 2304 { 1 3 } 1 1 }  }
	{ bias_V int 8 regular {array 48 { 1 3 } 1 1 }  }
	{ shuffleunit0_2_outpu int 8 regular {array 15552 { 1 3 } 1 1 } {global 0}  }
	{ ShuffleConvs_1_Downs int 8 regular {array 15552 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_1_Downs", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "ShuffleConvs_1_DownsampleUnit__conv1r_output_p.V","cData": "int8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 47,"step" : 1},{"low" : 0,"up" : 17,"step" : 1},{"low" : 0,"up" : 17,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ weight_V_address0 sc_out sc_lv 12 signal 0 } 
	...
	{ shuffleunit0_2_outpu_q0 sc_in sc_lv 8 signal 2 } 
	...
	{ ShuffleConvs_1_Downs_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "weight_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4191841", "Max" : "4191841"}
	, {"Name" : "Interval", "Min" : "4191841", "Max" : "4191841"}
]}
...
set Spec2ImplPortList { 
	weight_V { ap_memory {  { weight_V_address0 mem_address 1 12 }  { weight_V_ce0 mem_ce 1 1 }  { weight_V_q0 mem_dout 0 8 } } }
	...
	ShuffleConvs_1_Downs { ap_memory {  { ShuffleConvs_1_Downs_address0 mem_address 1 14 }  { ShuffleConvs_1_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_1_Downs_we0 mem_we 1 1 }  { ShuffleConvs_1_Downs_d0 mem_din 1 8 } } }
}
