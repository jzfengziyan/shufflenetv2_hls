...
set C_modelArgList {
	{ right_V int 8 regular {array 3456 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ right_V_address0 sc_out sc_lv 12 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "right_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "right_V", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	right_V { ap_memory {  { right_V_address0 mem_address 1 12 }  { right_V_ce0 mem_ce 1 1 }  { right_V_q0 mem_dout 0 8 } } }
