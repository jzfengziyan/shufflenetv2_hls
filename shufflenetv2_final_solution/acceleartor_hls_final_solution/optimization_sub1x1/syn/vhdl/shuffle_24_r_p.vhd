...
architecture behav of shuffle_24_r_p is 
    ...
    signal tmp_550_fu_213_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_550_reg_458 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal co_29_fu_223_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal co_29_reg_465 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_442_fu_253_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_442_reg_470 : STD_LOGIC_VECTOR (10 downto 0);
    signal exitcond3_fu_217_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal arrayNo_reg_475 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_446_fu_303_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_446_reg_480 : STD_LOGIC_VECTOR (6 downto 0);
    signal h_26_fu_315_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal h_26_reg_488 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_448_fu_354_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_448_reg_493 : STD_LOGIC_VECTOR (14 downto 0);
    signal exitcond2_fu_309_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_450_fu_385_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_450_reg_498 : STD_LOGIC_VECTOR (10 downto 0);
    signal w_31_fu_397_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal w_31_reg_506 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp_451_fu_411_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_451_reg_511 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal tmp_562_cast_fu_421_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_561_cast_fu_454_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_229_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_441_fu_241_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_shl3_cast_fu_249_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl2_cast_fu_237_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_443_fu_269_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_444_fu_279_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_445_fu_291_p3 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_447_fu_329_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_551_fu_342_p3 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_449_fu_360_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_552_fu_373_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl4_cast_fu_365_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl5_cast_fu_381_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_219_cast_fu_407_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_219_cast8_fu_403_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_452_fu_416_p2 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ShuffleNetV2_mux_jbC_x_U84 : component ShuffleNetV2_mux_jbC
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond3_fu_217_p2 = ap_const_lv1_0))) then
                arrayNo_reg_475 <= co_reg_180(3 downto 1);
                    tmp_442_reg_470(10 downto 1) <= tmp_442_fu_253_p2(10 downto 1);
                    tmp_446_reg_480(6 downto 1) <= tmp_446_fu_303_p2(6 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                co_29_reg_465 <= co_29_fu_223_p2;
                tmp_550_reg_458 <= tmp_550_fu_213_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond2_fu_309_p2))) then
                    tmp_448_reg_493(14 downto 1) <= tmp_448_fu_354_p2(14 downto 1);
                    tmp_450_reg_498(10 downto 1) <= tmp_450_fu_385_p2(10 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_391_p2) and (tmp_550_reg_458 = ap_const_lv1_1))) then
                tmp_451_reg_511 <= tmp_451_fu_411_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, tmp_550_reg_458, ap_CS_fsm_state2, exitcond3_fu_217_p2, ap_CS_fsm_state3, exitcond2_fu_309_p2, ap_CS_fsm_state4, exitcond_fu_391_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (exitcond_fu_391_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_391_p2) and (tmp_550_reg_458 = ap_const_lv1_0))) then
    ...
    buffer1_1_24_16x16_p_1_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_2_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_3_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_4_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_5_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_6_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_7_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_address0 <= tmp_562_cast_fu_421_p1(10 - 1 downto 0);
    ...
    co_29_fu_223_p2 <= std_logic_vector(unsigned(ap_const_lv6_1) + unsigned(co_reg_180));
    ...
    h_26_fu_315_p2 <= std_logic_vector(unsigned(h_reg_191) + unsigned(ap_const_lv5_1));
    output_V_address0 <= tmp_561_cast_fu_454_p1(14 - 1 downto 0);
    ...
    output_V_we0_assign_proc : process(tmp_550_reg_458, ap_CS_fsm_state6)
    begin
        if (((tmp_550_reg_458 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
    ...
    p_shl1_cast_fu_299_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_445_fu_291_p3),7));
    p_shl2_cast_fu_237_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_229_p3),11));
    p_shl3_cast_fu_249_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_441_fu_241_p3),11));
    p_shl4_cast_fu_365_p3 <= (tmp_449_fu_360_p2 & ap_const_lv4_0);
    p_shl5_cast_fu_381_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_552_fu_373_p3),11));
    p_shl6_cast_fu_334_p3 <= (tmp_447_fu_329_p2 & ap_const_lv4_0);
    p_shl7_cast_fu_350_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_551_fu_342_p3),15));
    p_shl_cast_fu_287_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_444_fu_279_p3),7));
    tmp_219_cast8_fu_403_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(w_reg_202),11));
    tmp_219_cast_fu_407_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(w_reg_202),15));
    tmp_441_fu_241_p3 <= (co_reg_180 & ap_const_lv1_0);
    tmp_442_fu_253_p2 <= std_logic_vector(unsigned(p_shl3_cast_fu_249_p1) + unsigned(p_shl2_cast_fu_237_p1));
    tmp_443_fu_269_p4 <= co_reg_180(5 downto 4);
    tmp_444_fu_279_p3 <= (tmp_443_fu_269_p4 & ap_const_lv4_0);
    tmp_445_fu_291_p3 <= (tmp_443_fu_269_p4 & ap_const_lv1_0);
    tmp_446_fu_303_p2 <= std_logic_vector(unsigned(p_shl1_cast_fu_299_p1) + unsigned(p_shl_cast_fu_287_p1));
    tmp_447_fu_329_p2 <= std_logic_vector(unsigned(tmp_cast_fu_325_p1) + unsigned(tmp_442_reg_470));
    tmp_448_fu_354_p2 <= std_logic_vector(unsigned(p_shl6_cast_fu_334_p3) + unsigned(p_shl7_cast_fu_350_p1));
    tmp_449_fu_360_p2 <= std_logic_vector(unsigned(tmp_cast9_fu_321_p1) + unsigned(tmp_446_reg_480));
    tmp_450_fu_385_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_365_p3) + unsigned(p_shl5_cast_fu_381_p1));
    tmp_451_fu_411_p2 <= std_logic_vector(unsigned(tmp_448_reg_493) + unsigned(tmp_219_cast_fu_407_p1));
    tmp_452_fu_416_p2 <= std_logic_vector(unsigned(tmp_450_reg_498) + unsigned(tmp_219_cast8_fu_403_p1));
    tmp_550_fu_213_p1 <= co_reg_180(1 - 1 downto 0);
    tmp_551_fu_342_p3 <= (tmp_447_fu_329_p2 & ap_const_lv1_0);
    tmp_552_fu_373_p3 <= (tmp_449_fu_360_p2 & ap_const_lv1_0);
    tmp_561_cast_fu_454_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_451_reg_511),64));
    tmp_562_cast_fu_421_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_452_fu_416_p2),64));
