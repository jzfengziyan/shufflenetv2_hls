...
wire   [0:0] tmp_507_fu_211_p1;
reg   [0:0] tmp_507_reg_464;
wire    ap_CS_fsm_state2;
wire   [7:0] co_23_fu_221_p2;
reg   [7:0] co_23_reg_471;
wire  signed [12:0] tmp_419_cast_fu_257_p1;
reg  signed [12:0] tmp_419_cast_reg_476;
wire   [0:0] exitcond3_fu_215_p2;
reg   [2:0] arrayNo_reg_481;
wire  signed [8:0] tmp_424_cast_fu_311_p1;
reg  signed [8:0] tmp_424_cast_reg_486;
wire   [2:0] h_20_fu_321_p2;
reg   [2:0] h_20_reg_494;
wire    ap_CS_fsm_state3;
wire   [13:0] tmp_362_fu_360_p2;
reg   [13:0] tmp_362_reg_499;
wire   [0:0] exitcond2_fu_315_p2;
wire   [9:0] tmp_364_fu_391_p2;
reg   [9:0] tmp_364_reg_504;
wire   [2:0] w_25_fu_403_p2;
reg   [2:0] w_25_reg_512;
wire    ap_CS_fsm_state4;
wire   [13:0] tmp_365_fu_417_p2;
reg   [13:0] tmp_365_reg_517;
...
wire   [63:0] tmp_434_cast_fu_427_p1;
wire   [63:0] tmp_433_cast_fu_460_p1;
wire   [10:0] tmp_s_fu_227_p3;
wire   [8:0] tmp_355_fu_239_p3;
wire   [11:0] p_shl2_cast_fu_235_p1;
wire   [11:0] p_shl3_cast_fu_247_p1;
wire   [11:0] tmp_356_fu_251_p2;
wire   [3:0] tmp_357_fu_271_p4;
wire   [6:0] tmp_358_fu_281_p3;
wire   [4:0] tmp_359_fu_293_p3;
wire   [7:0] p_shl_cast_fu_289_p1;
wire   [7:0] p_shl1_cast_fu_301_p1;
wire   [7:0] tmp_360_fu_305_p2;
wire   [12:0] tmp_208_cast_fu_331_p1;
wire   [12:0] tmp_361_fu_335_p2;
wire   [10:0] tmp_508_fu_340_p1;
wire   [13:0] p_shl6_cast_fu_344_p3;
wire   [13:0] p_shl7_cast_fu_352_p3;
wire   [8:0] tmp_208_cast9_fu_327_p1;
wire   [8:0] tmp_363_fu_366_p2;
wire   [6:0] tmp_509_fu_371_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond3_fu_215_p2 == 1'd0))) begin
        ...
        tmp_419_cast_reg_476[12 : 1] <= tmp_419_cast_fu_257_p1[12 : 1];
        tmp_424_cast_reg_486[8 : 1] <= tmp_424_cast_fu_311_p1[8 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond2_fu_315_p2))) begin
        tmp_362_reg_499[13 : 1] <= tmp_362_fu_360_p2[13 : 1];
        tmp_364_reg_504[9 : 1] <= tmp_364_fu_391_p2[9 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (1'd0 == exitcond_fu_397_p2) & (tmp_507_reg_464 == 1'd1))) begin
...
always @ (*) begin
    if (((tmp_507_reg_464 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
        output_V_we0 = 1'b1;
    end else begin
        output_V_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (exitcond_fu_397_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if (((1'b1 == ap_CS_fsm_state4) & (1'd0 == exitcond_fu_397_p2) & (tmp_507_reg_464 == 1'd0))) begin
...
assign buffer1_1_96_4x4_p_V_1_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_2_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_3_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_4_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_5_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_6_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_7_address0 = tmp_434_cast_fu_427_p1;

assign buffer1_1_96_4x4_p_V_8_address0 = tmp_434_cast_fu_427_p1;
...
assign output_V_address0 = tmp_433_cast_fu_460_p1;

assign output_V_d0 = tmp_reg_562;

assign p_shl1_cast_fu_301_p1 = tmp_359_fu_293_p3;

assign p_shl2_cast_fu_235_p1 = tmp_s_fu_227_p3;

assign p_shl3_cast_fu_247_p1 = tmp_355_fu_239_p3;

assign p_shl4_cast_fu_375_p3 = {{tmp_509_fu_371_p1}, {3'd0}};

assign p_shl5_cast_fu_383_p3 = {{tmp_363_fu_366_p2}, {1'd0}};

assign p_shl6_cast_fu_344_p3 = {{tmp_508_fu_340_p1}, {3'd0}};

assign p_shl7_cast_fu_352_p3 = {{tmp_361_fu_335_p2}, {1'd0}};

assign p_shl_cast_fu_289_p1 = tmp_358_fu_281_p3;
...
assign tmp_355_fu_239_p3 = {{co_reg_178}, {1'd0}};

assign tmp_356_fu_251_p2 = (p_shl2_cast_fu_235_p1 - p_shl3_cast_fu_247_p1);

assign tmp_357_fu_271_p4 = {{co_reg_178[7:4]}};

assign tmp_358_fu_281_p3 = {{tmp_357_fu_271_p4}, {3'd0}};

assign tmp_359_fu_293_p3 = {{tmp_357_fu_271_p4}, {1'd0}};

assign tmp_360_fu_305_p2 = (p_shl_cast_fu_289_p1 - p_shl1_cast_fu_301_p1);

assign tmp_361_fu_335_p2 = ($signed(tmp_208_cast_fu_331_p1) + $signed(tmp_419_cast_reg_476));

assign tmp_362_fu_360_p2 = (p_shl6_cast_fu_344_p3 - p_shl7_cast_fu_352_p3);

assign tmp_363_fu_366_p2 = ($signed(tmp_208_cast9_fu_327_p1) + $signed(tmp_424_cast_reg_486));

assign tmp_364_fu_391_p2 = (p_shl4_cast_fu_375_p3 - p_shl5_cast_fu_383_p3);

assign tmp_365_fu_417_p2 = (tmp_362_reg_499 + tmp_209_cast_fu_413_p1);

assign tmp_366_fu_422_p2 = (tmp_364_reg_504 + tmp_209_cast8_fu_409_p1);

assign tmp_419_cast_fu_257_p1 = $signed(tmp_356_fu_251_p2);

assign tmp_424_cast_fu_311_p1 = $signed(tmp_360_fu_305_p2);

assign tmp_433_cast_fu_460_p1 = tmp_365_reg_517;

assign tmp_434_cast_fu_427_p1 = tmp_366_fu_422_p2;

assign tmp_507_fu_211_p1 = co_reg_178[0:0];

assign tmp_508_fu_340_p1 = tmp_361_fu_335_p2[10:0];

assign tmp_509_fu_371_p1 = tmp_363_fu_366_p2[6:0];
...
always @ (posedge ap_clk) begin
    tmp_419_cast_reg_476[0] <= 1'b0;
    tmp_424_cast_reg_486[0] <= 1'b0;
    tmp_362_reg_499[0] <= 1'b0;
    tmp_364_reg_504[0] <= 1'b0;
end
