...
wire   [10:0] tmp_7_fu_254_p2;
reg   [10:0] tmp_7_reg_846;
wire    ap_CS_fsm_state2;
wire  signed [10:0] tmp_9_cast_fu_278_p1;
reg  signed [10:0] tmp_9_cast_reg_851;
wire  signed [11:0] tmp_19_cast_fu_288_p1;
reg  signed [11:0] tmp_19_cast_reg_856;
...
wire   [10:0] tmp_24_fu_402_p2;
reg   [10:0] tmp_24_reg_905;
wire    ap_CS_fsm_state5;
wire   [1:0] m_1_fu_414_p2;
reg   [1:0] m_1_reg_913;
wire   [14:0] tmp_26_fu_468_p2;
reg   [14:0] tmp_26_reg_918;
...
wire   [7:0] p_Val2_8_35_fu_749_p3;
...
wire   [0:0] underflow_1_fu_804_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_19_cast_reg_856[11 : 1] <= tmp_19_cast_fu_288_p1[11 : 1];
        tmp_7_reg_846[10 : 1] <= tmp_7_fu_254_p2[10 : 1];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        newsignbit_1_reg_1046 <= result_V_fu_785_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        output_V_addr_reg_887 <= tmp_24_cast_fu_362_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_32_reg_961 <= p_Val2_5_fu_541_p2[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        tmp_20_reg_874[12 : 1] <= tmp_20_fu_333_p2[12 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond4_fu_408_p2))) begin
        tmp_26_reg_918[14 : 1] <= tmp_26_fu_468_p2[14 : 1];
    end
end
...
assign brmerge9_fu_818_p2 = (newsignbit_1_reg_1046 | isneg_not_fu_813_p2);

assign brmerge_i_i1_fu_690_p2 = (newsignbit_reg_984 | p_not_i_i_fu_684_p2);

assign brmerge_i_i_fu_809_p2 = (isneg_reg_1033 ^ newsignbit_1_reg_1046);

assign brmerge_i_i_i_fu_728_p2 = (underflow_fu_723_p2 | overflow_fu_700_p2);

assign carry_fu_621_p2 = (tmp_33_fu_593_p3 & tmp_15_fu_615_p2);
...
assign input_V_address0 = tmp_33_cast_fu_530_p1;
...
assign p_Val2_8_35_fu_749_p3 = ((underflow_reg_1018[0:0] === 1'b1) ? 8'd128 : p_Val2_8_reg_978);
...
assign p_result_V_fu_830_p3 = ((underflow_1_fu_804_p2[0:0] === 1'b1) ? 8'd128 : result_V_reg_1040);

assign p_shl2_cast_fu_268_p1 = tmp_8_fu_260_p3;

assign p_shl3_cast_fu_238_p1 = tmp_1_fu_230_p3;

assign p_shl4_cast_fu_250_p1 = tmp_6_fu_242_p3;

assign p_shl5_cast_fu_317_p3 = {{tmp_19_fu_313_p1}, {3'd0}};

assign p_shl6_cast_fu_325_p3 = {{tmp_13_fu_308_p2}, {1'd0}};

assign p_shl8_cast_fu_452_p1 = tmp_27_fu_444_p3;

assign p_shl9_cast_fu_464_p1 = tmp_28_fu_456_p3;
...
assign sum_V_fu_755_p3 = ((underflow_not_fu_738_p2[0:0] === 1'b1) ? p_Val2_8_mux_fu_743_p3 : p_Val2_8_35_fu_749_p3);
...
assign tmp_11_fu_282_p2 = (p_shl3_cast_fu_238_p1 - p_shl4_cast_fu_250_p1);

assign tmp_12_cast_fu_563_p1 = $signed(tmp_12_fu_555_p3);

assign tmp_12_fu_555_p3 = {{p_Val2_4_reg_198}, {6'd0}};

assign tmp_13_fu_308_p2 = ($signed(h_cast9_cast_fu_304_p1) + $signed(tmp_19_cast_reg_856));

assign tmp_14_fu_590_p1 = tmp_32_reg_961;

assign tmp_15_fu_615_p2 = (newsignbit_fu_607_p3 ^ 1'd1);

assign tmp_16_fu_661_p2 = (tmp_35_fu_637_p3 ^ 1'd1);

assign tmp_18_fu_695_p2 = (signbit_reg_971 ^ 1'd1);

assign tmp_19_cast_fu_288_p1 = $signed(tmp_11_fu_282_p2);

assign tmp_19_fu_313_p1 = tmp_13_fu_308_p2[9:0];

assign tmp_1_fu_230_p3 = {{co_reg_140}, {3'd0}};

assign tmp_20_fu_333_p2 = (p_shl5_cast_fu_317_p3 - p_shl6_cast_fu_325_p3);

assign tmp_21_fu_357_p2 = (tmp_20_reg_874 + w_cast8_cast_fu_353_p1);

assign tmp_22_fu_391_p2 = ($signed(m_cast7_cast_fu_387_p1) + $signed(tmp_9_cast_reg_851));

assign tmp_23_fu_396_p2 = tmp_22_fu_391_p2 << 11'd2;

assign tmp_24_cast_fu_362_p1 = tmp_21_fu_357_p2;

assign tmp_24_fu_402_p2 = (tmp_23_fu_396_p2 - tmp_22_fu_391_p2);

assign tmp_25_fu_439_p2 = (tmp_cast_cast_fu_435_p1 + tmp_7_reg_846);

assign tmp_26_fu_468_p2 = (p_shl8_cast_fu_452_p1 + p_shl9_cast_fu_464_p1);

assign tmp_27_fu_444_p3 = {{tmp_25_fu_439_p2}, {3'd0}};

assign tmp_28_fu_456_p3 = {{tmp_25_fu_439_p2}, {1'd0}};

assign tmp_29_fu_484_p2 = (tmp_24_reg_905 + n_cast6_cast_fu_480_p1);

assign tmp_2_fu_373_p3 = {{w_reg_163}, {1'd0}};

assign tmp_30_fu_525_p2 = (tmp_10_cast_cast_fu_521_p1 + tmp_26_reg_918);

assign tmp_32_cast_fu_489_p1 = tmp_29_fu_484_p2;

assign tmp_33_cast_fu_530_p1 = tmp_30_fu_525_p2;

assign tmp_33_fu_593_p3 = p_Val2_6_fu_567_p2[32'd13];

assign tmp_35_fu_637_p3 = p_Val2_6_reg_966[32'd14];

assign tmp_3_fu_763_p1 = $signed(p_Val2_s_reg_175);

assign tmp_4_fu_767_p1 = $signed(bias_V_q0);

assign tmp_5_fu_799_p2 = (newsignbit_1_reg_1046 ^ 1'd1);

assign tmp_6_fu_242_p3 = {{co_reg_140}, {1'd0}};

assign tmp_7_fu_254_p2 = (p_shl4_cast_fu_250_p1 + p_shl3_cast_fu_238_p1);

assign tmp_8_fu_260_p3 = {{co_reg_140}, {2'd0}};

assign tmp_9_cast_fu_278_p1 = $signed(tmp_9_fu_272_p2);

assign tmp_9_fu_272_p2 = (p_shl2_cast_fu_268_p1 - co_cast_cast_fu_226_p1);
...
assign underflow_1_fu_804_p2 = (isneg_reg_1033 & tmp_5_fu_799_p2);
...
assign weight_V_address0 = tmp_32_cast_fu_489_p1;

always @ (posedge ap_clk) begin
    tmp_7_reg_846[0] <= 1'b0;
    tmp_19_cast_reg_856[0] <= 1'b0;
    tmp_20_reg_874[0] <= 1'b0;
    tmp_reg_882[0] <= 1'b0;
    tmp_2_reg_895[0] <= 1'b0;
    tmp_26_reg_918[0] <= 1'b0;
end
