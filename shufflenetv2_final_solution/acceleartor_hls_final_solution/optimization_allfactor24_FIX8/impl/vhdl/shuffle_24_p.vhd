...
architecture behav of shuffle_24_p is 
    ...
    signal tmp_2081_fu_454_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2081_reg_782 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_567_fu_482_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_567_reg_786 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_570_fu_534_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_570_reg_804 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_572_fu_573_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_572_reg_809 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_574_fu_604_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_574_reg_814 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_577_fu_634_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_577_reg_819 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_688_cast_fu_669_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_689_cast_fu_679_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_690_cast_fu_689_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_fu_458_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_566_fu_470_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_shl_cast_fu_466_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl1_cast_fu_478_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_568_fu_510_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_569_fu_522_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_571_fu_548_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_2082_fu_561_p3 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_573_fu_579_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_2083_fu_592_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl6_cast_fu_584_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal p_shl7_cast_fu_600_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_575_fu_610_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_576_fu_622_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_578_fu_664_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal w_cast1_cast6_fu_656_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_579_fu_674_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal w_cast1_cast5_fu_652_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_580_fu_684_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ShuffleNetV2_mux_dEe_x_U224 : component ShuffleNetV2_mux_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ...
                tmp_2081_reg_782 <= tmp_2081_fu_454_p1;
                    tmp_567_reg_786(10 downto 1) <= tmp_567_fu_482_p2(10 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                h_31_reg_827 <= h_31_fu_646_p2;
                    tmp_572_reg_809(13 downto 1) <= tmp_572_fu_573_p2(13 downto 1);
                    tmp_574_reg_814(14 downto 1) <= tmp_574_fu_604_p2(14 downto 1);
                    tmp_577_reg_819(9 downto 1) <= tmp_577_fu_634_p2(9 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                output_V_addr_reg_837 <= tmp_689_cast_fu_679_p1(14 - 1 downto 0);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond5_fu_488_p2 = ap_const_lv1_0))) then
                p_lshr_f_cast_reg_799 <= co_reg_411(5 downto 1);
                    tmp_570_reg_804(9 downto 1) <= tmp_570_fu_534_p2(9 downto 1);
            end if;
        end if;
    end process;
    tmp_567_reg_786(0) <= '0';
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, tmp_2081_reg_782, ap_CS_fsm_state2, exitcond5_fu_488_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, exitcond4_fu_640_p2, exitcond_fu_717_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_1 = exitcond_fu_717_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_717_p2) and (tmp_2081_reg_782 = ap_const_lv1_1))) then
    ...
    buffer1_1_24_16x16_p_10_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_11_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_12_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_13_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_14_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_15_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_16_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_17_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_18_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_19_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_1_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_20_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_21_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_22_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_23_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_2_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_3_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_4_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_5_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_6_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_7_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_8_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_9_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    buffer1_1_24_16x16_p_address0 <= tmp_690_cast_fu_689_p1(9 - 1 downto 0);
    ...
    left_V_address0 <= tmp_688_cast_fu_669_p1(13 - 1 downto 0);
    ...
    p_shl1_cast_fu_478_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_566_fu_470_p3),11));
    p_shl2_cast_fu_518_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_568_fu_510_p3),10));
    p_shl3_cast_fu_530_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_569_fu_522_p3),10));
    p_shl4_cast_fu_618_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_575_fu_610_p3),10));
    p_shl5_cast_fu_630_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_576_fu_622_p3),10));
    p_shl6_cast_fu_584_p3 <= (tmp_573_fu_579_p2 & ap_const_lv4_0);
    p_shl7_cast_fu_600_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2083_fu_592_p3),15));
    p_shl8_cast_fu_553_p3 <= (tmp_571_fu_548_p2 & ap_const_lv4_0);
    p_shl9_cast_fu_569_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2082_fu_561_p3),14));
    p_shl_cast_fu_466_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_458_p3),11));
    tmp_2081_fu_454_p1 <= co_reg_411(1 - 1 downto 0);
    tmp_2082_fu_561_p3 <= (tmp_571_fu_548_p2 & ap_const_lv1_0);
    tmp_2083_fu_592_p3 <= (tmp_573_fu_579_p2 & ap_const_lv1_0);
    tmp_566_fu_470_p3 <= (co_reg_411 & ap_const_lv1_0);
    tmp_567_fu_482_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_466_p1) + unsigned(p_shl1_cast_fu_478_p1));
    tmp_568_fu_510_p3 <= (p_lshr_f_cast_fu_500_p4 & ap_const_lv4_0);
    tmp_569_fu_522_p3 <= (p_lshr_f_cast_fu_500_p4 & ap_const_lv1_0);
    tmp_570_fu_534_p2 <= std_logic_vector(unsigned(p_shl3_cast_fu_530_p1) + unsigned(p_shl2_cast_fu_518_p1));
    tmp_571_fu_548_p2 <= std_logic_vector(unsigned(h_cast2_cast_fu_544_p1) + unsigned(tmp_570_reg_804));
    tmp_572_fu_573_p2 <= std_logic_vector(unsigned(p_shl8_cast_fu_553_p3) + unsigned(p_shl9_cast_fu_569_p1));
    tmp_573_fu_579_p2 <= std_logic_vector(unsigned(h_cast2_cast3_fu_540_p1) + unsigned(tmp_567_reg_786));
    tmp_574_fu_604_p2 <= std_logic_vector(unsigned(p_shl6_cast_fu_584_p3) + unsigned(p_shl7_cast_fu_600_p1));
    tmp_575_fu_610_p3 <= (h_reg_422 & ap_const_lv4_0);
    tmp_576_fu_622_p3 <= (h_reg_422 & ap_const_lv1_0);
    tmp_577_fu_634_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_618_p1) + unsigned(p_shl5_cast_fu_630_p1));
    tmp_578_fu_664_p2 <= std_logic_vector(unsigned(tmp_572_reg_809) + unsigned(w_cast1_cast_fu_660_p1));
    tmp_579_fu_674_p2 <= std_logic_vector(unsigned(tmp_574_reg_814) + unsigned(w_cast1_cast6_fu_656_p1));
    tmp_580_fu_684_p2 <= std_logic_vector(unsigned(tmp_577_reg_819) + unsigned(w_cast1_cast5_fu_652_p1));
    tmp_688_cast_fu_669_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_578_fu_664_p2),32));
    tmp_689_cast_fu_679_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_579_fu_674_p2),32));
    tmp_690_cast_fu_689_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_580_fu_684_p2),32));
