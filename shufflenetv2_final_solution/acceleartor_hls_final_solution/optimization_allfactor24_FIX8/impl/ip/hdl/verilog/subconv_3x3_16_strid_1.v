...
wire   [10:0] tmp_140_fu_260_p2;
reg   [10:0] tmp_140_reg_860;
wire    ap_CS_fsm_state2;
wire  signed [9:0] tmp_152_cast_fu_284_p1;
reg  signed [9:0] tmp_152_cast_reg_865;
wire   [9:0] tmp_144_fu_300_p2;
reg   [9:0] tmp_144_reg_870;
wire   [5:0] co_5_fu_312_p2;
reg   [5:0] co_5_reg_878;
reg   [5:0] bias_V_addr_reg_883;
wire   [0:0] exitcond8_fu_306_p2;
wire   [13:0] tmp_148_fu_351_p2;
reg   [13:0] tmp_148_reg_888;
...
wire   [9:0] tmp_152_fu_420_p2;
reg   [9:0] tmp_152_reg_919;
wire    ap_CS_fsm_state5;
wire   [1:0] m_5_fu_432_p2;
reg   [1:0] m_5_reg_927;
wire   [14:0] tmp_154_fu_482_p2;
reg   [14:0] tmp_154_reg_932;
...
reg   [1:0] tmp_59_reg_1011;
wire   [0:0] p_38_i_i_fu_693_p2;
reg   [0:0] p_38_i_i_reg_1017;
wire    ap_CS_fsm_state10;
wire   [0:0] tmp_61_fu_709_p2;
reg   [0:0] tmp_61_reg_1022;
...
wire  signed [8:0] tmp_52_fu_781_p1;
wire  signed [8:0] tmp_51_fu_777_p1;
wire   [8:0] p_Val2_40_fu_785_p2;
wire   [0:0] tmp_53_fu_813_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_59_reg_1011 <= {{p_Val2_43_fu_581_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_140_reg_860[10 : 1] <= tmp_140_fu_260_p2[10 : 1];
        tmp_144_reg_870[9 : 1] <= tmp_144_fu_300_p2[9 : 1];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        output_V_addr_reg_901 <= tmp_160_cast_fu_380_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_159_reg_975 <= p_Val2_6_fu_555_p2[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        tmp_148_reg_888[13 : 1] <= tmp_148_fu_351_p2[13 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond4_fu_426_p2))) begin
        tmp_154_reg_932[14 : 1] <= tmp_154_fu_482_p2[14 : 1];
    end
end
...
assign Range1_all_ones_fu_658_p2 = ((tmp_59_reg_1011 == 2'd3) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_663_p2 = ((tmp_59_reg_1011 == 2'd0) ? 1'b1 : 1'b0);
...
assign carry_fu_635_p2 = (tmp_160_fu_607_p3 & tmp_58_fu_629_p2);
...
assign input_V_address0 = tmp_169_cast_fu_544_p1;
...
assign overflow_fu_714_p2 = (brmerge_i_i5_fu_704_p2 & tmp_61_fu_709_p2);

assign p_38_i_i_fu_693_p2 = (carry_reg_1004 & Range1_all_ones_fu_658_p2);

assign p_41_i_i_fu_681_p2 = (signbit_reg_985 & tmp_60_fu_675_p2);

assign p_Val2_40_fu_785_p2 = ($signed(tmp_52_fu_781_p1) + $signed(tmp_51_fu_777_p1));

assign p_Val2_40_mux_fu_757_p3 = ((brmerge_i_i_i_reg_1037[0:0] === 1'b1) ? 8'd127 : p_Val2_45_reg_992);

assign p_Val2_43_fu_581_p2 = ($signed(tmp_108_cast_fu_577_p1) + $signed(p_Val2_6_reg_970));

assign p_Val2_44_fu_594_p4 = {{p_Val2_43_fu_581_p2[13:6]}};

assign p_Val2_45_fu_615_p2 = (p_Val2_44_fu_594_p4 + tmp_57_fu_604_p1);
...
assign p_shl2_cast_fu_274_p1 = tmp_141_fu_266_p3;

assign p_shl3_cast_fu_240_p1 = tmp_138_fu_232_p3;

assign p_shl4_cast1_fu_252_p1 = tmp_139_fu_244_p3;

assign p_shl4_cast_fu_256_p1 = tmp_139_fu_244_p3;

assign p_shl5_cast_fu_335_p1 = tmp_146_fu_327_p3;

assign p_shl6_cast_fu_347_p1 = tmp_147_fu_339_p3;

assign p_shl8_cast_fu_462_p3 = {{tmp_153_fu_457_p2}, {4'd0}};

assign p_shl9_cast_fu_478_p1 = tmp_155_fu_470_p3;

assign p_shl_cast_fu_296_p1 = tmp_143_fu_288_p3;
...
assign tmp5_fu_748_p2 = (brmerge40_demorgan_i_reg_1027 | tmp_61_reg_1022);

assign tmp_102_cast_cast_fu_453_p1 = tmp_54_fu_448_p2;

assign tmp_106_cast_cast_fu_535_p1 = tmp_55_fu_530_p2;

assign tmp_108_cast_fu_577_p1 = $signed(tmp_56_fu_569_p3);

assign tmp_138_fu_232_p3 = {{co_reg_142}, {4'd0}};

assign tmp_139_fu_244_p3 = {{co_reg_142}, {1'd0}};

assign tmp_140_fu_260_p2 = (p_shl4_cast_fu_256_p1 + p_shl3_cast_fu_240_p1);

assign tmp_141_fu_266_p3 = {{co_reg_142}, {2'd0}};

assign tmp_142_fu_278_p2 = (p_shl2_cast_fu_274_p1 - co_cast_cast_fu_228_p1);

assign tmp_143_fu_288_p3 = {{co_reg_142}, {3'd0}};

assign tmp_144_fu_300_p2 = (p_shl4_cast1_fu_252_p1 + p_shl_cast_fu_296_p1);

assign tmp_145_fu_322_p2 = (h_cast9_cast_fu_318_p1 + tmp_144_reg_870);

assign tmp_146_fu_327_p3 = {{tmp_145_fu_322_p2}, {3'd0}};

assign tmp_147_fu_339_p3 = {{tmp_145_fu_322_p2}, {1'd0}};

assign tmp_148_fu_351_p2 = (p_shl5_cast_fu_335_p1 + p_shl6_cast_fu_347_p1);

assign tmp_149_fu_375_p2 = (tmp_148_reg_888 + w_cast8_cast_fu_371_p1);

assign tmp_150_fu_409_p2 = ($signed(m_cast7_cast_fu_405_p1) + $signed(tmp_152_cast_reg_865));

assign tmp_151_fu_414_p2 = tmp_150_fu_409_p2 << 10'd2;

assign tmp_152_cast_fu_284_p1 = $signed(tmp_142_fu_278_p2);

assign tmp_152_fu_420_p2 = (tmp_151_fu_414_p2 - tmp_150_fu_409_p2);

assign tmp_153_fu_457_p2 = (tmp_102_cast_cast_fu_453_p1 + tmp_140_reg_860);

assign tmp_154_fu_482_p2 = (p_shl8_cast_fu_462_p3 + p_shl9_cast_fu_478_p1);

assign tmp_155_fu_470_p3 = {{tmp_153_fu_457_p2}, {1'd0}};

assign tmp_156_fu_498_p2 = (tmp_152_reg_919 + n_cast6_cast_fu_494_p1);

assign tmp_157_fu_539_p2 = (tmp_106_cast_cast_fu_535_p1 + tmp_154_reg_932);

assign tmp_160_cast_fu_380_p1 = tmp_149_fu_375_p2;

assign tmp_160_fu_607_p3 = p_Val2_43_fu_581_p2[32'd13];

assign tmp_162_fu_651_p3 = p_Val2_43_reg_980[32'd14];

assign tmp_168_cast_fu_503_p1 = tmp_156_fu_498_p2;

assign tmp_169_cast_fu_544_p1 = tmp_157_fu_539_p2;

assign tmp_51_fu_777_p1 = $signed(p_Val2_s_reg_177);

assign tmp_52_fu_781_p1 = $signed(bias_V_q0);

assign tmp_53_fu_813_p2 = (newsignbit_7_reg_1060 ^ 1'd1);

assign tmp_54_fu_448_p2 = ($signed(tmp2_cast_fu_444_p1) + $signed(tmp_reg_896));

assign tmp_55_fu_530_p2 = ($signed(tmp3_cast_fu_526_p1) + $signed(tmp_s_reg_909));

assign tmp_56_fu_569_p3 = {{p_Val2_42_reg_200}, {6'd0}};

assign tmp_57_fu_604_p1 = tmp_159_reg_975;

assign tmp_58_fu_629_p2 = (newsignbit_fu_621_p3 ^ 1'd1);

assign tmp_60_fu_675_p2 = (tmp_162_fu_651_p3 ^ 1'd1);

assign tmp_61_fu_709_p2 = (signbit_reg_985 ^ 1'd1);

assign tmp_fu_363_p3 = {{h_reg_153}, {1'd0}};

assign tmp_s_fu_391_p3 = {{w_reg_165}, {1'd0}};

assign underflow_7_fu_818_p2 = (isneg_reg_1047 & tmp_53_fu_813_p2);
...
assign weight_V_address0 = tmp_168_cast_fu_503_p1;

always @ (posedge ap_clk) begin
    tmp_140_reg_860[0] <= 1'b0;
    tmp_144_reg_870[0] <= 1'b0;
    tmp_148_reg_888[0] <= 1'b0;
    tmp_reg_896[0] <= 1'b0;
    tmp_s_reg_909[0] <= 1'b0;
    tmp_154_reg_932[0] <= 1'b0;
end
