...
architecture behav of avgpool is 
    ...
    signal co_35_fu_253_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal co_35_reg_526 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_2154_fu_259_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2154_reg_531 : STD_LOGIC_VECTOR (2 downto 0);
    signal exitcond35_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_799_cast_fu_281_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_799_cast_reg_536 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_802_cast_fu_294_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_802_cast_reg_541 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal h_35_fu_308_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_35_reg_549 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_658_reg_554 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal p_Val2_75_fu_410_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_75_reg_614 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_72_reg_220 : STD_LOGIC_VECTOR (7 downto 0);
    signal w_reg_232 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_804_cast_fu_343_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_659_fu_338_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_Val2_73_fu_371_p10 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_162_fu_392_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_161_fu_367_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_Val2_74_fu_396_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_164_fu_424_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_193_mux_fu_448_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_1_fu_455_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_lshr_cast_fu_478_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_60_fu_487_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_61_fu_497_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_2155_fu_470_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_neg_t_fu_481_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_lshr_f_cast_fu_501_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_62_fu_505_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ShuffleNetV2_mux_udo_x_U761 : component ShuffleNetV2_mux_udo
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    p_Val2_72_reg_220_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                h_35_reg_549 <= h_35_fu_308_p2;
                    tmp_802_cast_reg_541(11 downto 2) <= tmp_802_cast_fu_294_p3(11 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                isneg_reg_607 <= p_Val2_74_fu_396_p2(8 downto 8);
                newsignbit_reg_620 <= p_Val2_75_fu_410_p2(7 downto 7);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond35_fu_247_p2 = ap_const_lv1_0))) then
                tmp_2154_reg_531 <= tmp_2154_fu_259_p1;
                    tmp_799_cast_reg_536(8 downto 2) <= tmp_799_cast_fu_281_p1(8 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (exitcond34_fu_302_p2 = ap_const_lv1_1))) then
                tmp_658_reg_554 <= p_neg_fu_318_p2(8 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_799_cast_reg_536(1 downto 0) <= "00";
    tmp_799_cast_reg_536(9) <= '0';
    tmp_802_cast_reg_541(1 downto 0) <= "00";
    ...
    co_35_fu_253_p2 <= std_logic_vector(unsigned(co_reg_186) + unsigned(ap_const_lv10_1));
    co_cast4_fu_243_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(co_reg_186),32));
    conv_last_output_V_0_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_1_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_2_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_3_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_4_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_5_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_6_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_7_address0 <= tmp_804_cast_fu_343_p1(10 - 1 downto 0);
    ...
    begin
        ...
        output_V_d0 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_62_fu_505_p3),8));
    ...
    p_Val2_193_mux_fu_448_p3 <= 
        ap_const_lv8_7F when (brmerge_i_i_i_fu_434_p2(0) = '1') else 
        p_Val2_75_reg_614;
    p_Val2_1_fu_455_p3 <= 
        ap_const_lv8_80 when (underflow_fu_429_p2(0) = '1') else 
        p_Val2_75_reg_614;
    p_Val2_74_fu_396_p2 <= std_logic_vector(signed(tmp_162_fu_392_p1) + signed(tmp_161_fu_367_p1));
    p_Val2_75_fu_410_p2 <= std_logic_vector(unsigned(p_Val2_72_reg_220) + unsigned(p_Val2_73_fu_371_p10));
    p_lshr_cast_fu_478_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_658_reg_554),6));
    p_lshr_f_cast_fu_501_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_61_fu_497_p1),6));
    ...
    sum_V_fu_462_p3 <= 
        p_Val2_193_mux_fu_448_p3 when (brmerge_fu_443_p2(0) = '1') else 
        p_Val2_1_fu_455_p3;
        tmp_161_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_72_reg_220),9));

        tmp_162_fu_392_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_73_fu_371_p10),9));

    tmp_164_fu_424_p2 <= (newsignbit_reg_620 xor ap_const_lv1_1);
    tmp_2154_fu_259_p1 <= co_reg_186(3 - 1 downto 0);
    tmp_2155_fu_470_p3 <= p_Val2_s_reg_197(7 downto 7);
    tmp_60_fu_487_p4 <= p_Val2_s_reg_197(7 downto 4);
        tmp_61_fu_497_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_60_fu_487_p4),5));

    tmp_62_fu_505_p3 <= 
        p_neg_t_fu_481_p2 when (tmp_2155_fu_470_p3(0) = '1') else 
        p_lshr_f_cast_fu_501_p1;
    tmp_659_fu_338_p2 <= std_logic_vector(unsigned(tmp_802_cast_reg_541) + unsigned(w_cast2_cast_fu_334_p1));
    tmp_799_cast_fu_281_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_273_p3),10));
    tmp_802_cast_fu_294_p3 <= (tmp_s_fu_289_p2 & ap_const_lv2_0);
    tmp_804_cast_fu_343_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_659_fu_338_p2),32));
    tmp_fu_273_p3 <= (newIndex_fu_263_p4 & ap_const_lv2_0);
    tmp_s_fu_289_p2 <= std_logic_vector(unsigned(h_cast3_cast_fu_285_p1) + unsigned(tmp_799_cast_reg_536));
        tmp_tr_fu_314_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_s_reg_197),9));

    underflow_fu_429_p2 <= (isneg_reg_607 and tmp_164_fu_424_p2);
