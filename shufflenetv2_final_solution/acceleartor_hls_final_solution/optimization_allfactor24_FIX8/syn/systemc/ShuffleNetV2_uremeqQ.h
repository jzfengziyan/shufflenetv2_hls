...
#ifndef __ShuffleNetV2_uremeqQ__HH__
#define __ShuffleNetV2_uremeqQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremeqQ) {
    ...
    SC_CTOR(ShuffleNetV2_uremeqQ):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
