...
#ifndef __ShuffleNetV2_mul_esQ__HH__
#define __ShuffleNetV2_mul_esQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_mul_esQ) {
    ...
    SC_CTOR(ShuffleNetV2_mul_esQ):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
