...
MUL_DP::MUL_DP(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ShuffleNetV2_mul_cud_U6 = new ShuffleNetV2_mul_cud<1,2,8,26,33>("ShuffleNetV2_mul_cud_U6");
    ShuffleNetV2_mul_cud_U6->clk(ap_clk);
    ShuffleNetV2_mul_cud_U6->reset(ap_rst);
    ShuffleNetV2_mul_cud_U6->din0(w_V_read_reg_127);
    ShuffleNetV2_mul_cud_U6->din1(r_V_reg_132);
    ShuffleNetV2_mul_cud_U6->ce(grp_fu_80_ce);
    ShuffleNetV2_mul_cud_U6->dout(grp_fu_80_p2);
    ...
    SC_METHOD(thread_tmp_464_fu_108_p1);
    sensitive << ( tmp_2567_reg_147 );
    ...
    sc_trace(mVcdFile, tmp_2567_reg_147, "tmp_2567_reg_147");
    ...
    sc_trace(mVcdFile, tmp_464_fu_108_p1, "tmp_464_fu_108_p1");
...
MUL_DP::~MUL_DP() {
    ...
    delete ShuffleNetV2_mul_cud_U6;
}
...
void MUL_DP::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_ce.read(), ap_const_logic_1))) {
        ...
        tmp_2567_reg_147 = grp_fu_80_p2.read().range(15, 15);
...
void MUL_DP::thread_loc_V_fu_111_p2() {
    loc_V_fu_111_p2 = (!tmp_464_fu_108_p1.read().is_01() || !p_Result_s_reg_152.read().is_01())? sc_lv<16>(): (sc_biguint<16>(tmp_464_fu_108_p1.read()) + sc_biguint<16>(p_Result_s_reg_152.read()));
}
...
void MUL_DP::thread_tmp_464_fu_108_p1() {
    tmp_464_fu_108_p1 = esl_zext<16,1>(tmp_2567_reg_147.read());
}
