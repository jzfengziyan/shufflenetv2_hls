...
#ifndef __ShuffleNetV2_mul_cud__HH__
#define __ShuffleNetV2_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_mul_cud) {
    ...
    SC_CTOR(ShuffleNetV2_mul_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
