...
#ifndef __ShuffleNetV2_uremkbM__HH__
#define __ShuffleNetV2_uremkbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremkbM) {
    ...
    SC_CTOR(ShuffleNetV2_uremkbM):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
