...
#ifndef __ShuffleNetV2_uremg8j__HH__
#define __ShuffleNetV2_uremg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremg8j) {
    ...
    SC_CTOR(ShuffleNetV2_uremg8j):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
