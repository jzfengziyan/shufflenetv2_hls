...
architecture behav of shuffle_48_p is 
    ...
    signal tmp_2061_fu_470_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2061_reg_876 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_530_fu_498_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_530_reg_880 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_533_fu_554_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_533_reg_901 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_536_fu_615_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_536_reg_911 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_538_fu_658_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_538_reg_916 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal tmp_540_fu_693_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_540_reg_921 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_542_fu_728_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_542_reg_926 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_636_cast_fu_763_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_637_cast_fu_773_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_638_cast_fu_783_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_fu_474_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_529_fu_486_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_531_fu_532_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_532_fu_543_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_2062_fu_573_p4 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_2063_fu_583_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_534_fu_591_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_2064_fu_599_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_535_fu_607_p1 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_537_fu_629_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_2065_fu_634_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_2066_fu_646_p3 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_539_fu_664_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_2067_fu_669_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_2068_fu_681_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl9_cast_fu_689_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal p_shl8_cast_fu_677_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_541_fu_699_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_2069_fu_704_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_2070_fu_716_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_543_fu_758_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal w_cast1_cast4_fu_750_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_544_fu_768_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal w_cast1_cast3_fu_746_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_545_fu_778_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ShuffleNetV2_uremg8j_x_U471 : component ShuffleNetV2_uremg8j
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 6,
    ...
    ShuffleNetV2_mux_hbi_x_U472 : component ShuffleNetV2_mux_hbi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state11)) then
                    ...
                    tmp_533_reg_901(9 downto 1) <= tmp_533_fu_554_p2(9 downto 1);
                    tmp_536_reg_911(9 downto 1) <= tmp_536_fu_615_p2(9 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ...
                tmp_2061_reg_876 <= tmp_2061_fu_470_p1;
                    tmp_530_reg_880(10 downto 1) <= tmp_530_fu_498_p2(10 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                h_28_reg_934 <= h_28_fu_740_p2;
                    tmp_538_reg_916(13 downto 1) <= tmp_538_fu_658_p2(13 downto 1);
                    tmp_540_reg_921(14 downto 1) <= tmp_540_fu_693_p2(14 downto 1);
                    tmp_542_reg_926(8 downto 1) <= tmp_542_fu_728_p2(8 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state13)) then
                output_V_addr_reg_944 <= tmp_637_cast_fu_773_p1(14 - 1 downto 0);
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, tmp_2061_reg_876, ap_CS_fsm_state2, exitcond5_fu_504_p2, ap_CS_fsm_state12, ap_CS_fsm_state13, exitcond4_fu_734_p2, exitcond_fu_811_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state13 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state13) and (ap_const_lv1_1 = exitcond_fu_811_p2))) then
                    ap_NS_fsm <= ap_ST_fsm_state12;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state13) and (ap_const_lv1_0 = exitcond_fu_811_p2) and (tmp_2061_reg_876 = ap_const_lv1_1))) then
    ...
    buffer1_1_48_8x8_p_V_10_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_11_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_12_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_13_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_14_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_15_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_16_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_17_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_18_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_19_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_1_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_20_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_21_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_22_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_23_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_24_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_2_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_3_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_4_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_5_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_6_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_7_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_8_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_9_address0 <= tmp_638_cast_fu_783_p1(8 - 1 downto 0);
    ...
    left_V_address0 <= tmp_636_cast_fu_763_p1(13 - 1 downto 0);
    ...
    p_shl10_cast_fu_642_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2065_fu_634_p3),14));
    p_shl11_cast_fu_654_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2066_fu_646_p3),14));
    p_shl1_cast_fu_494_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_529_fu_486_p3),11));
    p_shl2_cast_fu_595_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_534_fu_591_p1),10));
    p_shl3_cast_fu_611_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_535_fu_607_p1),10));
    p_shl4_cast_fu_539_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_531_fu_532_p3),10));
    p_shl5_cast_fu_550_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_532_fu_543_p3),10));
    p_shl6_cast_fu_708_p3 <= (tmp_2069_fu_704_p1 & ap_const_lv3_0);
    p_shl7_cast_fu_720_p3 <= (tmp_2070_fu_716_p1 & ap_const_lv1_0);
    p_shl8_cast_fu_677_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2067_fu_669_p3),15));
    p_shl9_cast_fu_689_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2068_fu_681_p3),15));
    p_shl_cast_fu_482_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_474_p3),11));
    tmp_2061_fu_470_p1 <= co_reg_427(1 - 1 downto 0);
    tmp_2062_fu_573_p4 <= mul_fu_567_p2(13 downto 11);
    tmp_2063_fu_583_p3 <= (tmp_2062_fu_573_p4 & ap_const_lv3_0);
    tmp_2064_fu_599_p3 <= (tmp_2062_fu_573_p4 & ap_const_lv1_0);
    tmp_2065_fu_634_p3 <= (tmp_537_fu_629_p2 & ap_const_lv3_0);
    tmp_2066_fu_646_p3 <= (tmp_537_fu_629_p2 & ap_const_lv1_0);
    tmp_2067_fu_669_p3 <= (tmp_539_fu_664_p2 & ap_const_lv3_0);
    tmp_2068_fu_681_p3 <= (tmp_539_fu_664_p2 & ap_const_lv1_0);
    tmp_2069_fu_704_p1 <= tmp_541_fu_699_p2(6 - 1 downto 0);
    tmp_2070_fu_716_p1 <= tmp_541_fu_699_p2(8 - 1 downto 0);
    tmp_529_fu_486_p3 <= (co_reg_427 & ap_const_lv1_0);
    tmp_530_fu_498_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_482_p1) + unsigned(p_shl1_cast_fu_494_p1));
    tmp_531_fu_532_p3 <= (p_lshr_f_cast_reg_893 & ap_const_lv3_0);
    tmp_532_fu_543_p3 <= (p_lshr_f_cast_reg_893 & ap_const_lv1_0);
    tmp_533_fu_554_p2 <= std_logic_vector(unsigned(p_shl5_cast_fu_550_p1) + unsigned(p_shl4_cast_fu_539_p1));
        tmp_534_fu_591_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_2063_fu_583_p3),9));

        tmp_535_fu_607_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_2064_fu_599_p3),7));

    tmp_536_fu_615_p2 <= std_logic_vector(unsigned(p_shl3_cast_fu_611_p1) + unsigned(p_shl2_cast_fu_595_p1));
    tmp_537_fu_629_p2 <= std_logic_vector(unsigned(tmp_533_reg_901) + unsigned(h_cast2_cast_fu_625_p1));
    tmp_538_fu_658_p2 <= std_logic_vector(unsigned(p_shl11_cast_fu_654_p1) + unsigned(p_shl10_cast_fu_642_p1));
    tmp_539_fu_664_p2 <= std_logic_vector(unsigned(tmp_530_reg_880) + unsigned(h_cast2_cast2_fu_621_p1));
    tmp_540_fu_693_p2 <= std_logic_vector(unsigned(p_shl9_cast_fu_689_p1) + unsigned(p_shl8_cast_fu_677_p1));
    tmp_541_fu_699_p2 <= std_logic_vector(unsigned(tmp_536_reg_911) + unsigned(h_cast2_cast_fu_625_p1));
    tmp_542_fu_728_p2 <= std_logic_vector(unsigned(p_shl7_cast_fu_720_p3) + unsigned(p_shl6_cast_fu_708_p3));
    tmp_543_fu_758_p2 <= std_logic_vector(unsigned(tmp_538_reg_916) + unsigned(w_cast1_cast_fu_754_p1));
    tmp_544_fu_768_p2 <= std_logic_vector(unsigned(tmp_540_reg_921) + unsigned(w_cast1_cast4_fu_750_p1));
    tmp_545_fu_778_p2 <= std_logic_vector(unsigned(tmp_542_reg_926) + unsigned(w_cast1_cast3_fu_746_p1));
    tmp_636_cast_fu_763_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_543_fu_758_p2),32));
    tmp_637_cast_fu_773_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_544_fu_768_p2),32));
    tmp_638_cast_fu_783_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_545_fu_778_p2),32));
