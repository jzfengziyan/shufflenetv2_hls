...
FIX_8 conv1_bias [24];
//--------New feature map buffer-------------
FIX_8 feature_buffer_48x18x18[1][48][18][18] = {0};


FIX_8 feature_buffer_96x10x10[1][96][10][10] = {0};


FIX_8 feature_buffer_192x6x6[1][192][6][6] = {0};
//-----Old feature map buffer---------------------
/*FIX_8 downsampleunit0_output_p[1][48][18][18] = {0};//FIX_8 feature_buffer0_48x18x18[1][48][18][18] = {0}
FIX_8 shuffleunit0_0_output_p[1][48][18][18] = {0};//FIX_8 feature_buffer1_48x18x18[1][48][18][18] = {0}
FIX_8 shuffleunit0_1_output_p[1][48][18][18] = {0};//FIX_8 feature_buffer0_48x18x18[1][48][18][18] = {0}
FIX_8 shuffleunit0_2_output_p[1][48][18][18] = {0};//FIX_8 feature_buffer1_48x18x18[1][48][18][18] = {0}

FIX_8 downsampleunit1_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer0_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_0_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer1_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_1_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer0_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_2_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer1_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_3_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer0_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_4_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer1_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_5_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer0_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_6_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer1_96x10x10[1][96][10][10] = {0}
FIX_8 shuffleunit1_7_output_p[1][96][10][10] = {0};//FIX_8 feature_buffer0_96x10x10[1][96][10][10] = {0}

FIX_8 downsampleunit2_output_p[1][192][6][6] = {0};//FIX_8 feature_buffer0_192x6x6[1][192][6][6] = {0}
FIX_8 shuffleunit2_0_output_p[1][192][6][6] = {0};//FIX_8 feature_buffer1_192x6x6[1][192][6][6] = {0}
FIX_8 shuffleunit2_1_output_p[1][192][6][6] = {0};//FIX_8 feature_buffer0_192x6x6[1][192][6][6] = {0}
FIX_8 shuffleunit2_2_output_p[1][192][6][6] = {0};//FIX_8 feature_buffer1_192x6x6[1][192][6][6] = {0}*/
...
//#pragma HLS PIPELINE
    ...
    shuffle_24_l_p(buffer1_1_24_16x16_p, feature_buffer_48x18x18);
...
//#pragma HLS PIPELINE
	...
	shuffle_24_r_p(buffer1_1_24_16x16_p, feature_buffer_48x18x18);
...
//------------------ShuffleUnit0_0-----------------------------
	...
	for(int co = 0;co <24;co ++){
		for(int h=0;h<16;h++){
			for(int w = 0;w<16;w++){
//#pragma HLS PIPELINE
				buffer0_1_24_16x16_p[0][co][h+1][w+1] = feature_buffer_48x18x18[0][24+co][h+1][w+1];
...
//#pragma HLS PIPELINE
				...
				buffer0_1_24_16x16_p[0][co][h+1][w+1] = feature_buffer_48x18x18[0][co][h+1][w+1];
			}
		}
	}

	shuffle_24_p(buffer0_1_24_16x16_p,buffer1_1_24_16x16_p,feature_buffer_48x18x18);
...
//#pragma HLS PIPELINE
	...
	subconv_1x1_16p_p(feature_buffer_48x18x18,weights_48_48_1x1,bias_48,ShuffleConvs_1_DownsampleUnit__conv1r_output_p);
	//conv2r
    for(int co = 0;co<24;co++)
        for(int w = 0; w <3; w++)
            for(int h = 0; h <3;h++)
...
//#pragma HLS PIPELINE
	...
	//shuffle_r
    shuffle_48_l_p(buffer1_1_48_8x8_p, feature_buffer_96x10x10);
...
//#pragma HLS PIPELINE
	...
	subconv_3x3_16_stride_no_relu_p(feature_buffer_48x18x18,weights_48_1_3x3,bias_48,buffer0_1_48_8x8_p);
...
//#pragma HLS PIPELINE
	...
	//shuffle_l
	shuffle_48_r_p(buffer1_1_48_8x8_p, feature_buffer_96x10x10);
...
//------------------ShuffleUnit1_0-----------------------------
	...
	for(int co = 0;co <48;co ++){
		for(int h=0;h<8;h++){
			for(int w = 0;w<8;w++){
//#pragma HLS PIPELINE
				buffer0_1_48_8x8_p[0][co][h+1][w+1] = feature_buffer_96x10x10[0][48+co][h+1][w+1];
				//left_part[0][co][h][w] = downsampleunit0_output[0][co][h][w];
			}
		}
	}
...
//#pragma HLS PIPELINE
				//right_part[0][co][h][w] = downsampleunit0_output[0][24+co][h][w];
				buffer0_1_48_8x8_p[0][co][h+1][w+1] = feature_buffer_96x10x10[0][co][h+1][w+1];
			}
		}
	}
	shuffle_48_p(buffer0_1_48_8x8_p,buffer1_1_48_8x8_p,feature_buffer_96x10x10);
...
//#pragma HLS PIPELINE
	...
	subconv_1x1_8p_p(feature_buffer_96x10x10,weights_96_96_1x1,bias_96,ShuffleConvs_2_DownsampleUnit__conv1r_output_p);
...
//#pragma HLS PIPELINE
	...
	//shuffle_r
    shuffle_96_l_p(buffer1_1_96_4x4_p, feature_buffer_192x6x6);//!!!!!!!! attention: for downsample, r l is swapped
...
//#pragma HLS PIPELINE
	...
	subconv_3x3_8_stride_no_relu_p(feature_buffer_96x10x10,weights_96_1_3x3,bias_96,buffer0_1_96_4x4_p);
...
//#pragma HLS PIPELINE
	...
	//shuffle_l
	shuffle_96_r_p(buffer1_1_96_4x4_p, feature_buffer_192x6x6);
...
/*------------------ShuffleUNit2_0-------------------------*/
	...
	for(int co = 0;co <96;co ++){
		for(int h=0;h<4;h++){
			for(int w = 0;w<4;w++){
//#pragma HLS PIPELINE
				buffer0_1_96_4x4_p[0][co][h+1][w+1] = feature_buffer_192x6x6[0][96+co][h+1][w+1];
...
//#pragma HLS PIPELINE
				...
				buffer0_1_96_4x4_p[0][co][h+1][w+1] = feature_buffer_192x6x6[0][co][h+1][w+1];
			}
		}
	}
	shuffle_96_p(buffer0_1_96_4x4_p,buffer1_1_96_4x4_p,feature_buffer_192x6x6);
...
//#pragma HLS PIPELINE
    ...
    for(int ci = 0; ci < 192; ci++){
    	for(int w = 0;w<4;w++){
    		for(int h = 0; h <4;h++){
//#pragma HLS PIPELINE
    			shuffleunit2_2_output[0][ci][w][h] = feature_buffer_192x6x6[0][ci][w+1][h+1];
    		}
    	}
    }
    ...
    /*----------------Used for DEBUG------------------*/
        for(int co = 0; co < 24; co++){
            for(int w = 0; w < 34; w++){
                for(int h = 0; h < 34; h++){
                    cout<< conv1_output_p[0][co][w][h] <<" ";
                }cout<<endl;
            }cout<< co<<endl;
        }cout<<"conv1_output_p above"<<endl;
