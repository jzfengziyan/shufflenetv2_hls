...
set C_modelArgList {
	...
	{ ShuffleConvs_0_Downs int 8 regular {array 27744 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_0_Downs", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "ShuffleConvs_0_DownsampleUnit__conv1r_output_p.V","cData": "int8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 33,"step" : 1},{"low" : 0,"up" : 33,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ ShuffleConvs_0_Downs_q0 sc_in sc_lv 8 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	ShuffleConvs_0_Downs { ap_memory {  { ShuffleConvs_0_Downs_address0 mem_address 1 15 }  { ShuffleConvs_0_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_0_Downs_q0 mem_dout 0 8 } } }
}
