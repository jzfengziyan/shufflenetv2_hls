...
fc::fc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_250_reg_695 );
    sensitive << ( ap_CS_fsm_state14 );

    SC_METHOD(thread_Range1_all_zeros_fu_395_p2);
    sensitive << ( carry_reg_688 );
    sensitive << ( tmp_250_reg_695 );
    sensitive << ( ap_CS_fsm_state14 );
    ...
    sensitive << ( tmp_244_fu_276_p1 );

    SC_METHOD(thread_avgpool_output_V_ce0);
    sensitive << ( ap_CS_fsm_state10 );

    SC_METHOD(thread_bias_V_address0);
    sensitive << ( tmp_reg_621 );
    sensitive << ( ap_CS_fsm_state10 );

    SC_METHOD(thread_bias_V_ce0);
    sensitive << ( ap_CS_fsm_state10 );

    SC_METHOD(thread_brmerge1_fu_567_p2);
    sensitive << ( newsignbit_10_fu_535_p3 );
    sensitive << ( isneg_not_fu_561_p2 );

    SC_METHOD(thread_brmerge40_demorgan_i_fu_452_p2);
    sensitive << ( newsignbit_reg_682 );
    sensitive << ( deleted_ones_fu_418_p3 );

    SC_METHOD(thread_brmerge_i_i7_fu_436_p2);
    sensitive << ( newsignbit_reg_682 );
    sensitive << ( p_not_i_i_fu_430_p2 );

    SC_METHOD(thread_brmerge_i_i_fu_555_p2);
    sensitive << ( newsignbit_10_fu_535_p3 );
    sensitive << ( isneg_fu_522_p3 );

    SC_METHOD(thread_brmerge_i_i_i_fu_474_p2);
    sensitive << ( underflow_fu_469_p2 );
    sensitive << ( overflow_fu_446_p2 );

    SC_METHOD(thread_carry_fu_367_p2);
    sensitive << ( tmp_552_fu_339_p3 );
    sensitive << ( tmp_247_fu_361_p2 );

    SC_METHOD(thread_ci_6_fu_270_p2);
    sensitive << ( ci_reg_195 );

    SC_METHOD(thread_co_34_fu_227_p2);
    sensitive << ( co_reg_171 );

    SC_METHOD(thread_deleted_ones_fu_418_p3);
    sensitive << ( carry_reg_688 );
    sensitive << ( Range1_all_ones_fu_390_p2 );
    sensitive << ( p_41_i_i_fu_413_p2 );

    SC_METHOD(thread_deleted_zeros_fu_400_p3);
    sensitive << ( carry_reg_688 );
    sensitive << ( Range1_all_ones_fu_390_p2 );
    sensitive << ( Range1_all_zeros_fu_395_p2 );

    SC_METHOD(thread_exitcond24_fu_221_p2);
    ...
    sensitive << ( p_Val2_64_fu_516_p2 );

    SC_METHOD(thread_isneg_not_fu_561_p2);
    sensitive << ( isneg_fu_522_p3 );
    ...
    sensitive << ( weight_V_addr_reg_615 );
    sensitive << ( ap_reg_ioackin_m_axi_weight_V_ARREADY );
    ...
    SC_METHOD(thread_newsignbit_10_fu_535_p3);
    sensitive << ( result_V_fu_530_p2 );

    SC_METHOD(thread_newsignbit_fu_353_p3);
    sensitive << ( p_Val2_69_fu_347_p2 );
    ...
    SC_METHOD(thread_overflow_fu_446_p2);
    sensitive << ( tmp_249_fu_441_p2 );
    sensitive << ( brmerge_i_i7_fu_436_p2 );

    SC_METHOD(thread_p_38_i_i_fu_425_p2);
    sensitive << ( carry_reg_688 );
    sensitive << ( Range1_all_ones_fu_390_p2 );

    SC_METHOD(thread_p_41_i_i_fu_413_p2);
    sensitive << ( signbit_reg_669 );
    sensitive << ( tmp_248_fu_407_p2 );

    SC_METHOD(thread_p_Val2_64_fu_516_p2);
    sensitive << ( tmp_242_fu_513_p1 );
    sensitive << ( tmp_s_fu_509_p1 );

    SC_METHOD(thread_p_Val2_66_fu_287_p0);
    sensitive << ( avgpool_output_V_loa_reg_649 );
    sensitive << ( ap_CS_fsm_state12 );

    SC_METHOD(thread_p_Val2_66_fu_287_p1);
    sensitive << ( weight_V_addr_read_reg_644 );
    sensitive << ( ap_CS_fsm_state12 );

    SC_METHOD(thread_p_Val2_66_fu_287_p2);
    sensitive << ( p_Val2_66_fu_287_p0 );
    sensitive << ( p_Val2_66_fu_287_p1 );

    SC_METHOD(thread_p_Val2_67_fu_313_p2);
    sensitive << ( p_Val2_66_reg_654 );
    sensitive << ( tmp_253_cast_fu_309_p1 );

    SC_METHOD(thread_p_Val2_68_fu_326_p4);
    sensitive << ( p_Val2_67_fu_313_p2 );

    SC_METHOD(thread_p_Val2_69_fu_347_p2);
    sensitive << ( tmp_246_fu_336_p1 );
    sensitive << ( p_Val2_68_fu_326_p4 );

    SC_METHOD(thread_p_Val2_78_mux_fu_489_p3);
    sensitive << ( p_Val2_69_reg_676 );
    sensitive << ( brmerge_i_i_i_reg_721 );

    SC_METHOD(thread_p_Val2_s_170_fu_495_p3);
    sensitive << ( p_Val2_69_reg_676 );
    sensitive << ( underflow_reg_716 );

    SC_METHOD(thread_p_not_i_i_fu_430_p2);
    sensitive << ( deleted_zeros_fu_400_p3 );

    SC_METHOD(thread_p_result_V_fu_581_p3);
    sensitive << ( result_V_fu_530_p2 );
    sensitive << ( underflow_10_fu_549_p2 );

    SC_METHOD(thread_result_1_fu_589_p3);
    sensitive << ( brmerge1_fu_567_p2 );
    sensitive << ( result_V_mux_fu_573_p3 );
    sensitive << ( p_result_V_fu_581_p3 );

    SC_METHOD(thread_result_V_fu_530_p2);
    sensitive << ( p_Val2_63_reg_731 );
    sensitive << ( p_Val2_s_reg_183 );

    SC_METHOD(thread_result_V_mux_fu_573_p3);
    sensitive << ( result_V_fu_530_p2 );
    sensitive << ( brmerge_i_i_fu_555_p2 );

    SC_METHOD(thread_sext2_fu_206_p1);
    sensitive << ( fc_output_V15 );

    SC_METHOD(thread_sext_cast_fu_217_p1);
    sensitive << ( fc_weight_V11 );

    SC_METHOD(thread_sum_V_fu_501_p3);
    sensitive << ( underflow_not_fu_484_p2 );
    sensitive << ( p_Val2_78_mux_fu_489_p3 );
    sensitive << ( p_Val2_s_170_fu_495_p3 );

    SC_METHOD(thread_tmp2_demorgan_fu_457_p2);
    sensitive << ( p_38_i_i_fu_425_p2 );
    sensitive << ( brmerge40_demorgan_i_fu_452_p2 );

    SC_METHOD(thread_tmp2_fu_463_p2);
    sensitive << ( tmp2_demorgan_fu_457_p2 );

    SC_METHOD(thread_tmp3_fu_480_p2);
    sensitive << ( tmp_249_reg_706 );
    sensitive << ( brmerge40_demorgan_i_reg_711 );

    SC_METHOD(thread_tmp_242_fu_513_p1);
    sensitive << ( p_Val2_63_reg_731 );

    SC_METHOD(thread_tmp_243_fu_543_p2);
    sensitive << ( newsignbit_10_fu_535_p3 );

    SC_METHOD(thread_tmp_244_fu_276_p1);
    sensitive << ( ci_reg_195 );

    SC_METHOD(thread_tmp_245_fu_301_p3);
    sensitive << ( p_Val2_s_reg_183 );

    SC_METHOD(thread_tmp_246_fu_336_p1);
    sensitive << ( tmp_551_reg_659 );

    SC_METHOD(thread_tmp_247_fu_361_p2);
    sensitive << ( newsignbit_fu_353_p3 );

    SC_METHOD(thread_tmp_248_fu_407_p2);
    sensitive << ( tmp_554_fu_383_p3 );

    SC_METHOD(thread_tmp_249_fu_441_p2);
    sensitive << ( signbit_reg_669 );

    SC_METHOD(thread_tmp_253_cast_fu_309_p1);
    sensitive << ( tmp_245_fu_301_p3 );

    SC_METHOD(thread_tmp_527_fu_233_p3);
    sensitive << ( co_reg_171 );

    SC_METHOD(thread_tmp_545_fu_241_p1);
    sensitive << ( tmp_527_fu_233_p3 );

    SC_METHOD(thread_tmp_546_fu_245_p2);
    sensitive << ( sext_cast_reg_602 );
    sensitive << ( tmp_545_fu_241_p1 );

    SC_METHOD(thread_tmp_547_fu_250_p1);
    sensitive << ( tmp_546_fu_245_p2 );

    SC_METHOD(thread_tmp_552_fu_339_p3);
    sensitive << ( p_Val2_67_fu_313_p2 );

    SC_METHOD(thread_tmp_554_fu_383_p3);
    sensitive << ( p_Val2_67_reg_664 );
    ...
    SC_METHOD(thread_underflow_10_fu_549_p2);
    sensitive << ( isneg_fu_522_p3 );
    sensitive << ( tmp_243_fu_543_p2 );

    SC_METHOD(thread_underflow_fu_469_p2);
    sensitive << ( signbit_reg_669 );
    sensitive << ( tmp2_fu_463_p2 );

    SC_METHOD(thread_underflow_not_fu_484_p2);
    sensitive << ( p_38_i_i_reg_701 );
    sensitive << ( tmp3_fu_480_p2 );
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( exitcond24_fu_221_p2 );
    sensitive << ( ap_CS_fsm_state10 );
    ...
    sc_trace(mVcdFile, sext_cast_fu_217_p1, "sext_cast_fu_217_p1");
    sc_trace(mVcdFile, sext_cast_reg_602, "sext_cast_reg_602");
    sc_trace(mVcdFile, co_34_fu_227_p2, "co_34_fu_227_p2");
    sc_trace(mVcdFile, co_34_reg_610, "co_34_reg_610");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, weight_V_addr_reg_615, "weight_V_addr_reg_615");
    sc_trace(mVcdFile, exitcond24_fu_221_p2, "exitcond24_fu_221_p2");
    sc_trace(mVcdFile, tmp_fu_260_p1, "tmp_fu_260_p1");
    sc_trace(mVcdFile, tmp_reg_621, "tmp_reg_621");
    sc_trace(mVcdFile, ap_CS_fsm_state9, "ap_CS_fsm_state9");
    sc_trace(mVcdFile, ci_6_fu_270_p2, "ci_6_fu_270_p2");
    sc_trace(mVcdFile, ci_6_reg_629, "ci_6_reg_629");
    sc_trace(mVcdFile, ap_CS_fsm_state10, "ap_CS_fsm_state10");
    sc_trace(mVcdFile, exitcond_fu_264_p2, "exitcond_fu_264_p2");
    sc_trace(mVcdFile, weight_V_addr_read_reg_644, "weight_V_addr_read_reg_644");
    sc_trace(mVcdFile, avgpool_output_V_loa_reg_649, "avgpool_output_V_loa_reg_649");
    sc_trace(mVcdFile, p_Val2_66_fu_287_p2, "p_Val2_66_fu_287_p2");
    sc_trace(mVcdFile, p_Val2_66_reg_654, "p_Val2_66_reg_654");
    sc_trace(mVcdFile, ap_CS_fsm_state12, "ap_CS_fsm_state12");
    sc_trace(mVcdFile, tmp_551_reg_659, "tmp_551_reg_659");
    sc_trace(mVcdFile, p_Val2_67_fu_313_p2, "p_Val2_67_fu_313_p2");
    sc_trace(mVcdFile, p_Val2_67_reg_664, "p_Val2_67_reg_664");
    sc_trace(mVcdFile, ap_CS_fsm_state13, "ap_CS_fsm_state13");
    sc_trace(mVcdFile, signbit_reg_669, "signbit_reg_669");
    sc_trace(mVcdFile, p_Val2_69_fu_347_p2, "p_Val2_69_fu_347_p2");
    sc_trace(mVcdFile, p_Val2_69_reg_676, "p_Val2_69_reg_676");
    sc_trace(mVcdFile, newsignbit_fu_353_p3, "newsignbit_fu_353_p3");
    sc_trace(mVcdFile, newsignbit_reg_682, "newsignbit_reg_682");
    sc_trace(mVcdFile, carry_fu_367_p2, "carry_fu_367_p2");
    sc_trace(mVcdFile, carry_reg_688, "carry_reg_688");
    sc_trace(mVcdFile, tmp_250_reg_695, "tmp_250_reg_695");
    sc_trace(mVcdFile, p_38_i_i_fu_425_p2, "p_38_i_i_fu_425_p2");
    sc_trace(mVcdFile, p_38_i_i_reg_701, "p_38_i_i_reg_701");
    sc_trace(mVcdFile, ap_CS_fsm_state14, "ap_CS_fsm_state14");
    sc_trace(mVcdFile, tmp_249_fu_441_p2, "tmp_249_fu_441_p2");
    sc_trace(mVcdFile, tmp_249_reg_706, "tmp_249_reg_706");
    sc_trace(mVcdFile, brmerge40_demorgan_i_fu_452_p2, "brmerge40_demorgan_i_fu_452_p2");
    sc_trace(mVcdFile, brmerge40_demorgan_i_reg_711, "brmerge40_demorgan_i_reg_711");
    sc_trace(mVcdFile, underflow_fu_469_p2, "underflow_fu_469_p2");
    sc_trace(mVcdFile, underflow_reg_716, "underflow_reg_716");
    sc_trace(mVcdFile, brmerge_i_i_i_fu_474_p2, "brmerge_i_i_i_fu_474_p2");
    sc_trace(mVcdFile, brmerge_i_i_i_reg_721, "brmerge_i_i_i_reg_721");
    sc_trace(mVcdFile, sum_V_fu_501_p3, "sum_V_fu_501_p3");
    sc_trace(mVcdFile, ap_CS_fsm_state15, "ap_CS_fsm_state15");
    sc_trace(mVcdFile, p_Val2_63_reg_731, "p_Val2_63_reg_731");
    sc_trace(mVcdFile, ap_CS_fsm_state16, "ap_CS_fsm_state16");
    sc_trace(mVcdFile, result_1_fu_589_p3, "result_1_fu_589_p3");
    sc_trace(mVcdFile, result_1_reg_737, "result_1_reg_737");
    sc_trace(mVcdFile, ap_CS_fsm_state17, "ap_CS_fsm_state17");
    sc_trace(mVcdFile, co_reg_171, "co_reg_171");
    ...
    sc_trace(mVcdFile, ci_reg_195, "ci_reg_195");
    sc_trace(mVcdFile, tmp_244_fu_276_p1, "tmp_244_fu_276_p1");
    sc_trace(mVcdFile, sext2_fu_206_p1, "sext2_fu_206_p1");
    sc_trace(mVcdFile, tmp_547_fu_250_p1, "tmp_547_fu_250_p1");
    ...
    sc_trace(mVcdFile, tmp_527_fu_233_p3, "tmp_527_fu_233_p3");
    sc_trace(mVcdFile, tmp_545_fu_241_p1, "tmp_545_fu_241_p1");
    sc_trace(mVcdFile, tmp_546_fu_245_p2, "tmp_546_fu_245_p2");
    sc_trace(mVcdFile, p_Val2_66_fu_287_p0, "p_Val2_66_fu_287_p0");
    sc_trace(mVcdFile, p_Val2_66_fu_287_p1, "p_Val2_66_fu_287_p1");
    sc_trace(mVcdFile, tmp_245_fu_301_p3, "tmp_245_fu_301_p3");
    sc_trace(mVcdFile, tmp_253_cast_fu_309_p1, "tmp_253_cast_fu_309_p1");
    sc_trace(mVcdFile, tmp_246_fu_336_p1, "tmp_246_fu_336_p1");
    sc_trace(mVcdFile, p_Val2_68_fu_326_p4, "p_Val2_68_fu_326_p4");
    sc_trace(mVcdFile, tmp_552_fu_339_p3, "tmp_552_fu_339_p3");
    sc_trace(mVcdFile, tmp_247_fu_361_p2, "tmp_247_fu_361_p2");
    sc_trace(mVcdFile, Range1_all_ones_fu_390_p2, "Range1_all_ones_fu_390_p2");
    sc_trace(mVcdFile, Range1_all_zeros_fu_395_p2, "Range1_all_zeros_fu_395_p2");
    sc_trace(mVcdFile, tmp_554_fu_383_p3, "tmp_554_fu_383_p3");
    sc_trace(mVcdFile, tmp_248_fu_407_p2, "tmp_248_fu_407_p2");
    sc_trace(mVcdFile, p_41_i_i_fu_413_p2, "p_41_i_i_fu_413_p2");
    sc_trace(mVcdFile, deleted_zeros_fu_400_p3, "deleted_zeros_fu_400_p3");
    sc_trace(mVcdFile, p_not_i_i_fu_430_p2, "p_not_i_i_fu_430_p2");
    sc_trace(mVcdFile, brmerge_i_i7_fu_436_p2, "brmerge_i_i7_fu_436_p2");
    sc_trace(mVcdFile, deleted_ones_fu_418_p3, "deleted_ones_fu_418_p3");
    sc_trace(mVcdFile, tmp2_demorgan_fu_457_p2, "tmp2_demorgan_fu_457_p2");
    sc_trace(mVcdFile, tmp2_fu_463_p2, "tmp2_fu_463_p2");
    sc_trace(mVcdFile, overflow_fu_446_p2, "overflow_fu_446_p2");
    sc_trace(mVcdFile, tmp3_fu_480_p2, "tmp3_fu_480_p2");
    sc_trace(mVcdFile, underflow_not_fu_484_p2, "underflow_not_fu_484_p2");
    sc_trace(mVcdFile, p_Val2_78_mux_fu_489_p3, "p_Val2_78_mux_fu_489_p3");
    sc_trace(mVcdFile, p_Val2_s_170_fu_495_p3, "p_Val2_s_170_fu_495_p3");
    sc_trace(mVcdFile, tmp_242_fu_513_p1, "tmp_242_fu_513_p1");
    sc_trace(mVcdFile, tmp_s_fu_509_p1, "tmp_s_fu_509_p1");
    sc_trace(mVcdFile, p_Val2_64_fu_516_p2, "p_Val2_64_fu_516_p2");
    sc_trace(mVcdFile, result_V_fu_530_p2, "result_V_fu_530_p2");
    sc_trace(mVcdFile, newsignbit_10_fu_535_p3, "newsignbit_10_fu_535_p3");
    sc_trace(mVcdFile, isneg_fu_522_p3, "isneg_fu_522_p3");
    sc_trace(mVcdFile, tmp_243_fu_543_p2, "tmp_243_fu_543_p2");
    sc_trace(mVcdFile, isneg_not_fu_561_p2, "isneg_not_fu_561_p2");
    sc_trace(mVcdFile, brmerge_i_i_fu_555_p2, "brmerge_i_i_fu_555_p2");
    sc_trace(mVcdFile, underflow_10_fu_549_p2, "underflow_10_fu_549_p2");
    sc_trace(mVcdFile, brmerge1_fu_567_p2, "brmerge1_fu_567_p2");
    sc_trace(mVcdFile, result_V_mux_fu_573_p3, "result_V_mux_fu_573_p3");
    sc_trace(mVcdFile, p_result_V_fu_581_p3, "p_result_V_fu_581_p3");
...
void fc::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state15.read())) {
        p_Val2_s_reg_183 = sum_V_fu_501_p3.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state11.read()) && esl_seteq<1,1,1>(m_axi_weight_V_RVALID.read(), ap_const_logic_1))) {
        avgpool_output_V_loa_reg_649 = avgpool_output_V_q0.read();
        weight_V_addr_read_reg_644 = m_axi_weight_V_RDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state14.read())) {
        brmerge40_demorgan_i_reg_711 = brmerge40_demorgan_i_fu_452_p2.read();
        brmerge_i_i_i_reg_721 = brmerge_i_i_i_fu_474_p2.read();
        p_38_i_i_reg_701 = p_38_i_i_fu_425_p2.read();
        tmp_249_reg_706 = tmp_249_fu_441_p2.read();
        underflow_reg_716 = underflow_fu_469_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state13.read())) {
        carry_reg_688 = carry_fu_367_p2.read();
        newsignbit_reg_682 = p_Val2_69_fu_347_p2.read().range(7, 7);
        p_Val2_67_reg_664 = p_Val2_67_fu_313_p2.read();
        p_Val2_69_reg_676 = p_Val2_69_fu_347_p2.read();
        signbit_reg_669 = p_Val2_67_fu_313_p2.read().range(15, 15);
        tmp_250_reg_695 = p_Val2_67_fu_313_p2.read().range(15, 14);
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        ci_6_reg_629 = ci_6_fu_270_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        co_34_reg_610 = co_34_fu_227_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state16.read())) {
        p_Val2_63_reg_731 = bias_V_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state12.read())) {
        p_Val2_66_reg_654 = p_Val2_66_fu_287_p2.read();
        tmp_551_reg_659 = p_Val2_66_fu_287_p2.read().range(5, 5);
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state17.read())) {
        result_1_reg_737 = result_1_fu_589_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, ap_sig_ioackin_m_axi_output_V_AWREADY.read())))) {
        sext_cast_reg_602 = sext_cast_fu_217_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        tmp_reg_621 = tmp_fu_260_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond24_fu_221_p2.read()))) {
        weight_V_addr_reg_615 =  (sc_lv<32>) (tmp_547_fu_250_p1.read());
    }
}

void fc::thread_Range1_all_ones_fu_390_p2() {
    Range1_all_ones_fu_390_p2 = (!tmp_250_reg_695.read().is_01() || !ap_const_lv2_3.is_01())? sc_lv<1>(): sc_lv<1>(tmp_250_reg_695.read() == ap_const_lv2_3);
}

void fc::thread_Range1_all_zeros_fu_395_p2() {
    Range1_all_zeros_fu_395_p2 = (!tmp_250_reg_695.read().is_01() || !ap_const_lv2_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_250_reg_695.read() == ap_const_lv2_0);
}
...
void fc::thread_avgpool_output_V_address0() {
    avgpool_output_V_address0 =  (sc_lv<9>) (tmp_244_fu_276_p1.read());
}
...
void fc::thread_bias_V_address0() {
    bias_V_address0 =  (sc_lv<4>) (tmp_reg_621.read());
}
...
void fc::thread_brmerge1_fu_567_p2() {
    brmerge1_fu_567_p2 = (newsignbit_10_fu_535_p3.read() | isneg_not_fu_561_p2.read());
}

void fc::thread_brmerge40_demorgan_i_fu_452_p2() {
    brmerge40_demorgan_i_fu_452_p2 = (newsignbit_reg_682.read() & deleted_ones_fu_418_p3.read());
}

void fc::thread_brmerge_i_i7_fu_436_p2() {
    brmerge_i_i7_fu_436_p2 = (newsignbit_reg_682.read() | p_not_i_i_fu_430_p2.read());
}

void fc::thread_brmerge_i_i_fu_555_p2() {
    brmerge_i_i_fu_555_p2 = (isneg_fu_522_p3.read() ^ newsignbit_10_fu_535_p3.read());
}

void fc::thread_brmerge_i_i_i_fu_474_p2() {
    brmerge_i_i_i_fu_474_p2 = (underflow_fu_469_p2.read() | overflow_fu_446_p2.read());
}

void fc::thread_carry_fu_367_p2() {
    carry_fu_367_p2 = (tmp_552_fu_339_p3.read() & tmp_247_fu_361_p2.read());
}

void fc::thread_ci_6_fu_270_p2() {
    ci_6_fu_270_p2 = (!ci_reg_195.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(ci_reg_195.read()) + sc_biguint<10>(ap_const_lv10_1));
}

void fc::thread_co_34_fu_227_p2() {
    co_34_fu_227_p2 = (!co_reg_171.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(co_reg_171.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void fc::thread_deleted_ones_fu_418_p3() {
    deleted_ones_fu_418_p3 = (!carry_reg_688.read()[0].is_01())? sc_lv<1>(): ((carry_reg_688.read()[0].to_bool())? p_41_i_i_fu_413_p2.read(): Range1_all_ones_fu_390_p2.read());
}

void fc::thread_deleted_zeros_fu_400_p3() {
    deleted_zeros_fu_400_p3 = (!carry_reg_688.read()[0].is_01())? sc_lv<1>(): ((carry_reg_688.read()[0].to_bool())? Range1_all_ones_fu_390_p2.read(): Range1_all_zeros_fu_395_p2.read());
}

void fc::thread_exitcond24_fu_221_p2() {
    exitcond24_fu_221_p2 = (!co_reg_171.read().is_01() || !ap_const_lv4_A.is_01())? sc_lv<1>(): sc_lv<1>(co_reg_171.read() == ap_const_lv4_A);
}

void fc::thread_exitcond_fu_264_p2() {
    exitcond_fu_264_p2 = (!ci_reg_195.read().is_01() || !ap_const_lv10_200.is_01())? sc_lv<1>(): sc_lv<1>(ci_reg_195.read() == ap_const_lv10_200);
}

void fc::thread_isneg_fu_522_p3() {
    isneg_fu_522_p3 = p_Val2_64_fu_516_p2.read().range(8, 8);
}

void fc::thread_isneg_not_fu_561_p2() {
    isneg_not_fu_561_p2 = (isneg_fu_522_p3.read() ^ ap_const_lv1_1);
}
...
void fc::thread_m_axi_output_V_AWADDR() {
    m_axi_output_V_AWADDR =  (sc_lv<32>) (sext2_fu_206_p1.read());
}
...
void fc::thread_m_axi_output_V_WDATA() {
    m_axi_output_V_WDATA = result_1_reg_737.read();
}
...
void fc::thread_m_axi_weight_V_ARADDR() {
    m_axi_weight_V_ARADDR = weight_V_addr_reg_615.read();
}
...
void fc::thread_newsignbit_10_fu_535_p3() {
    newsignbit_10_fu_535_p3 = result_V_fu_530_p2.read().range(7, 7);
}

void fc::thread_newsignbit_fu_353_p3() {
    newsignbit_fu_353_p3 = p_Val2_69_fu_347_p2.read().range(7, 7);
}
...
void fc::thread_overflow_fu_446_p2() {
    overflow_fu_446_p2 = (brmerge_i_i7_fu_436_p2.read() & tmp_249_fu_441_p2.read());
}

void fc::thread_p_38_i_i_fu_425_p2() {
    p_38_i_i_fu_425_p2 = (carry_reg_688.read() & Range1_all_ones_fu_390_p2.read());
}

void fc::thread_p_41_i_i_fu_413_p2() {
    p_41_i_i_fu_413_p2 = (signbit_reg_669.read() & tmp_248_fu_407_p2.read());
}

void fc::thread_p_Val2_64_fu_516_p2() {
    p_Val2_64_fu_516_p2 = (!tmp_242_fu_513_p1.read().is_01() || !tmp_s_fu_509_p1.read().is_01())? sc_lv<9>(): (sc_bigint<9>(tmp_242_fu_513_p1.read()) + sc_bigint<9>(tmp_s_fu_509_p1.read()));
}

void fc::thread_p_Val2_66_fu_287_p0() {
    p_Val2_66_fu_287_p0 = avgpool_output_V_loa_reg_649.read();
}

void fc::thread_p_Val2_66_fu_287_p1() {
    p_Val2_66_fu_287_p1 = weight_V_addr_read_reg_644.read();
}

void fc::thread_p_Val2_66_fu_287_p2() {
    p_Val2_66_fu_287_p2 = (!p_Val2_66_fu_287_p0.read().is_01() || !p_Val2_66_fu_287_p1.read().is_01())? sc_lv<16>(): sc_bigint<8>(p_Val2_66_fu_287_p0.read()) * sc_bigint<8>(p_Val2_66_fu_287_p1.read());
}

void fc::thread_p_Val2_67_fu_313_p2() {
    p_Val2_67_fu_313_p2 = (!p_Val2_66_reg_654.read().is_01() || !tmp_253_cast_fu_309_p1.read().is_01())? sc_lv<16>(): (sc_biguint<16>(p_Val2_66_reg_654.read()) + sc_bigint<16>(tmp_253_cast_fu_309_p1.read()));
}

void fc::thread_p_Val2_68_fu_326_p4() {
    p_Val2_68_fu_326_p4 = p_Val2_67_fu_313_p2.read().range(13, 6);
}

void fc::thread_p_Val2_69_fu_347_p2() {
    p_Val2_69_fu_347_p2 = (!tmp_246_fu_336_p1.read().is_01() || !p_Val2_68_fu_326_p4.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_246_fu_336_p1.read()) + sc_biguint<8>(p_Val2_68_fu_326_p4.read()));
}

void fc::thread_p_Val2_78_mux_fu_489_p3() {
    p_Val2_78_mux_fu_489_p3 = (!brmerge_i_i_i_reg_721.read()[0].is_01())? sc_lv<8>(): ((brmerge_i_i_i_reg_721.read()[0].to_bool())? ap_const_lv8_7F: p_Val2_69_reg_676.read());
}

void fc::thread_p_Val2_s_170_fu_495_p3() {
    p_Val2_s_170_fu_495_p3 = (!underflow_reg_716.read()[0].is_01())? sc_lv<8>(): ((underflow_reg_716.read()[0].to_bool())? ap_const_lv8_80: p_Val2_69_reg_676.read());
}

void fc::thread_p_not_i_i_fu_430_p2() {
    p_not_i_i_fu_430_p2 = (deleted_zeros_fu_400_p3.read() ^ ap_const_lv1_1);
}

void fc::thread_p_result_V_fu_581_p3() {
    p_result_V_fu_581_p3 = (!underflow_10_fu_549_p2.read()[0].is_01())? sc_lv<8>(): ((underflow_10_fu_549_p2.read()[0].to_bool())? ap_const_lv8_80: result_V_fu_530_p2.read());
}

void fc::thread_result_1_fu_589_p3() {
    result_1_fu_589_p3 = (!brmerge1_fu_567_p2.read()[0].is_01())? sc_lv<8>(): ((brmerge1_fu_567_p2.read()[0].to_bool())? result_V_mux_fu_573_p3.read(): p_result_V_fu_581_p3.read());
}

void fc::thread_result_V_fu_530_p2() {
    result_V_fu_530_p2 = (!p_Val2_63_reg_731.read().is_01() || !p_Val2_s_reg_183.read().is_01())? sc_lv<8>(): (sc_biguint<8>(p_Val2_63_reg_731.read()) + sc_biguint<8>(p_Val2_s_reg_183.read()));
}

void fc::thread_result_V_mux_fu_573_p3() {
    result_V_mux_fu_573_p3 = (!brmerge_i_i_fu_555_p2.read()[0].is_01())? sc_lv<8>(): ((brmerge_i_i_fu_555_p2.read()[0].to_bool())? ap_const_lv8_7F: result_V_fu_530_p2.read());
}

void fc::thread_sext2_fu_206_p1() {
    sext2_fu_206_p1 = esl_sext<64,32>(fc_output_V15.read());
}

void fc::thread_sext_cast_fu_217_p1() {
    sext_cast_fu_217_p1 = esl_sext<33,32>(fc_weight_V11.read());
}

void fc::thread_sum_V_fu_501_p3() {
    sum_V_fu_501_p3 = (!underflow_not_fu_484_p2.read()[0].is_01())? sc_lv<8>(): ((underflow_not_fu_484_p2.read()[0].to_bool())? p_Val2_78_mux_fu_489_p3.read(): p_Val2_s_170_fu_495_p3.read());
}

void fc::thread_tmp2_demorgan_fu_457_p2() {
    tmp2_demorgan_fu_457_p2 = (p_38_i_i_fu_425_p2.read() | brmerge40_demorgan_i_fu_452_p2.read());
}

void fc::thread_tmp2_fu_463_p2() {
    tmp2_fu_463_p2 = (tmp2_demorgan_fu_457_p2.read() ^ ap_const_lv1_1);
}

void fc::thread_tmp3_fu_480_p2() {
    tmp3_fu_480_p2 = (brmerge40_demorgan_i_reg_711.read() | tmp_249_reg_706.read());
}

void fc::thread_tmp_242_fu_513_p1() {
    tmp_242_fu_513_p1 = esl_sext<9,8>(p_Val2_63_reg_731.read());
}

void fc::thread_tmp_243_fu_543_p2() {
    tmp_243_fu_543_p2 = (newsignbit_10_fu_535_p3.read() ^ ap_const_lv1_1);
}

void fc::thread_tmp_244_fu_276_p1() {
    tmp_244_fu_276_p1 = esl_zext<64,10>(ci_reg_195.read());
}

void fc::thread_tmp_245_fu_301_p3() {
    tmp_245_fu_301_p3 = esl_concat<8,6>(p_Val2_s_reg_183.read(), ap_const_lv6_0);
}

void fc::thread_tmp_246_fu_336_p1() {
    tmp_246_fu_336_p1 = esl_zext<8,1>(tmp_551_reg_659.read());
}

void fc::thread_tmp_247_fu_361_p2() {
    tmp_247_fu_361_p2 = (newsignbit_fu_353_p3.read() ^ ap_const_lv1_1);
}

void fc::thread_tmp_248_fu_407_p2() {
    tmp_248_fu_407_p2 = (tmp_554_fu_383_p3.read() ^ ap_const_lv1_1);
}

void fc::thread_tmp_249_fu_441_p2() {
    tmp_249_fu_441_p2 = (signbit_reg_669.read() ^ ap_const_lv1_1);
}

void fc::thread_tmp_253_cast_fu_309_p1() {
    tmp_253_cast_fu_309_p1 = esl_sext<16,14>(tmp_245_fu_301_p3.read());
}

void fc::thread_tmp_527_fu_233_p3() {
    tmp_527_fu_233_p3 = esl_concat<4,9>(co_reg_171.read(), ap_const_lv9_0);
}

void fc::thread_tmp_545_fu_241_p1() {
    tmp_545_fu_241_p1 = esl_zext<33,13>(tmp_527_fu_233_p3.read());
}

void fc::thread_tmp_546_fu_245_p2() {
    tmp_546_fu_245_p2 = (!tmp_545_fu_241_p1.read().is_01() || !sext_cast_reg_602.read().is_01())? sc_lv<33>(): (sc_biguint<33>(tmp_545_fu_241_p1.read()) + sc_bigint<33>(sext_cast_reg_602.read()));
}

void fc::thread_tmp_547_fu_250_p1() {
    tmp_547_fu_250_p1 = esl_sext<64,33>(tmp_546_fu_245_p2.read());
}

void fc::thread_tmp_552_fu_339_p3() {
    tmp_552_fu_339_p3 = p_Val2_67_fu_313_p2.read().range(13, 13);
}

void fc::thread_tmp_554_fu_383_p3() {
    tmp_554_fu_383_p3 = p_Val2_67_reg_664.read().range(14, 14);
}

void fc::thread_tmp_fu_260_p1() {
    tmp_fu_260_p1 = esl_zext<64,4>(co_reg_171.read());
}

void fc::thread_tmp_s_fu_509_p1() {
    tmp_s_fu_509_p1 = esl_sext<9,8>(p_Val2_s_reg_183.read());
}

void fc::thread_underflow_10_fu_549_p2() {
    underflow_10_fu_549_p2 = (isneg_fu_522_p3.read() & tmp_243_fu_543_p2.read());
}

void fc::thread_underflow_fu_469_p2() {
    underflow_fu_469_p2 = (signbit_reg_669.read() & tmp2_fu_463_p2.read());
}

void fc::thread_underflow_not_fu_484_p2() {
    underflow_not_fu_484_p2 = (tmp3_fu_480_p2.read() | p_38_i_i_reg_701.read());
}
...
void fc::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond24_fu_221_p2.read(), ap_const_lv1_1))) {
        ...
        case 256 : 
            ...
            break;
        case 512 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read()) && esl_seteq<1,1,1>(exitcond_fu_264_p2.read(), ap_const_lv1_1))) {
