...
wire   [3:0] co_34_fu_227_p2;
reg   [3:0] co_34_reg_610;
wire    ap_CS_fsm_state2;
reg   [31:0] weight_V_addr_reg_615;
wire   [0:0] exitcond24_fu_221_p2;
wire   [63:0] tmp_fu_260_p1;
reg   [63:0] tmp_reg_621;
wire    ap_CS_fsm_state9;
wire   [9:0] ci_6_fu_270_p2;
reg   [9:0] ci_6_reg_629;
wire    ap_CS_fsm_state10;
wire   [0:0] exitcond_fu_264_p2;
reg   [7:0] weight_V_addr_read_reg_644;
reg   [7:0] avgpool_output_V_loa_reg_649;
wire   [15:0] p_Val2_66_fu_287_p2;
reg   [15:0] p_Val2_66_reg_654;
wire    ap_CS_fsm_state12;
reg   [0:0] tmp_551_reg_659;
wire   [15:0] p_Val2_67_fu_313_p2;
reg   [15:0] p_Val2_67_reg_664;
wire    ap_CS_fsm_state13;
reg   [0:0] signbit_reg_669;
wire   [7:0] p_Val2_69_fu_347_p2;
reg   [7:0] p_Val2_69_reg_676;
wire   [0:0] newsignbit_fu_353_p3;
reg   [0:0] newsignbit_reg_682;
wire   [0:0] carry_fu_367_p2;
reg   [0:0] carry_reg_688;
reg   [1:0] tmp_250_reg_695;
wire   [0:0] p_38_i_i_fu_425_p2;
reg   [0:0] p_38_i_i_reg_701;
wire    ap_CS_fsm_state14;
wire   [0:0] tmp_249_fu_441_p2;
reg   [0:0] tmp_249_reg_706;
...
reg   [9:0] ci_reg_195;
wire   [63:0] tmp_244_fu_276_p1;
wire  signed [63:0] sext2_fu_206_p1;
wire  signed [63:0] tmp_547_fu_250_p1;
...
wire   [12:0] tmp_527_fu_233_p3;
wire   [32:0] tmp_545_fu_241_p1;
wire   [32:0] tmp_546_fu_245_p2;
wire  signed [7:0] p_Val2_66_fu_287_p0;
wire  signed [7:0] p_Val2_66_fu_287_p1;
wire   [13:0] tmp_245_fu_301_p3;
wire  signed [15:0] tmp_253_cast_fu_309_p1;
wire   [7:0] tmp_246_fu_336_p1;
wire   [7:0] p_Val2_68_fu_326_p4;
wire   [0:0] tmp_552_fu_339_p3;
wire   [0:0] tmp_247_fu_361_p2;
wire   [0:0] Range1_all_ones_fu_390_p2;
wire   [0:0] Range1_all_zeros_fu_395_p2;
wire   [0:0] tmp_554_fu_383_p3;
wire   [0:0] tmp_248_fu_407_p2;
...
wire   [7:0] p_Val2_78_mux_fu_489_p3;
wire   [7:0] p_Val2_s_170_fu_495_p3;
wire  signed [8:0] tmp_242_fu_513_p1;
wire  signed [8:0] tmp_s_fu_509_p1;
wire   [8:0] p_Val2_64_fu_516_p2;
wire   [7:0] result_V_fu_530_p2;
wire   [0:0] newsignbit_10_fu_535_p3;
wire   [0:0] isneg_fu_522_p3;
wire   [0:0] tmp_243_fu_543_p2;
wire   [0:0] isneg_not_fu_561_p2;
wire   [0:0] brmerge_i_i_fu_555_p2;
wire   [0:0] underflow_10_fu_549_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        ...
        newsignbit_reg_682 <= p_Val2_69_fu_347_p2[32'd7];
        p_Val2_67_reg_664 <= p_Val2_67_fu_313_p2;
        p_Val2_69_reg_676 <= p_Val2_69_fu_347_p2;
        signbit_reg_669 <= p_Val2_67_fu_313_p2[32'd15];
        tmp_250_reg_695 <= {{p_Val2_67_fu_313_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        tmp_551_reg_659 <= p_Val2_66_fu_287_p2[32'd5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == exitcond24_fu_221_p2))) begin
        weight_V_addr_reg_615 <= tmp_547_fu_250_p1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (exitcond24_fu_221_p2 == 1'd1))) begin
...
assign Range1_all_ones_fu_390_p2 = ((tmp_250_reg_695 == 2'd3) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_395_p2 = ((tmp_250_reg_695 == 2'd0) ? 1'b1 : 1'b0);
...
assign avgpool_output_V_address0 = tmp_244_fu_276_p1;

assign bias_V_address0 = tmp_reg_621;

assign brmerge1_fu_567_p2 = (newsignbit_10_fu_535_p3 | isneg_not_fu_561_p2);
...
assign brmerge_i_i_fu_555_p2 = (isneg_fu_522_p3 ^ newsignbit_10_fu_535_p3);

assign brmerge_i_i_i_fu_474_p2 = (underflow_fu_469_p2 | overflow_fu_446_p2);

assign carry_fu_367_p2 = (tmp_552_fu_339_p3 & tmp_247_fu_361_p2);

assign ci_6_fu_270_p2 = (ci_reg_195 + 10'd1);

assign co_34_fu_227_p2 = (co_reg_171 + 4'd1);
...
assign exitcond24_fu_221_p2 = ((co_reg_171 == 4'd10) ? 1'b1 : 1'b0);

assign exitcond_fu_264_p2 = ((ci_reg_195 == 10'd512) ? 1'b1 : 1'b0);

assign isneg_fu_522_p3 = p_Val2_64_fu_516_p2[32'd8];
...
assign newsignbit_10_fu_535_p3 = result_V_fu_530_p2[32'd7];

assign newsignbit_fu_353_p3 = p_Val2_69_fu_347_p2[32'd7];

assign overflow_fu_446_p2 = (brmerge_i_i7_fu_436_p2 & tmp_249_fu_441_p2);

assign p_38_i_i_fu_425_p2 = (carry_reg_688 & Range1_all_ones_fu_390_p2);

assign p_41_i_i_fu_413_p2 = (signbit_reg_669 & tmp_248_fu_407_p2);

assign p_Val2_64_fu_516_p2 = ($signed(tmp_242_fu_513_p1) + $signed(tmp_s_fu_509_p1));

assign p_Val2_66_fu_287_p0 = avgpool_output_V_loa_reg_649;

assign p_Val2_66_fu_287_p1 = weight_V_addr_read_reg_644;

assign p_Val2_66_fu_287_p2 = ($signed(p_Val2_66_fu_287_p0) * $signed(p_Val2_66_fu_287_p1));

assign p_Val2_67_fu_313_p2 = ($signed(p_Val2_66_reg_654) + $signed(tmp_253_cast_fu_309_p1));

assign p_Val2_68_fu_326_p4 = {{p_Val2_67_fu_313_p2[13:6]}};

assign p_Val2_69_fu_347_p2 = (tmp_246_fu_336_p1 + p_Val2_68_fu_326_p4);

assign p_Val2_78_mux_fu_489_p3 = ((brmerge_i_i_i_reg_721[0:0] === 1'b1) ? 8'd127 : p_Val2_69_reg_676);

assign p_Val2_s_170_fu_495_p3 = ((underflow_reg_716[0:0] === 1'b1) ? 8'd128 : p_Val2_69_reg_676);

assign p_not_i_i_fu_430_p2 = (deleted_zeros_fu_400_p3 ^ 1'd1);

assign p_result_V_fu_581_p3 = ((underflow_10_fu_549_p2[0:0] === 1'b1) ? 8'd128 : result_V_fu_530_p2);

assign result_1_fu_589_p3 = ((brmerge1_fu_567_p2[0:0] === 1'b1) ? result_V_mux_fu_573_p3 : p_result_V_fu_581_p3);

assign result_V_fu_530_p2 = (p_Val2_63_reg_731 + p_Val2_s_reg_183);
...
assign sum_V_fu_501_p3 = ((underflow_not_fu_484_p2[0:0] === 1'b1) ? p_Val2_78_mux_fu_489_p3 : p_Val2_s_170_fu_495_p3);
...
assign tmp3_fu_480_p2 = (brmerge40_demorgan_i_reg_711 | tmp_249_reg_706);

assign tmp_242_fu_513_p1 = $signed(p_Val2_63_reg_731);

assign tmp_243_fu_543_p2 = (newsignbit_10_fu_535_p3 ^ 1'd1);

assign tmp_244_fu_276_p1 = ci_reg_195;

assign tmp_245_fu_301_p3 = {{p_Val2_s_reg_183}, {6'd0}};

assign tmp_246_fu_336_p1 = tmp_551_reg_659;

assign tmp_247_fu_361_p2 = (newsignbit_fu_353_p3 ^ 1'd1);

assign tmp_248_fu_407_p2 = (tmp_554_fu_383_p3 ^ 1'd1);

assign tmp_249_fu_441_p2 = (signbit_reg_669 ^ 1'd1);

assign tmp_253_cast_fu_309_p1 = $signed(tmp_245_fu_301_p3);

assign tmp_527_fu_233_p3 = {{co_reg_171}, {9'd0}};

assign tmp_545_fu_241_p1 = tmp_527_fu_233_p3;

assign tmp_546_fu_245_p2 = ($signed(tmp_545_fu_241_p1) + $signed(sext_cast_reg_602));

assign tmp_547_fu_250_p1 = $signed(tmp_546_fu_245_p2);

assign tmp_552_fu_339_p3 = p_Val2_67_fu_313_p2[32'd13];

assign tmp_554_fu_383_p3 = p_Val2_67_reg_664[32'd14];

assign tmp_fu_260_p1 = co_reg_171;

assign tmp_s_fu_509_p1 = $signed(p_Val2_s_reg_183);

assign underflow_10_fu_549_p2 = (isneg_fu_522_p3 & tmp_243_fu_543_p2);
