...
wire  signed [10:0] tmp_42_cast_fu_369_p1;
reg  signed [10:0] tmp_42_cast_reg_1028;
wire   [0:0] exitcond1_fu_330_p2;
wire  signed [11:0] tmp_45_cast_fu_403_p1;
reg  signed [11:0] tmp_45_cast_reg_1033;
wire   [2:0] tmp_37_fu_407_p1;
reg   [2:0] tmp_37_reg_1038;
wire   [7:0] tmp_39_fu_445_p2;
reg   [7:0] tmp_39_reg_1043;
reg   [6:0] bias_V_addr_reg_1048;
wire   [3:0] tmp_2_fu_457_p3;
reg   [3:0] tmp_2_reg_1056;
wire    ap_CS_fsm_state3;
wire   [0:0] exitcond2_fu_451_p2;
wire   [12:0] tmp_42_fu_494_p2;
reg   [12:0] tmp_42_reg_1061;
...
wire   [10:0] tmp_46_fu_547_p2;
reg   [10:0] tmp_46_reg_1087;
wire   [0:0] exitcond4_fu_520_p2;
wire   [11:0] tmp_50_fu_601_p2;
reg   [11:0] tmp_50_reg_1092;
wire   [12:0] tmp_43_fu_611_p2;
reg   [12:0] tmp_43_reg_1097;
...
wire   [63:0] tmp_61_cast_fu_643_p1;
wire   [63:0] tmp_62_cast_fu_672_p1;
wire   [63:0] tmp_53_cast_fu_1016_p1;
wire   [8:0] tmp_s_fu_351_p3;
wire   [9:0] p_shl4_cast_fu_359_p1;
wire   [9:0] tmp_cast_fu_347_p1;
wire   [9:0] tmp_32_fu_363_p2;
wire   [9:0] tmp_33_fu_373_p3;
wire   [7:0] tmp_34_fu_385_p3;
wire   [10:0] p_shl2_cast_fu_381_p1;
wire   [10:0] p_shl3_cast_fu_393_p1;
wire   [10:0] tmp_35_fu_397_p2;
wire   [3:0] newIndex_fu_411_p4;
wire   [6:0] tmp_36_fu_421_p3;
wire   [4:0] tmp_38_fu_433_p3;
wire   [7:0] p_shl_cast_fu_429_p1;
wire   [7:0] p_shl1_cast_fu_441_p1;
wire   [11:0] tmp_3_cast_fu_465_p1;
wire   [11:0] tmp_40_fu_469_p2;
wire   [9:0] tmp_41_fu_474_p1;
wire   [12:0] p_shl5_cast_fu_478_p3;
wire   [12:0] p_shl6_cast_fu_486_p3;
wire   [10:0] tmp_1_cast_fu_532_p1;
wire   [10:0] tmp_44_fu_536_p2;
wire   [10:0] tmp_45_fu_541_p2;
wire   [1:0] tmp2_fu_553_p2;
wire  signed [3:0] tmp2_cast_fu_559_p1;
wire   [3:0] tmp_8_fu_563_p2;
wire   [7:0] tmp_cast_26_fu_568_p1;
wire   [7:0] tmp_47_fu_572_p2;
wire   [10:0] tmp_48_fu_577_p3;
wire   [8:0] tmp_49_fu_589_p3;
...
wire   [7:0] p_Val2_8_28_fu_919_p3;
...
wire   [0:0] underflow_2_fu_974_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_fu_330_p2 == 1'd0))) begin
        ...
        tmp_39_reg_1043[7 : 1] <= tmp_39_fu_445_p2[7 : 1];
        tmp_42_cast_reg_1028 <= tmp_42_cast_fu_369_p1;
        tmp_45_cast_reg_1033[11 : 1] <= tmp_45_cast_fu_403_p1[11 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        newsignbit_2_reg_1260 <= result_V_fu_955_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_54_reg_1175 <= p_Val2_5_fu_711_p2[32'd5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond2_fu_451_p2))) begin
        ...
        tmp_42_reg_1061[12 : 1] <= tmp_42_fu_494_p2[12 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond4_fu_520_p2))) begin
        ...
        tmp_50_reg_1092[11 : 1] <= tmp_50_fu_601_p2[11 : 1];
    end
end
...
assign ShuffleConvs_2_Downs_1_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_2_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_3_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_4_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_5_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_6_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_7_address0 = tmp_62_cast_fu_672_p1;

assign ShuffleConvs_2_Downs_address0 = tmp_62_cast_fu_672_p1;
...
assign brmerge9_fu_988_p2 = (newsignbit_2_reg_1260 | isneg_not_fu_983_p2);

assign brmerge_i_i1_fu_860_p2 = (newsignbit_reg_1198 | p_not_i_i_fu_854_p2);

assign brmerge_i_i_fu_979_p2 = (isneg_reg_1247 ^ newsignbit_2_reg_1260);

assign brmerge_i_i_i_fu_898_p2 = (underflow_fu_893_p2 | overflow_fu_870_p2);

assign carry_fu_791_p2 = (tmp_55_fu_763_p3 & tmp_17_fu_785_p2);
...
assign output_V_address0 = tmp_53_cast_fu_1016_p1;
...
assign p_Val2_8_28_fu_919_p3 = ((underflow_reg_1232[0:0] === 1'b1) ? 8'd128 : p_Val2_8_reg_1192);
...
assign p_result_V_fu_1000_p3 = ((underflow_2_fu_974_p2[0:0] === 1'b1) ? 8'd128 : result_V_reg_1254);

assign p_shl1_cast_fu_441_p1 = tmp_38_fu_433_p3;

assign p_shl2_cast_fu_381_p1 = tmp_33_fu_373_p3;

assign p_shl3_cast_fu_393_p1 = tmp_34_fu_385_p3;

assign p_shl4_cast_fu_359_p1 = tmp_s_fu_351_p3;

assign p_shl5_cast_fu_478_p3 = {{tmp_41_fu_474_p1}, {3'd0}};

assign p_shl6_cast_fu_486_p3 = {{tmp_40_fu_469_p2}, {1'd0}};

assign p_shl7_cast_fu_585_p1 = tmp_48_fu_577_p3;

assign p_shl8_cast_fu_597_p1 = tmp_49_fu_589_p3;

assign p_shl_cast_fu_429_p1 = tmp_36_fu_421_p3;
...
assign sum_V_fu_925_p3 = ((underflow_not_fu_908_p2[0:0] === 1'b1) ? p_Val2_8_mux_fu_913_p3 : p_Val2_8_28_fu_919_p3);
...
assign tmp_32_fu_363_p2 = (p_shl4_cast_fu_359_p1 - tmp_cast_fu_347_p1);

assign tmp_33_fu_373_p3 = {{co_reg_249}, {3'd0}};

assign tmp_34_fu_385_p3 = {{co_reg_249}, {1'd0}};

assign tmp_35_fu_397_p2 = (p_shl2_cast_fu_381_p1 - p_shl3_cast_fu_393_p1);

assign tmp_36_fu_421_p3 = {{newIndex_fu_411_p4}, {3'd0}};

assign tmp_37_fu_407_p1 = co_reg_249[2:0];

assign tmp_38_fu_433_p3 = {{newIndex_fu_411_p4}, {1'd0}};

assign tmp_39_fu_445_p2 = (p_shl_cast_fu_429_p1 + p_shl1_cast_fu_441_p1);

assign tmp_3_cast_fu_465_p1 = h_reg_260;

assign tmp_40_fu_469_p2 = ($signed(tmp_45_cast_reg_1033) + $signed(tmp_3_cast_fu_465_p1));

assign tmp_41_fu_474_p1 = tmp_40_fu_469_p2[9:0];

assign tmp_42_cast_fu_369_p1 = $signed(tmp_32_fu_363_p2);

assign tmp_42_fu_494_p2 = (p_shl5_cast_fu_478_p3 - p_shl6_cast_fu_486_p3);

assign tmp_43_fu_611_p2 = (tmp_42_reg_1061 + tmp_9_cast_fu_607_p1);

assign tmp_44_fu_536_p2 = ($signed(tmp_42_cast_reg_1028) + $signed(tmp_1_cast_fu_532_p1));

assign tmp_45_cast_fu_403_p1 = $signed(tmp_35_fu_397_p2);

assign tmp_45_fu_541_p2 = tmp_44_fu_536_p2 << 11'd2;

assign tmp_46_fu_547_p2 = (tmp_45_fu_541_p2 - tmp_44_fu_536_p2);

assign tmp_47_fu_572_p2 = (tmp_39_reg_1043 + tmp_cast_26_fu_568_p1);

assign tmp_48_fu_577_p3 = {{tmp_47_fu_572_p2}, {3'd0}};

assign tmp_49_fu_589_p3 = {{tmp_47_fu_572_p2}, {1'd0}};

assign tmp_4_fu_969_p2 = (newsignbit_2_reg_1260 ^ 1'd1);

assign tmp_50_fu_601_p2 = (p_shl8_cast_fu_597_p1 + p_shl7_cast_fu_585_p1);

assign tmp_51_fu_638_p2 = (tmp_10_cast_fu_634_p1 + tmp_46_reg_1087);

assign tmp_52_fu_667_p2 = (tmp_12_cast_fu_663_p1 + tmp_50_reg_1092);

assign tmp_53_cast_fu_1016_p1 = tmp_43_reg_1097;

assign tmp_55_fu_763_p3 = p_Val2_6_fu_737_p2[32'd13];

assign tmp_57_fu_807_p3 = p_Val2_6_reg_1180[32'd14];

assign tmp_5_fu_506_p3 = {{w_reg_272}, {1'd0}};

assign tmp_61_cast_fu_643_p1 = tmp_51_fu_638_p2;

assign tmp_62_cast_fu_672_p1 = tmp_52_fu_667_p2;
...
assign tmp_cast_26_fu_568_p1 = tmp_8_fu_563_p2;
...
assign underflow_2_fu_974_p2 = (isneg_reg_1247 & tmp_4_fu_969_p2);
...
assign weight_V_address0 = tmp_61_cast_fu_643_p1;

always @ (posedge ap_clk) begin
    tmp_45_cast_reg_1033[0] <= 1'b0;
    tmp_39_reg_1043[0] <= 1'b0;
    tmp_2_reg_1056[0] <= 1'b0;
    tmp_42_reg_1061[0] <= 1'b0;
    tmp_5_reg_1069[0] <= 1'b0;
    tmp_50_reg_1092[0] <= 1'b0;
end
