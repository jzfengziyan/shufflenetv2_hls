...
architecture behav of avgpool is 
    ...
    signal co_35_fu_249_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal co_35_reg_521 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_660_fu_259_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_660_reg_531 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_755_cast_fu_281_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_755_cast_reg_536 : STD_LOGIC_VECTOR (9 downto 0);
    signal h_32_fu_291_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_32_reg_544 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_759_cast_fu_306_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_759_cast_reg_549 : STD_LOGIC_VECTOR (11 downto 0);
    signal exitcond34_fu_285_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_597_reg_554 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal p_Val2_76_fu_410_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_76_reg_614 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_73_reg_220 : STD_LOGIC_VECTOR (7 downto 0);
    signal w_reg_232 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_760_cast_fu_355_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_598_fu_301_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_tr_fu_314_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_neg_fu_318_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_293_cast_fu_346_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_599_fu_350_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_Val2_74_fu_371_p10 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_294_fu_367_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_295_fu_392_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_Val2_75_fu_396_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_296_fu_424_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_100_mux_fu_448_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_1_fu_455_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_lshr_cast_fu_478_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_89_fu_487_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_90_fu_497_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_661_fu_470_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_neg_t_fu_481_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_lshr_f_cast_fu_501_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_91_fu_505_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ShuffleNetV2_mux_jbC_x_U371 : component ShuffleNetV2_mux_jbC
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    port map (
        ...
        din9 => tmp_660_reg_531,
        dout => p_Val2_74_fu_371_p10);
    ...
    p_Val2_73_reg_220_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
                p_Val2_73_reg_220 <= sum_V_fu_462_p3;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond34_fu_285_p2))) then 
                p_Val2_73_reg_220 <= p_Val2_s_reg_197;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_1 = exitcond_fu_334_p2))) then 
                p_Val2_s_reg_197 <= p_Val2_73_reg_220;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond35_fu_243_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                isneg_reg_607 <= p_Val2_75_fu_396_p2(8 downto 8);
                newsignbit_reg_620 <= p_Val2_76_fu_410_p2(7 downto 7);
                p_Val2_76_reg_614 <= p_Val2_76_fu_410_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (exitcond34_fu_285_p2 = ap_const_lv1_1))) then
                tmp_597_reg_554 <= p_neg_fu_318_p2(8 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond35_fu_243_p2 = ap_const_lv1_0))) then
                tmp_660_reg_531 <= tmp_660_fu_259_p1;
                    tmp_755_cast_reg_536(8 downto 2) <= tmp_755_cast_fu_281_p1(8 downto 2);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond34_fu_285_p2))) then
                    tmp_759_cast_reg_549(11 downto 2) <= tmp_759_cast_fu_306_p3(11 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_755_cast_reg_536(1 downto 0) <= "00";
    tmp_755_cast_reg_536(9) <= '0';
    tmp_759_cast_reg_549(1 downto 0) <= "00";
    ...
    co_35_fu_249_p2 <= std_logic_vector(unsigned(co_reg_186) + unsigned(ap_const_lv10_1));
    conv_last_output_V_0_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_1_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_2_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_3_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_4_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_5_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_6_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    conv_last_output_V_7_address0 <= tmp_760_cast_fu_355_p1(10 - 1 downto 0);
    ...
    h_32_fu_291_p2 <= std_logic_vector(unsigned(h_reg_209) + unsigned(ap_const_lv3_1));
    ...
    begin
        ...
        output_V_d0 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_91_fu_505_p3),8));
    ...
    p_Val2_100_mux_fu_448_p3 <= 
        ap_const_lv8_7F when (brmerge_i_i_i_fu_434_p2(0) = '1') else 
        p_Val2_76_reg_614;
    p_Val2_1_fu_455_p3 <= 
        ap_const_lv8_80 when (underflow_fu_429_p2(0) = '1') else 
        p_Val2_76_reg_614;
    p_Val2_75_fu_396_p2 <= std_logic_vector(signed(tmp_294_fu_367_p1) + signed(tmp_295_fu_392_p1));
    p_Val2_76_fu_410_p2 <= std_logic_vector(unsigned(p_Val2_74_fu_371_p10) + unsigned(p_Val2_73_reg_220));
    p_lshr_cast_fu_478_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_597_reg_554),6));
    p_lshr_f_cast_fu_501_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_90_fu_497_p1),6));
    ...
    sum_V_fu_462_p3 <= 
        p_Val2_100_mux_fu_448_p3 when (brmerge_fu_443_p2(0) = '1') else 
        p_Val2_1_fu_455_p3;
    tmp_293_cast_fu_346_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(w_reg_232),12));
        tmp_294_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_73_reg_220),9));

        tmp_295_fu_392_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_74_fu_371_p10),9));

    tmp_296_fu_424_p2 <= (newsignbit_reg_620 xor ap_const_lv1_1);
    tmp_598_fu_301_p2 <= std_logic_vector(unsigned(tmp_cast_fu_297_p1) + unsigned(tmp_755_cast_reg_536));
    tmp_599_fu_350_p2 <= std_logic_vector(unsigned(tmp_759_cast_reg_549) + unsigned(tmp_293_cast_fu_346_p1));
    tmp_660_fu_259_p1 <= co_reg_186(3 - 1 downto 0);
    tmp_661_fu_470_p3 <= p_Val2_s_reg_197(7 downto 7);
    tmp_755_cast_fu_281_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_273_p3),10));
    tmp_759_cast_fu_306_p3 <= (tmp_598_fu_301_p2 & ap_const_lv2_0);
    tmp_760_cast_fu_355_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_599_fu_350_p2),64));
    tmp_89_fu_487_p4 <= p_Val2_s_reg_197(7 downto 4);
        tmp_90_fu_497_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_89_fu_487_p4),5));

    tmp_91_fu_505_p3 <= 
        p_neg_t_fu_481_p2 when (tmp_661_fu_470_p3(0) = '1') else 
    ...
    underflow_fu_429_p2 <= (isneg_reg_607 and tmp_296_fu_424_p2);
