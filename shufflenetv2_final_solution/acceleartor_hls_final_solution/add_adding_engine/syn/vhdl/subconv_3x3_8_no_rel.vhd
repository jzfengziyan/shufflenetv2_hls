...
architecture behav of subconv_3x3_8_no_rel is 
    ...
    signal tmp_64_cast_fu_363_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_64_cast_reg_1004 : STD_LOGIC_VECTOR (9 downto 0);
    signal exitcond5_fu_324_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_56_fu_391_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_56_reg_1009 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_58_fu_397_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_58_reg_1014 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_60_fu_435_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_60_reg_1019 : STD_LOGIC_VECTOR (6 downto 0);
    signal bias_V_addr_reg_1024 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_64_fu_480_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_64_reg_1032 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_66_fu_514_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_66_reg_1053 : STD_LOGIC_VECTOR (9 downto 0);
    signal exitcond8_fu_498_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_69_fu_539_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_69_reg_1059 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_68_fu_549_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_68_reg_1065 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal tmp_72_fu_576_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_72_reg_1070 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_74_fu_628_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_74_reg_1088 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_76_reg_1148 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_83_cast_fu_603_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_84_cast_fu_633_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_75_cast_fu_985_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_53_fu_357_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_54_fu_367_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_55_fu_379_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_57_fu_411_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_59_fu_423_p3 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_61_fu_451_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_62_fu_456_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_63_fu_468_p3 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_67_fu_544_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_70_fu_554_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_71_fu_565_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_73_fu_598_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_77_fu_723_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_79_fu_767_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_65_fu_980_p2 : STD_LOGIC_VECTOR (13 downto 0);
...
begin
    ShuffleNetV2_mux_jbC_x_U236 : component ShuffleNetV2_mux_jbC
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond5_fu_324_p2 = ap_const_lv1_0))) then
                bias_V_addr_reg_1024 <= tmp_fu_336_p1(6 - 1 downto 0);
                    tmp_56_reg_1009(9 downto 1) <= tmp_56_fu_391_p2(9 downto 1);
                tmp_58_reg_1014 <= tmp_58_fu_397_p1;
                    tmp_60_reg_1019(6 downto 1) <= tmp_60_fu_435_p2(6 downto 1);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                ...
                tmp_76_reg_1148 <= p_Val2_1_fu_671_p2(5 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond6_fu_441_p2))) then
                    tmp_64_reg_1032(13 downto 1) <= tmp_64_fu_480_p2(13 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then
                tmp_68_reg_1065 <= tmp_68_fu_549_p2;
                    tmp_72_reg_1070(10 downto 1) <= tmp_72_fu_576_p2(10 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    buffer1_1_48_8x8_p_V_1_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_2_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_3_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_4_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_5_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_6_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_7_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    buffer1_1_48_8x8_p_V_8_address0 <= tmp_84_cast_fu_633_p1(10 - 1 downto 0);
    ...
    carry_fu_751_p2 <= (tmp_77_fu_723_p3 and tmp_38_fu_745_p2);
    ...
    output_V_address0 <= tmp_75_cast_fu_985_p1(13 - 1 downto 0);
    ...
    p_result_V_fu_960_p3 <= 
        ...
        result_V_reg_1227;
    p_shl1_cast_fu_431_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_59_fu_423_p3),7));
    p_shl2_cast_fu_375_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_54_fu_367_p3),10));
    p_shl3_cast_fu_387_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_55_fu_379_p3),10));
    p_shl4_cast_fu_353_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_345_p3),9));
    p_shl5_cast_fu_464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_62_fu_456_p3),14));
    p_shl6_cast_fu_476_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_63_fu_468_p3),14));
    p_shl7_cast_fu_561_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_70_fu_554_p3),11));
    p_shl8_cast_fu_572_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_71_fu_565_p3),11));
    p_shl_cast_fu_419_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_57_fu_411_p3),7));
    ...
    tmp_37_fu_720_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_76_reg_1148),8));
    tmp_38_fu_745_p2 <= (newsignbit_fu_737_p3 xor ap_const_lv1_1);
    tmp_40_fu_791_p2 <= (tmp_79_fu_767_p3 xor ap_const_lv1_1);
    ...
    tmp_53_fu_357_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_353_p1) - unsigned(tmp_cast_fu_341_p1));
    tmp_54_fu_367_p3 <= (co_reg_243 & ap_const_lv3_0);
    tmp_55_fu_379_p3 <= (co_reg_243 & ap_const_lv1_0);
    tmp_56_fu_391_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_375_p1) + unsigned(p_shl3_cast_fu_387_p1));
    tmp_57_fu_411_p3 <= (newIndex_fu_401_p4 & ap_const_lv3_0);
    tmp_58_fu_397_p1 <= co_reg_243(3 - 1 downto 0);
    tmp_59_fu_423_p3 <= (newIndex_fu_401_p4 & ap_const_lv1_0);
    tmp_60_fu_435_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_419_p1) + unsigned(p_shl1_cast_fu_431_p1));
    tmp_61_fu_451_p2 <= std_logic_vector(unsigned(tmp_cast_30_fu_447_p1) + unsigned(tmp_56_reg_1009));
    tmp_62_fu_456_p3 <= (tmp_61_fu_451_p2 & ap_const_lv3_0);
    tmp_63_fu_468_p3 <= (tmp_61_fu_451_p2 & ap_const_lv1_0);
        tmp_64_cast_fu_363_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_53_fu_357_p2),10));

    tmp_64_fu_480_p2 <= std_logic_vector(unsigned(p_shl5_cast_fu_464_p1) + unsigned(p_shl6_cast_fu_476_p1));
    tmp_65_fu_980_p2 <= std_logic_vector(unsigned(tmp_64_reg_1032) + unsigned(tmp_29_cast_fu_976_p1));
    tmp_66_fu_514_p2 <= std_logic_vector(signed(tmp_64_cast_reg_1004) + signed(tmp_30_cast_fu_510_p1));
    tmp_67_fu_544_p2 <= std_logic_vector(shift_left(unsigned(tmp_66_reg_1053),to_integer(unsigned('0' & ap_const_lv10_2(10-1 downto 0)))));
    tmp_68_fu_549_p2 <= std_logic_vector(unsigned(tmp_67_fu_544_p2) - unsigned(tmp_66_reg_1053));
    tmp_69_fu_539_p2 <= std_logic_vector(unsigned(tmp_60_reg_1019) + unsigned(tmp_32_cast_fu_535_p1));
    tmp_70_fu_554_p3 <= (tmp_69_reg_1059 & ap_const_lv3_0);
    tmp_71_fu_565_p3 <= (tmp_69_reg_1059 & ap_const_lv1_0);
    tmp_72_fu_576_p2 <= std_logic_vector(unsigned(p_shl8_cast_fu_572_p1) + unsigned(p_shl7_cast_fu_561_p1));
    tmp_73_fu_598_p2 <= std_logic_vector(unsigned(tmp_33_cast_fu_594_p1) + unsigned(tmp_68_reg_1065));
    tmp_74_fu_628_p2 <= std_logic_vector(unsigned(tmp_35_cast_fu_624_p1) + unsigned(tmp_72_reg_1070));
    tmp_75_cast_fu_985_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_65_fu_980_p2),64));
    tmp_77_fu_723_p3 <= p_Val2_15_fu_697_p2(13 downto 13);
    tmp_79_fu_767_p3 <= p_Val2_15_reg_1153(14 downto 14);
    tmp_83_cast_fu_603_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_73_fu_598_p2),64));
    tmp_84_cast_fu_633_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_74_reg_1088),64));
    ...
    weight_V_address0 <= tmp_83_cast_fu_603_p1(9 - 1 downto 0);
