...
architecture behav of subconv_3x3_8_stride is 
    ...
    signal tmp_42_cast_fu_369_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_42_cast_reg_1028 : STD_LOGIC_VECTOR (10 downto 0);
    signal exitcond1_fu_330_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_45_cast_fu_403_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_45_cast_reg_1033 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_37_fu_407_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_37_reg_1038 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_39_fu_445_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_39_reg_1043 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_42_fu_494_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_42_reg_1061 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_46_fu_547_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_46_reg_1087 : STD_LOGIC_VECTOR (10 downto 0);
    signal exitcond4_fu_520_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_50_fu_601_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_50_reg_1092 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_43_fu_611_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_43_reg_1097 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_54_reg_1175 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal newsignbit_2_reg_1260 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_61_cast_fu_643_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_62_cast_fu_672_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_53_cast_fu_1016_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_32_fu_363_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_33_fu_373_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_34_fu_385_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl2_cast_fu_381_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl3_cast_fu_393_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_35_fu_397_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal newIndex_fu_411_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_36_fu_421_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_38_fu_433_p3 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_40_fu_469_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_41_fu_474_p1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_44_fu_536_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_45_fu_541_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_cast_26_fu_568_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_47_fu_572_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_48_fu_577_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_49_fu_589_p3 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_51_fu_638_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_55_fu_763_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_8_28_fu_919_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal underflow_2_fu_974_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ShuffleNetV2_mux_jbC_x_U278 : component ShuffleNetV2_mux_jbC
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond1_fu_330_p2 = ap_const_lv1_0))) then
                ...
                tmp_37_reg_1038 <= tmp_37_fu_407_p1;
                    tmp_39_reg_1043(7 downto 1) <= tmp_39_fu_445_p2(7 downto 1);
                tmp_42_cast_reg_1028 <= tmp_42_cast_fu_369_p1;
                    tmp_45_cast_reg_1033(11 downto 1) <= tmp_45_cast_fu_403_p1(11 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                ...
                newsignbit_2_reg_1260 <= result_V_fu_955_p2(7 downto 7);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                ...
                tmp_54_reg_1175 <= p_Val2_5_fu_711_p2(5 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond2_fu_451_p2))) then
                    ...
                    tmp_42_reg_1061(12 downto 1) <= tmp_42_fu_494_p2(12 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (ap_const_lv1_1 = exitcond4_fu_520_p2))) then
                tmp_43_reg_1097 <= tmp_43_fu_611_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (ap_const_lv1_0 = exitcond4_fu_520_p2))) then
                tmp_46_reg_1087 <= tmp_46_fu_547_p2;
                    tmp_50_reg_1092(11 downto 1) <= tmp_50_fu_601_p2(11 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ShuffleConvs_2_Downs_1_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_2_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_3_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_4_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_5_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_6_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_7_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    ShuffleConvs_2_Downs_address0 <= tmp_62_cast_fu_672_p1(11 - 1 downto 0);
    ...
    brmerge9_fu_988_p2 <= (newsignbit_2_reg_1260 or isneg_not_fu_983_p2);
    brmerge_i_i1_fu_860_p2 <= (newsignbit_reg_1198 or p_not_i_i_fu_854_p2);
    brmerge_i_i_fu_979_p2 <= (isneg_reg_1247 xor newsignbit_2_reg_1260);
    brmerge_i_i_i_fu_898_p2 <= (underflow_fu_893_p2 or overflow_fu_870_p2);
    carry_fu_791_p2 <= (tmp_55_fu_763_p3 and tmp_17_fu_785_p2);
    ...
    output_V_address0 <= tmp_53_cast_fu_1016_p1(12 - 1 downto 0);
    ...
    p_result_V_fu_1000_p3 <= 
        ap_const_lv8_80 when (underflow_2_fu_974_p2(0) = '1') else 
        result_V_reg_1254;
    p_shl1_cast_fu_441_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_38_fu_433_p3),8));
    p_shl2_cast_fu_381_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_33_fu_373_p3),11));
    p_shl3_cast_fu_393_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_34_fu_385_p3),11));
    p_shl4_cast_fu_359_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_351_p3),10));
    p_shl5_cast_fu_478_p3 <= (tmp_41_fu_474_p1 & ap_const_lv3_0);
    p_shl6_cast_fu_486_p3 <= (tmp_40_fu_469_p2 & ap_const_lv1_0);
    p_shl7_cast_fu_585_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_48_fu_577_p3),12));
    p_shl8_cast_fu_597_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_49_fu_589_p3),12));
    p_shl_cast_fu_429_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_36_fu_421_p3),8));
    ...
    tmp_16_fu_760_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_54_reg_1175),8));
    ...
    tmp_18_fu_831_p2 <= (tmp_57_fu_807_p3 xor ap_const_lv1_1);
    ...
    tmp_32_fu_363_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_359_p1) - unsigned(tmp_cast_fu_347_p1));
    tmp_33_fu_373_p3 <= (co_reg_249 & ap_const_lv3_0);
    tmp_34_fu_385_p3 <= (co_reg_249 & ap_const_lv1_0);
    tmp_35_fu_397_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_381_p1) - unsigned(p_shl3_cast_fu_393_p1));
    tmp_36_fu_421_p3 <= (newIndex_fu_411_p4 & ap_const_lv3_0);
    tmp_37_fu_407_p1 <= co_reg_249(3 - 1 downto 0);
    tmp_38_fu_433_p3 <= (newIndex_fu_411_p4 & ap_const_lv1_0);
    tmp_39_fu_445_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_429_p1) + unsigned(p_shl1_cast_fu_441_p1));
    tmp_3_cast_fu_465_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(h_reg_260),12));
    tmp_40_fu_469_p2 <= std_logic_vector(signed(tmp_45_cast_reg_1033) + signed(tmp_3_cast_fu_465_p1));
    tmp_41_fu_474_p1 <= tmp_40_fu_469_p2(10 - 1 downto 0);
        tmp_42_cast_fu_369_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_32_fu_363_p2),11));

    tmp_42_fu_494_p2 <= std_logic_vector(unsigned(p_shl5_cast_fu_478_p3) - unsigned(p_shl6_cast_fu_486_p3));
    tmp_43_fu_611_p2 <= std_logic_vector(unsigned(tmp_42_reg_1061) + unsigned(tmp_9_cast_fu_607_p1));
    tmp_44_fu_536_p2 <= std_logic_vector(signed(tmp_42_cast_reg_1028) + signed(tmp_1_cast_fu_532_p1));
        tmp_45_cast_fu_403_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_35_fu_397_p2),12));

    tmp_45_fu_541_p2 <= std_logic_vector(shift_left(unsigned(tmp_44_fu_536_p2),to_integer(unsigned('0' & ap_const_lv11_2(11-1 downto 0)))));
    tmp_46_fu_547_p2 <= std_logic_vector(unsigned(tmp_45_fu_541_p2) - unsigned(tmp_44_fu_536_p2));
    tmp_47_fu_572_p2 <= std_logic_vector(unsigned(tmp_39_reg_1043) + unsigned(tmp_cast_26_fu_568_p1));
    tmp_48_fu_577_p3 <= (tmp_47_fu_572_p2 & ap_const_lv3_0);
    tmp_49_fu_589_p3 <= (tmp_47_fu_572_p2 & ap_const_lv1_0);
    tmp_4_fu_969_p2 <= (newsignbit_2_reg_1260 xor ap_const_lv1_1);
    tmp_50_fu_601_p2 <= std_logic_vector(unsigned(p_shl8_cast_fu_597_p1) + unsigned(p_shl7_cast_fu_585_p1));
    tmp_51_fu_638_p2 <= std_logic_vector(unsigned(tmp_10_cast_fu_634_p1) + unsigned(tmp_46_reg_1087));
    tmp_52_fu_667_p2 <= std_logic_vector(unsigned(tmp_12_cast_fu_663_p1) + unsigned(tmp_50_reg_1092));
    tmp_53_cast_fu_1016_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_43_reg_1097),64));
    tmp_55_fu_763_p3 <= p_Val2_6_fu_737_p2(13 downto 13);
    tmp_57_fu_807_p3 <= p_Val2_6_reg_1180(14 downto 14);
    tmp_5_fu_506_p3 <= (w_reg_272 & ap_const_lv1_0);
    tmp_61_cast_fu_643_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_51_fu_638_p2),64));
    tmp_62_cast_fu_672_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_52_fu_667_p2),64));
    ...
    tmp_cast_26_fu_568_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_563_p2),8));
    ...
    underflow_2_fu_974_p2 <= (isneg_reg_1247 and tmp_4_fu_969_p2);
    ...
    weight_V_address0 <= tmp_61_cast_fu_643_p1(10 - 1 downto 0);
