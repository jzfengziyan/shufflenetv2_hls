...
wire  signed [8:0] tmp_176_cast_fu_562_p1;
reg  signed [8:0] tmp_176_cast_reg_1203;
wire    ap_CS_fsm_state2;
wire   [9:0] tmp_168_fu_590_p2;
reg   [9:0] tmp_168_reg_1208;
wire   [4:0] co_6_fu_602_p2;
reg   [4:0] co_6_reg_1216;
reg   [4:0] bias_V_addr_reg_1221;
wire   [0:0] exitcond5_fu_596_p2;
wire   [13:0] tmp_171_fu_637_p2;
reg   [13:0] tmp_171_reg_1226;
wire    ap_CS_fsm_state3;
reg   [12:0] output_V_addr_reg_1234;
wire    ap_CS_fsm_state4;
wire   [4:0] h_6_fu_669_p2;
wire   [0:0] exitcond7_fu_663_p2;
wire   [8:0] tmp_175_fu_690_p2;
reg   [8:0] tmp_175_reg_1247;
wire    ap_CS_fsm_state5;
wire   [1:0] m_6_fu_702_p2;
reg   [1:0] m_6_reg_1255;
wire   [9:0] tmp_178_fu_748_p2;
reg   [9:0] tmp_178_reg_1260;
wire   [0:0] exitcond8_fu_696_p2;
reg   [7:0] weight_V_addr_reg_1265;
wire    ap_CS_fsm_state6;
wire   [1:0] n_6_fu_774_p2;
reg   [1:0] n_6_reg_1273;
wire   [9:0] tmp_180_fu_800_p2;
reg   [9:0] tmp_180_reg_1278;
wire   [0:0] exitcond_fu_768_p2;
wire    ap_CS_fsm_state7;
reg   [7:0] weight_V_load_reg_1403;
wire    ap_CS_fsm_state8;
wire   [7:0] tmp_73_fu_832_p26;
reg   [7:0] tmp_73_reg_1408;
wire   [15:0] p_Val2_6_fu_892_p2;
reg   [15:0] p_Val2_6_reg_1413;
wire    ap_CS_fsm_state9;
reg   [0:0] tmp_182_reg_1418;
wire   [15:0] p_Val2_50_fu_918_p2;
reg   [15:0] p_Val2_50_reg_1423;
wire    ap_CS_fsm_state10;
reg   [0:0] signbit_reg_1428;
wire   [7:0] p_Val2_52_fu_952_p2;
reg   [7:0] p_Val2_52_reg_1435;
...
reg   [1:0] m_reg_501;
reg   [7:0] p_Val2_49_reg_512;
reg   [1:0] n_reg_524;
wire   [31:0] co_cast_fu_535_p1;
wire   [31:0] tmp_184_cast_fu_658_p1;
wire   [31:0] tmp_191_cast_fu_763_p1;
wire   [31:0] tmp_192_cast_fu_805_p1;
wire   [6:0] tmp_164_fu_544_p3;
wire   [7:0] p_shl2_cast_fu_552_p1;
wire   [7:0] co_cast_cast_fu_540_p1;
wire   [7:0] tmp_165_fu_556_p2;
wire   [8:0] tmp_166_fu_566_p3;
wire   [5:0] tmp_167_fu_578_p3;
wire   [9:0] p_shl1_cast_fu_586_p1;
wire   [9:0] p_shl_cast_fu_574_p1;
wire   [9:0] h_cast9_cast_fu_608_p1;
wire   [9:0] tmp_169_fu_612_p2;
wire   [10:0] tmp_170_fu_625_p3;
wire   [13:0] p_shl3_cast_fu_617_p3;
wire   [13:0] p_shl4_cast_fu_633_p1;
wire   [13:0] w_cast8_cast_fu_649_p1;
wire   [13:0] tmp_172_fu_653_p2;
wire   [8:0] m_cast7_cast_fu_675_p1;
wire   [8:0] tmp_173_fu_679_p2;
wire   [8:0] tmp_174_fu_684_p2;
wire   [1:0] tmp2_fu_708_p2;
wire  signed [4:0] tmp2_cast_fu_714_p1;
wire   [4:0] tmp_75_fu_718_p2;
wire   [8:0] tmp_176_fu_724_p3;
wire   [5:0] tmp_177_fu_736_p3;
wire   [9:0] p_shl7_cast_fu_744_p1;
wire   [9:0] p_shl6_cast_fu_732_p1;
wire   [8:0] n_cast6_cast_fu_754_p1;
wire   [8:0] tmp_179_fu_758_p2;
wire   [1:0] tmp3_fu_780_p2;
wire  signed [4:0] tmp3_cast_fu_786_p1;
wire   [4:0] tmp_76_fu_790_p2;
wire   [9:0] tmp_109_cast_cast_fu_796_p1;
wire  signed [7:0] p_Val2_6_fu_892_p0;
wire  signed [7:0] p_Val2_6_fu_892_p1;
wire   [13:0] tmp_77_fu_906_p3;
wire  signed [15:0] tmp_111_cast_fu_914_p1;
wire   [7:0] p_Val2_51_fu_931_p4;
wire   [7:0] tmp_78_fu_941_p1;
wire   [0:0] tmp_183_fu_944_p3;
wire   [0:0] tmp_79_fu_966_p2;
wire   [0:0] Range1_all_ones_fu_995_p2;
wire   [0:0] Range1_all_zeros_fu_1000_p2;
wire   [0:0] tmp_185_fu_988_p3;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        newsignbit_reg_1441 <= p_Val2_52_fu_952_p2[32'd7];
        p_Val2_50_reg_1423 <= p_Val2_50_fu_918_p2;
        p_Val2_52_reg_1435 <= p_Val2_52_fu_952_p2;
        signbit_reg_1428 <= p_Val2_50_fu_918_p2[32'd15];
        tmp_80_reg_1454 <= {{p_Val2_50_fu_918_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_168_reg_1208[9 : 1] <= tmp_168_fu_590_p2[9 : 1];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        isneg_reg_1490 <= p_Val2_47_fu_1122_p2[32'd8];
        newsignbit_8_reg_1503 <= result_V_fu_1136_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        weight_V_addr_reg_1265 <= tmp_191_cast_fu_763_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        output_V_addr_reg_1234 <= tmp_184_cast_fu_658_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_182_reg_1418 <= p_Val2_6_fu_892_p2[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        tmp_171_reg_1226[13 : 1] <= tmp_171_fu_637_p2[13 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond8_fu_696_p2))) begin
        tmp_178_reg_1260[9 : 1] <= tmp_178_fu_748_p2[9 : 1];
    end
end
...
assign brmerge9_fu_1175_p2 = (newsignbit_8_reg_1503 | isneg_not_fu_1170_p2);

assign brmerge_i_i6_fu_1041_p2 = (newsignbit_reg_1441 | p_not_i_i_fu_1035_p2);

assign brmerge_i_i_fu_1166_p2 = (isneg_reg_1490 ^ newsignbit_8_reg_1503);

assign brmerge_i_i_i_fu_1079_p2 = (underflow_fu_1074_p2 | overflow_fu_1051_p2);

assign buffer1_1_24_16x16_p_10_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_11_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_12_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_13_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_14_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_15_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_16_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_17_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_18_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_19_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_1_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_20_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_21_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_22_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_23_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_2_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_3_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_4_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_5_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_6_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_7_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_8_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_9_address0 = tmp_192_cast_fu_805_p1;

assign buffer1_1_24_16x16_p_address0 = tmp_192_cast_fu_805_p1;

assign carry_fu_972_p2 = (tmp_183_fu_944_p3 & tmp_79_fu_966_p2);
...
assign newsignbit_fu_958_p3 = p_Val2_52_fu_952_p2[32'd7];
...
assign p_Val2_47_fu_1122_p2 = ($signed(tmp_s_fu_1118_p1) + $signed(tmp_fu_1114_p1));

assign p_Val2_48_mux_fu_1094_p3 = ((brmerge_i_i_i_reg_1480[0:0] === 1'b1) ? 8'd127 : p_Val2_52_reg_1435);

assign p_Val2_50_fu_918_p2 = ($signed(tmp_111_cast_fu_914_p1) + $signed(p_Val2_6_reg_1413));

assign p_Val2_51_fu_931_p4 = {{p_Val2_50_fu_918_p2[13:6]}};

assign p_Val2_52_fu_952_p2 = (p_Val2_51_fu_931_p4 + tmp_78_fu_941_p1);

assign p_Val2_6_fu_892_p0 = weight_V_load_reg_1403;

assign p_Val2_6_fu_892_p1 = tmp_73_reg_1408;

assign p_Val2_6_fu_892_p2 = ($signed(p_Val2_6_fu_892_p0) * $signed(p_Val2_6_fu_892_p1));

assign p_Val2_s_70_fu_1100_p3 = ((underflow_reg_1475[0:0] === 1'b1) ? 8'd128 : p_Val2_52_reg_1435);

assign p_not_i_i_fu_1035_p2 = (deleted_zeros_fu_1005_p3 ^ 1'd1);

assign p_result_V_fu_1187_p3 = ((underflow_8_fu_1161_p2[0:0] === 1'b1) ? 8'd128 : result_V_reg_1497);

assign p_shl1_cast_fu_586_p1 = tmp_167_fu_578_p3;

assign p_shl2_cast_fu_552_p1 = tmp_164_fu_544_p3;

assign p_shl3_cast_fu_617_p3 = {{tmp_169_fu_612_p2}, {4'd0}};

assign p_shl4_cast_fu_633_p1 = tmp_170_fu_625_p3;

assign p_shl6_cast_fu_732_p1 = tmp_176_fu_724_p3;

assign p_shl7_cast_fu_744_p1 = tmp_177_fu_736_p3;

assign p_shl_cast_fu_574_p1 = tmp_166_fu_566_p3;
...
assign sum_V_fu_1106_p3 = ((underflow_not_fu_1089_p2[0:0] === 1'b1) ? p_Val2_48_mux_fu_1094_p3 : p_Val2_s_70_fu_1100_p3);
...
assign tmp_109_cast_cast_fu_796_p1 = tmp_76_fu_790_p2;

assign tmp_111_cast_fu_914_p1 = $signed(tmp_77_fu_906_p3);

assign tmp_164_fu_544_p3 = {{co_reg_453}, {2'd0}};

assign tmp_165_fu_556_p2 = (p_shl2_cast_fu_552_p1 - co_cast_cast_fu_540_p1);

assign tmp_166_fu_566_p3 = {{co_reg_453}, {4'd0}};

assign tmp_167_fu_578_p3 = {{co_reg_453}, {1'd0}};

assign tmp_168_fu_590_p2 = (p_shl1_cast_fu_586_p1 + p_shl_cast_fu_574_p1);

assign tmp_169_fu_612_p2 = (h_cast9_cast_fu_608_p1 + tmp_168_reg_1208);

assign tmp_170_fu_625_p3 = {{tmp_169_fu_612_p2}, {1'd0}};

assign tmp_171_fu_637_p2 = (p_shl3_cast_fu_617_p3 + p_shl4_cast_fu_633_p1);

assign tmp_172_fu_653_p2 = (tmp_171_reg_1226 + w_cast8_cast_fu_649_p1);

assign tmp_173_fu_679_p2 = ($signed(m_cast7_cast_fu_675_p1) + $signed(tmp_176_cast_reg_1203));

assign tmp_174_fu_684_p2 = tmp_173_fu_679_p2 << 9'd2;

assign tmp_175_fu_690_p2 = (tmp_174_fu_684_p2 - tmp_173_fu_679_p2);

assign tmp_176_cast_fu_562_p1 = $signed(tmp_165_fu_556_p2);

assign tmp_176_fu_724_p3 = {{tmp_75_fu_718_p2}, {4'd0}};

assign tmp_177_fu_736_p3 = {{tmp_75_fu_718_p2}, {1'd0}};

assign tmp_178_fu_748_p2 = (p_shl7_cast_fu_744_p1 + p_shl6_cast_fu_732_p1);

assign tmp_179_fu_758_p2 = (tmp_175_reg_1247 + n_cast6_cast_fu_754_p1);

assign tmp_180_fu_800_p2 = (tmp_109_cast_cast_fu_796_p1 + tmp_178_reg_1260);

assign tmp_183_fu_944_p3 = p_Val2_50_fu_918_p2[32'd13];

assign tmp_184_cast_fu_658_p1 = tmp_172_fu_653_p2;

assign tmp_185_fu_988_p3 = p_Val2_50_reg_1423[32'd14];

assign tmp_191_cast_fu_763_p1 = tmp_179_fu_758_p2;

assign tmp_192_cast_fu_805_p1 = tmp_180_reg_1278;

assign tmp_74_fu_1156_p2 = (newsignbit_8_reg_1503 ^ 1'd1);

assign tmp_75_fu_718_p2 = ($signed(h_reg_465) + $signed(tmp2_cast_fu_714_p1));

assign tmp_76_fu_790_p2 = ($signed(tmp3_cast_fu_786_p1) + $signed(w_reg_477));

assign tmp_77_fu_906_p3 = {{p_Val2_49_reg_512}, {6'd0}};

assign tmp_78_fu_941_p1 = tmp_182_reg_1418;

assign tmp_79_fu_966_p2 = (newsignbit_fu_958_p3 ^ 1'd1);

assign tmp_81_fu_1012_p2 = (tmp_185_fu_988_p3 ^ 1'd1);
...
assign underflow_8_fu_1161_p2 = (isneg_reg_1490 & tmp_74_fu_1156_p2);
...
always @ (posedge ap_clk) begin
    tmp_168_reg_1208[0] <= 1'b0;
    tmp_171_reg_1226[0] <= 1'b0;
    tmp_178_reg_1260[0] <= 1'b0;
end
