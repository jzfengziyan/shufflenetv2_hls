...
architecture behav of subconv_3x3_8_stride is 
    ...
    signal tmp_37_fu_254_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_37_reg_846 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_41_cast_fu_278_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_41_cast_reg_851 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_44_cast_fu_288_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_44_cast_reg_856 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_42_fu_333_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_42_reg_874 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_47_fu_402_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_47_reg_905 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal m_1_fu_414_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal m_1_reg_913 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_49_fu_468_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_49_reg_918 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal tmp_49_cast_fu_362_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_57_cast_fu_489_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_58_cast_fu_530_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_35_fu_230_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_36_fu_242_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl4_cast_fu_250_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl3_cast_fu_238_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_38_fu_260_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl2_cast_fu_268_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal co_cast_cast_fu_226_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_39_fu_272_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_40_fu_282_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal h_cast9_cast_fu_304_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_41_fu_308_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_43_fu_313_p1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_44_fu_357_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal m_cast7_cast_fu_387_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_45_fu_391_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_46_fu_396_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_48_fu_439_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_50_fu_444_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_51_fu_456_p3 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_52_fu_484_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_53_fu_525_p2 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal tmp_56_fu_593_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_58_fu_637_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_8_40_fu_749_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal underflow_2_fu_804_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                co_1_reg_864 <= co_1_fu_298_p2;
                    tmp_37_reg_846(10 downto 1) <= tmp_37_fu_254_p2(10 downto 1);
                tmp_41_cast_reg_851 <= tmp_41_cast_fu_278_p1;
                    tmp_44_cast_reg_856(11 downto 1) <= tmp_44_cast_fu_288_p1(11 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                ...
                newsignbit_2_reg_1046 <= result_V_fu_785_p2(7 downto 7);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                output_V_addr_reg_887 <= tmp_49_cast_fu_362_p1(12 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                ...
                tmp_55_reg_961 <= p_Val2_5_fu_541_p2(5 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                    tmp_42_reg_874(12 downto 1) <= tmp_42_fu_333_p2(12 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (ap_const_lv1_0 = exitcond4_fu_408_p2))) then
                    tmp_49_reg_918(14 downto 1) <= tmp_49_fu_468_p2(14 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    brmerge9_fu_818_p2 <= (newsignbit_2_reg_1046 or isneg_not_fu_813_p2);
    brmerge_i_i1_fu_690_p2 <= (newsignbit_reg_984 or p_not_i_i_fu_684_p2);
    brmerge_i_i_fu_809_p2 <= (isneg_reg_1033 xor newsignbit_2_reg_1046);
    brmerge_i_i_i_fu_728_p2 <= (underflow_fu_723_p2 or overflow_fu_700_p2);
    carry_fu_621_p2 <= (tmp_56_fu_593_p3 and tmp_15_fu_615_p2);
    ...
    input_V_address0 <= tmp_58_cast_fu_530_p1(14 - 1 downto 0);
    ...
    p_result_V_fu_830_p3 <= 
        ap_const_lv8_80 when (underflow_2_fu_804_p2(0) = '1') else 
        result_V_reg_1040;
    p_shl2_cast_fu_268_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_38_fu_260_p3),10));
    p_shl3_cast_fu_238_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_35_fu_230_p3),11));
    p_shl4_cast_fu_250_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_36_fu_242_p3),11));
    p_shl5_cast_fu_317_p3 <= (tmp_43_fu_313_p1 & ap_const_lv3_0);
    p_shl6_cast_fu_325_p3 <= (tmp_41_fu_308_p2 & ap_const_lv1_0);
    p_shl8_cast_fu_452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_50_fu_444_p3),15));
    p_shl9_cast_fu_464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_51_fu_456_p3),15));
    ...
    tmp_14_fu_590_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_55_reg_961),8));
    tmp_15_fu_615_p2 <= (newsignbit_fu_607_p3 xor ap_const_lv1_1);
    tmp_16_fu_661_p2 <= (tmp_58_fu_637_p3 xor ap_const_lv1_1);
    tmp_18_fu_695_p2 <= (signbit_reg_971 xor ap_const_lv1_1);
    tmp_2_fu_373_p3 <= (w_reg_163 & ap_const_lv1_0);
    tmp_35_fu_230_p3 <= (co_reg_140 & ap_const_lv3_0);
    tmp_36_fu_242_p3 <= (co_reg_140 & ap_const_lv1_0);
    tmp_37_fu_254_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_250_p1) + unsigned(p_shl3_cast_fu_238_p1));
    tmp_38_fu_260_p3 <= (co_reg_140 & ap_const_lv2_0);
    tmp_39_fu_272_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_268_p1) - unsigned(co_cast_cast_fu_226_p1));
        tmp_3_fu_763_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_s_reg_175),9));

    tmp_40_fu_282_p2 <= std_logic_vector(unsigned(p_shl3_cast_fu_238_p1) - unsigned(p_shl4_cast_fu_250_p1));
        tmp_41_cast_fu_278_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_39_fu_272_p2),11));

    tmp_41_fu_308_p2 <= std_logic_vector(unsigned(h_cast9_cast_fu_304_p1) + unsigned(tmp_44_cast_reg_856));
    tmp_42_fu_333_p2 <= std_logic_vector(unsigned(p_shl5_cast_fu_317_p3) - unsigned(p_shl6_cast_fu_325_p3));
    tmp_43_fu_313_p1 <= tmp_41_fu_308_p2(10 - 1 downto 0);
        tmp_44_cast_fu_288_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_40_fu_282_p2),12));

    tmp_44_fu_357_p2 <= std_logic_vector(unsigned(tmp_42_reg_874) + unsigned(w_cast8_cast_fu_353_p1));
    tmp_45_fu_391_p2 <= std_logic_vector(unsigned(m_cast7_cast_fu_387_p1) + unsigned(tmp_41_cast_reg_851));
    tmp_46_fu_396_p2 <= std_logic_vector(shift_left(unsigned(tmp_45_fu_391_p2),to_integer(unsigned('0' & ap_const_lv11_2(11-1 downto 0)))));
    tmp_47_fu_402_p2 <= std_logic_vector(unsigned(tmp_46_fu_396_p2) - unsigned(tmp_45_fu_391_p2));
    tmp_48_fu_439_p2 <= std_logic_vector(unsigned(tmp_cast_cast_fu_435_p1) + unsigned(tmp_37_reg_846));
    tmp_49_cast_fu_362_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_44_fu_357_p2),32));
    tmp_49_fu_468_p2 <= std_logic_vector(unsigned(p_shl8_cast_fu_452_p1) + unsigned(p_shl9_cast_fu_464_p1));
        tmp_4_fu_767_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(bias_V_q0),9));

    tmp_50_fu_444_p3 <= (tmp_48_fu_439_p2 & ap_const_lv3_0);
    tmp_51_fu_456_p3 <= (tmp_48_fu_439_p2 & ap_const_lv1_0);
    tmp_52_fu_484_p2 <= std_logic_vector(unsigned(tmp_47_reg_905) + unsigned(n_cast6_cast_fu_480_p1));
    tmp_53_fu_525_p2 <= std_logic_vector(unsigned(tmp_10_cast_cast_fu_521_p1) + unsigned(tmp_49_reg_918));
    tmp_56_fu_593_p3 <= p_Val2_6_fu_567_p2(13 downto 13);
    tmp_57_cast_fu_489_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_52_fu_484_p2),32));
    tmp_58_cast_fu_530_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_53_fu_525_p2),32));
    tmp_58_fu_637_p3 <= p_Val2_6_reg_966(14 downto 14);
    tmp_5_fu_799_p2 <= (newsignbit_2_reg_1046 xor ap_const_lv1_1);
    ...
    underflow_2_fu_804_p2 <= (isneg_reg_1033 and tmp_5_fu_799_p2);
    ...
    weight_V_address0 <= tmp_57_cast_fu_489_p1(10 - 1 downto 0);
