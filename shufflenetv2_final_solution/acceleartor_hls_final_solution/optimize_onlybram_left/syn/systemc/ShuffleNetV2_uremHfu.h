...
#ifndef __ShuffleNetV2_uremHfu__HH__
#define __ShuffleNetV2_uremHfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremHfu) {
    ...
    SC_CTOR(ShuffleNetV2_uremHfu):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
