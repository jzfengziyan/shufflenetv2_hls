...
#ifndef __ShuffleNetV2_mul_fcY__HH__
#define __ShuffleNetV2_mul_fcY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_mul_fcY) {
    ...
    SC_CTOR(ShuffleNetV2_mul_fcY):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
