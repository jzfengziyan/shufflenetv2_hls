...
#ifndef __ShuffleNetV2_mul_fdY__HH__
#define __ShuffleNetV2_mul_fdY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_mul_fdY) {
    ...
    SC_CTOR(ShuffleNetV2_mul_fdY):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
