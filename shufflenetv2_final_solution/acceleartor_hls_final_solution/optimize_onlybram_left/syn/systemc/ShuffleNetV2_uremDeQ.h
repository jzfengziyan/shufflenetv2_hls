...
#ifndef __ShuffleNetV2_uremDeQ__HH__
#define __ShuffleNetV2_uremDeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremDeQ) {
    ...
    ACMP_urem_seq<ID, 10, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(ShuffleNetV2_uremDeQ):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
