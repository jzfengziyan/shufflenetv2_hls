...
#ifndef __ShuffleNetV2_uremfaY__HH__
#define __ShuffleNetV2_uremfaY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremfaY) {
    ...
    SC_CTOR(ShuffleNetV2_uremfaY):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
