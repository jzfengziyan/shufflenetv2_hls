...
#ifndef __ShuffleNetV2_uremfbY__HH__
#define __ShuffleNetV2_uremfbY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_uremfbY) {
    ...
    SC_CTOR(ShuffleNetV2_uremfbY):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
