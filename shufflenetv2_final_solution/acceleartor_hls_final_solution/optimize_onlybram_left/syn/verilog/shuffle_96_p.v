...
wire   [0:0] tmp_2018_fu_468_p1;
reg   [0:0] tmp_2018_reg_876;
wire    ap_CS_fsm_state2;
wire  signed [12:0] tmp_521_cast_fu_502_p1;
reg  signed [12:0] tmp_521_cast_reg_880;
wire   [7:0] co_25_fu_512_p2;
reg   [7:0] co_25_reg_888;
reg   [6:0] p_lshr_f_cast_reg_893;
wire   [0:0] exitcond5_fu_506_p2;
reg   [3:0] tmp_2019_reg_901;
wire    ap_CS_fsm_state11;
wire  signed [11:0] tmp_526_cast_fu_581_p1;
reg  signed [11:0] tmp_526_cast_reg_907;
wire    ap_CS_fsm_state12;
wire   [8:0] arrayNo_cast_fu_585_p1;
reg   [8:0] arrayNo_cast_reg_912;
wire  signed [11:0] tmp_531_cast_fu_625_p1;
reg  signed [11:0] tmp_531_cast_reg_917;
wire   [12:0] tmp_473_fu_662_p2;
reg   [12:0] tmp_473_reg_922;
wire    ap_CS_fsm_state13;
wire   [13:0] tmp_475_fu_693_p2;
reg   [13:0] tmp_475_reg_927;
wire   [8:0] tmp_477_fu_728_p2;
reg   [8:0] tmp_477_reg_932;
...
ShuffleNetV2_uremHfu #(
    .ID( 1 ),
    .NUM_STAGE( 11 ),
    .din0_WIDTH( 7 ),
    .din1_WIDTH( 6 ),
    .dout_WIDTH( 7 ))
ShuffleNetV2_uremHfu_x_U764(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        tmp_526_cast_reg_907[11 : 1] <= tmp_526_cast_fu_581_p1[11 : 1];
        tmp_531_cast_reg_917[11 : 1] <= tmp_531_cast_fu_625_p1[11 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_521_cast_reg_880[12 : 1] <= tmp_521_cast_fu_502_p1[12 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state13)) begin
        ...
        tmp_473_reg_922[12 : 1] <= tmp_473_fu_662_p2[12 : 1];
        tmp_475_reg_927[13 : 1] <= tmp_475_fu_693_p2[13 : 1];
        tmp_477_reg_932[8 : 1] <= tmp_477_fu_728_p2[8 : 1];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        output_V_addr_reg_950 <= tmp_545_cast_fu_773_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        tmp_2019_reg_901 <= {{mul_fu_537_p2[15:12]}};
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state14 : begin
            if (((1'b1 == ap_CS_fsm_state14) & (1'd1 == exitcond_fu_811_p2))) begin
                ap_NS_fsm = ap_ST_fsm_state13;
            end else if (((1'b1 == ap_CS_fsm_state14) & (1'd0 == exitcond_fu_811_p2) & (tmp_2018_reg_876 == 1'd1))) begin
...
assign buffer1_1_96_4x4_p_V_10_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_11_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_12_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_13_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_14_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_15_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_16_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_17_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_18_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_19_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_1_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_20_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_21_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_22_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_23_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_24_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_2_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_3_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_4_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_5_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_6_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_7_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_8_address0 = tmp_546_cast_fu_783_p1;

assign buffer1_1_96_4x4_p_V_9_address0 = tmp_546_cast_fu_783_p1;
...
assign left_V_address0 = tmp_544_cast_fu_763_p1;
...
assign p_shl10_cast_fu_646_p3 = {{tmp_2022_fu_642_p1}, {3'd0}};

assign p_shl11_cast_fu_654_p3 = {{tmp_472_fu_637_p2}, {1'd0}};

assign p_shl1_cast_fu_492_p1 = tmp_464_fu_484_p3;

assign p_shl2_cast_fu_600_p1 = $unsigned(tmp_469_fu_596_p1);

assign p_shl3_cast_fu_615_p1 = $unsigned(tmp_470_fu_611_p1);

assign p_shl4_cast_fu_560_p1 = tmp_466_fu_553_p3;

assign p_shl5_cast_fu_571_p1 = tmp_467_fu_564_p3;

assign p_shl6_cast_fu_708_p3 = {{tmp_2024_fu_704_p1}, {3'd0}};

assign p_shl7_cast_fu_720_p3 = {{tmp_2025_fu_716_p1}, {1'd0}};

assign p_shl8_cast_fu_677_p3 = {{tmp_2023_fu_673_p1}, {3'd0}};

assign p_shl9_cast_fu_685_p3 = {{tmp_474_fu_668_p2}, {1'd0}};

assign p_shl_cast_fu_480_p1 = tmp_s_fu_472_p3;

assign tmp_2018_fu_468_p1 = co_reg_425[0:0];

assign tmp_2020_fu_589_p3 = {{tmp_2019_reg_901}, {3'd0}};

assign tmp_2021_fu_604_p3 = {{tmp_2019_reg_901}, {1'd0}};

assign tmp_2022_fu_642_p1 = tmp_472_fu_637_p2[9:0];

assign tmp_2023_fu_673_p1 = tmp_474_fu_668_p2[10:0];

assign tmp_2024_fu_704_p1 = tmp_476_fu_699_p2[5:0];

assign tmp_2025_fu_716_p1 = tmp_476_fu_699_p2[7:0];

assign tmp_464_fu_484_p3 = {{co_reg_425}, {1'd0}};

assign tmp_465_fu_496_p2 = (p_shl_cast_fu_480_p1 - p_shl1_cast_fu_492_p1);

assign tmp_466_fu_553_p3 = {{p_lshr_f_cast_reg_893}, {3'd0}};

assign tmp_467_fu_564_p3 = {{p_lshr_f_cast_reg_893}, {1'd0}};

assign tmp_468_fu_575_p2 = (p_shl4_cast_fu_560_p1 - p_shl5_cast_fu_571_p1);

assign tmp_469_fu_596_p1 = $signed(tmp_2020_fu_589_p3);

assign tmp_470_fu_611_p1 = $signed(tmp_2021_fu_604_p3);

assign tmp_471_fu_619_p2 = (p_shl2_cast_fu_600_p1 - p_shl3_cast_fu_615_p1);

assign tmp_472_fu_637_p2 = ($signed(h_cast2_cast_fu_633_p1) + $signed(tmp_526_cast_reg_907));

assign tmp_473_fu_662_p2 = (p_shl10_cast_fu_646_p3 - p_shl11_cast_fu_654_p3);

assign tmp_474_fu_668_p2 = ($signed(h_cast2_cast1_fu_629_p1) + $signed(tmp_521_cast_reg_880));

assign tmp_475_fu_693_p2 = (p_shl8_cast_fu_677_p3 - p_shl9_cast_fu_685_p3);

assign tmp_476_fu_699_p2 = ($signed(h_cast2_cast_fu_633_p1) + $signed(tmp_531_cast_reg_917));

assign tmp_477_fu_728_p2 = (p_shl6_cast_fu_708_p3 - p_shl7_cast_fu_720_p3);

assign tmp_478_fu_758_p2 = (tmp_473_reg_922 + w_cast1_cast_fu_754_p1);

assign tmp_479_fu_768_p2 = (tmp_475_reg_927 + w_cast1_cast2_fu_750_p1);

assign tmp_480_fu_778_p2 = (tmp_477_reg_932 + w_cast1_cast1_fu_746_p1);

assign tmp_521_cast_fu_502_p1 = $signed(tmp_465_fu_496_p2);

assign tmp_526_cast_fu_581_p1 = $signed(tmp_468_fu_575_p2);

assign tmp_531_cast_fu_625_p1 = $signed(tmp_471_fu_619_p2);

assign tmp_544_cast_fu_763_p1 = tmp_478_fu_758_p2;

assign tmp_545_cast_fu_773_p1 = tmp_479_fu_768_p2;

assign tmp_546_cast_fu_783_p1 = tmp_480_fu_778_p2;
...
always @ (posedge ap_clk) begin
    tmp_521_cast_reg_880[0] <= 1'b0;
    tmp_526_cast_reg_907[0] <= 1'b0;
    arrayNo_cast_reg_912[8:7] <= 2'b00;
    tmp_531_cast_reg_917[0] <= 1'b0;
    tmp_473_reg_922[0] <= 1'b0;
    tmp_475_reg_927[0] <= 1'b0;
    tmp_477_reg_932[0] <= 1'b0;
end
