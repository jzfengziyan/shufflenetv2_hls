...
wire   [15:0] tmp_456_fu_108_p1;
wire   [15:0] loc_V_fu_111_p2;
reg    grp_fu_80_ce;

ShuffleNetV2_mul_bkb #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 26 ),
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp0_stage0_flag00011001 == 1'b0) & (ap_ce == 1'b1))) begin
        ...
        tmp_2664_reg_147 <= grp_fu_80_p2[32'd15];
...
assign loc_V_fu_111_p2 = (tmp_456_fu_108_p1 + p_Result_s_reg_152);
...
assign tmp_456_fu_108_p1 = tmp_2664_reg_147;
