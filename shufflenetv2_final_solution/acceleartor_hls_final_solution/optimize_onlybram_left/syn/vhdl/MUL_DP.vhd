...
architecture behav of MUL_DP is 
    ...
    signal tmp_2664_reg_147 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_456_fu_108_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal loc_V_fu_111_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_80_ce : STD_LOGIC;

    component ShuffleNetV2_mul_bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ShuffleNetV2_mul_bkb_U0 : component ShuffleNetV2_mul_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0) and (ap_ce = ap_const_logic_1))) then
                ...
                tmp_2664_reg_147 <= grp_fu_80_p2(15 downto 15);
    ...
    loc_V_fu_111_p2 <= std_logic_vector(unsigned(tmp_456_fu_108_p1) + unsigned(p_Result_s_reg_152));
    ...
    tmp_456_fu_108_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2664_reg_147),16));
end behav;
