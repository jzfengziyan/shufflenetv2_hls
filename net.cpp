...
/** initialize weights and image **/
	...
	ifs_param.read((char*)(***conv_last_weight), 512*192*1*1*sizeof(float));
    ifs_param.read((char*)conv_last_bias, 512*sizeof(float));//verified
	ifs_param.read((char*)(*fc_weight), 10*512*sizeof(float));
    ifs_param.read((char*)fc_bias, 10*sizeof(float));//verified
    ifs_param.close();
