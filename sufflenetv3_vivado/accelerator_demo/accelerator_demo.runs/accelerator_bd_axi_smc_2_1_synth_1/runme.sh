...
HD_PWD='/home/ziyan/ziyan/ece527/shufflenetv2_master/sufflenetv3_vivado/accelerator_demo/accelerator_demo.runs/accelerator_bd_axi_smc_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerator_bd_axi_smc_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerator_bd_axi_smc_2_1.tcl
