...
#ifndef __vector_multiplierbkb__HH__
#define __vector_multiplierbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vector_multiplierbkb) {
    ...
    SC_CTOR(vector_multiplierbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
