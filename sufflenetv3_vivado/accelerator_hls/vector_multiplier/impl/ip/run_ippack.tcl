...
set Library     "hls"
set IPName      "vector_multiplier"
set Version     "1.0"
set DisplayName "Vector_multiplier"
set Revision    "1710162333"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "vector_multiplier"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTL m_axi_DATA_A m_axi_DATA_B m_axi_DATA_C"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_DATA_A {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_A"
        data_width "32"
        param_prefix "C_M_AXI_DATA_A"
    ...
    m_axi_DATA_B {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_B"
        data_width "32"
        param_prefix "C_M_AXI_DATA_B"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_DATA_C {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_C"
        data_width "32"
        param_prefix "C_M_AXI_DATA_C"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 80 II x}
...
set enable_xo_gen 0
set kernel_files {F:/ECE527/MP4/Tutorial_Files/accelerator_hls/accelerator.cpp}
if {$enable_xo_gen} {
