...
port (
    ...
    buffer1_1_96_4x4_address0 : OUT STD_LOGIC_VECTOR (10 downto 0);
    buffer1_1_96_4x4_ce0 : OUT STD_LOGIC;
    buffer1_1_96_4x4_q0 : IN STD_LOGIC_VECTOR (31 downto 0) );
end;


architecture behav of shuffle_96 is 
    ...
    signal co_15_fu_132_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal co_15_reg_266 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal h_15_fu_178_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal h_15_reg_284 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_248_cast_fu_197_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_248_cast_reg_289 : STD_LOGIC_VECTOR (11 downto 0);
    signal exitcond1_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_251_cast_fu_210_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_251_cast_reg_294 : STD_LOGIC_VECTOR (12 downto 0);
    signal w_15_fu_224_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal w_15_reg_302 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal exitcond_fu_218_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal output_addr_reg_312 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_99_cast_fu_234_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_154_fu_238_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_99_cast1_fu_230_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_155_fu_249_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (ap_const_lv1_0 = exitcond_fu_218_p2))) then
                output_addr_reg_312 <= tmp_253_cast_fu_254_p1(12 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond2_fu_126_p2 = ap_const_lv1_0))) then
                    tmp_243_cast_reg_271(8 downto 2) <= tmp_243_cast_fu_156_p1(8 downto 2);
                    tmp_245_cast_reg_276(9 downto 2) <= tmp_245_cast_fu_168_p1(9 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond1_fu_172_p2))) then
                    tmp_248_cast_reg_289(11 downto 2) <= tmp_248_cast_fu_197_p3(11 downto 2);
                    tmp_251_cast_reg_294(12 downto 2) <= tmp_251_cast_fu_210_p3(12 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_243_cast_reg_271(1 downto 0) <= "00";
    tmp_243_cast_reg_271(9) <= '0';
    tmp_245_cast_reg_276(1 downto 0) <= "00";
    tmp_245_cast_reg_276(10) <= '0';
    tmp_248_cast_reg_289(1 downto 0) <= "00";
    tmp_251_cast_reg_294(1 downto 0) <= "00";
    ...
    buffer1_1_96_4x4_address0 <= tmp_252_cast_fu_243_p1(11 - 1 downto 0);

    buffer1_1_96_4x4_ce0_assign_proc : process(ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    co_15_fu_132_p2 <= std_logic_vector(unsigned(ap_const_lv8_1) + unsigned(co_reg_77));
    ...
    h_15_fu_178_p2 <= std_logic_vector(unsigned(h_reg_88) + unsigned(ap_const_lv3_1));
    left_r_address0 <= tmp_252_cast_fu_243_p1(11 - 1 downto 0);
    ...
    storemerge_phi_fu_113_p4_assign_proc : process(left_r_q0, buffer1_1_96_4x4_q0, tmp_96_reg_259, ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
    ...
    tmp_151_fu_160_p3 <= (co_reg_77 & ap_const_lv2_0);
    ...
    tmp_248_cast_fu_197_p3 <= (tmp_152_fu_192_p2 & ap_const_lv2_0);
    tmp_251_cast_fu_210_p3 <= (tmp_153_fu_205_p2 & ap_const_lv2_0);
    ...
    tmp_99_cast1_fu_230_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(w_reg_99),13));
    tmp_99_cast_fu_234_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(w_reg_99),12));
    ...
    w_15_fu_224_p2 <= std_logic_vector(unsigned(w_reg_99) + unsigned(ap_const_lv3_1));
end behav;
