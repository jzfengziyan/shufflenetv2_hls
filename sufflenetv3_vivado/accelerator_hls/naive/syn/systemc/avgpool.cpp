...
avgpool::avgpool(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_368_cast_fu_204_p1 );
    ...
    SC_METHOD(thread_tmp_123_cast_fu_166_p1);
    sensitive << ( h_reg_81 );

    SC_METHOD(thread_tmp_124_cast_fu_195_p1);
    sensitive << ( w_reg_104 );

    SC_METHOD(thread_tmp_207_fu_142_p3);
    sensitive << ( co_reg_58 );

    SC_METHOD(thread_tmp_208_fu_170_p2);
    sensitive << ( tmp_364_cast_reg_222 );
    sensitive << ( tmp_123_cast_fu_166_p1 );

    SC_METHOD(thread_tmp_209_fu_199_p2);
    sensitive << ( tmp_367_cast_reg_235 );
    sensitive << ( tmp_124_cast_fu_195_p1 );

    SC_METHOD(thread_tmp_364_cast_fu_150_p1);
    sensitive << ( tmp_207_fu_142_p3 );

    SC_METHOD(thread_tmp_367_cast_fu_175_p3);
    sensitive << ( tmp_208_fu_170_p2 );

    SC_METHOD(thread_tmp_368_cast_fu_204_p1);
    sensitive << ( tmp_209_fu_199_p2 );
    ...
    sc_trace(mVcdFile, tmp_364_cast_fu_150_p1, "tmp_364_cast_fu_150_p1");
    sc_trace(mVcdFile, tmp_364_cast_reg_222, "tmp_364_cast_reg_222");
    sc_trace(mVcdFile, h_24_fu_160_p2, "h_24_fu_160_p2");
    sc_trace(mVcdFile, h_24_reg_230, "h_24_reg_230");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, tmp_367_cast_fu_175_p3, "tmp_367_cast_fu_175_p3");
    sc_trace(mVcdFile, tmp_367_cast_reg_235, "tmp_367_cast_reg_235");
    ...
    sc_trace(mVcdFile, tmp_368_cast_fu_204_p1, "tmp_368_cast_fu_204_p1");
    sc_trace(mVcdFile, ap_CS_fsm_state6, "ap_CS_fsm_state6");
    sc_trace(mVcdFile, tmp_207_fu_142_p3, "tmp_207_fu_142_p3");
    sc_trace(mVcdFile, tmp_123_cast_fu_166_p1, "tmp_123_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_208_fu_170_p2, "tmp_208_fu_170_p2");
    sc_trace(mVcdFile, tmp_124_cast_fu_195_p1, "tmp_124_cast_fu_195_p1");
    sc_trace(mVcdFile, tmp_209_fu_199_p2, "tmp_209_fu_199_p2");
...
void avgpool::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond2_fu_126_p2.read(), ap_const_lv1_0))) {
        tmp_364_cast_reg_222 = tmp_364_cast_fu_150_p1.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond1_fu_154_p2.read()))) {
        tmp_367_cast_reg_235 = tmp_367_cast_fu_175_p3.read();
    }
...
void avgpool::thread_conv_last_output_address0() {
    conv_last_output_address0 =  (sc_lv<13>) (tmp_368_cast_fu_204_p1.read());
}
...
void avgpool::thread_tmp_123_cast_fu_166_p1() {
    tmp_123_cast_fu_166_p1 = esl_zext<13,3>(h_reg_81.read());
}

void avgpool::thread_tmp_124_cast_fu_195_p1() {
    tmp_124_cast_fu_195_p1 = esl_zext<15,3>(w_reg_104.read());
}

void avgpool::thread_tmp_207_fu_142_p3() {
    tmp_207_fu_142_p3 = esl_concat<10,2>(co_reg_58.read(), ap_const_lv2_0);
}

void avgpool::thread_tmp_208_fu_170_p2() {
    tmp_208_fu_170_p2 = (!tmp_123_cast_fu_166_p1.read().is_01() || !tmp_364_cast_reg_222.read().is_01())? sc_lv<13>(): (sc_biguint<13>(tmp_123_cast_fu_166_p1.read()) + sc_biguint<13>(tmp_364_cast_reg_222.read()));
}

void avgpool::thread_tmp_209_fu_199_p2() {
    tmp_209_fu_199_p2 = (!tmp_367_cast_reg_235.read().is_01() || !tmp_124_cast_fu_195_p1.read().is_01())? sc_lv<15>(): (sc_biguint<15>(tmp_367_cast_reg_235.read()) + sc_biguint<15>(tmp_124_cast_fu_195_p1.read()));
}

void avgpool::thread_tmp_364_cast_fu_150_p1() {
    tmp_364_cast_fu_150_p1 = esl_zext<13,12>(tmp_207_fu_142_p3.read());
}

void avgpool::thread_tmp_367_cast_fu_175_p3() {
    tmp_367_cast_fu_175_p3 = esl_concat<13,2>(tmp_208_fu_170_p2.read(), ap_const_lv2_0);
}

void avgpool::thread_tmp_368_cast_fu_204_p1() {
    tmp_368_cast_fu_204_p1 = esl_zext<64,15>(tmp_209_fu_199_p2.read());
}
