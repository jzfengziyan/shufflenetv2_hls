...
#ifndef __ShuffleNetV2_fcmpdEe__HH__
#define __ShuffleNetV2_fcmpdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ShuffleNetV2_fcmpdEe) {
    ...
    SC_CTOR(ShuffleNetV2_fcmpdEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
