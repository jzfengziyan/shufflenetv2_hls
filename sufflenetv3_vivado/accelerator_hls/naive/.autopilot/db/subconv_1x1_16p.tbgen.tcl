set moduleName subconv_1x1_16p
...
set C_modelName {subconv_1x1_16p}
...
set C_modelArgList {
	...
	{ ShuffleConvs_1_Downs float 32 regular {array 12288 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_1_Downs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ShuffleConvs_1_DownsampleUnit__conv1r_output","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 47,"step" : 1},{"low" : 0,"up" : 15,"step" : 1},{"low" : 0,"up" : 15,"step" : 1}]}]}], "extern" : 0} ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6612577", "Max" : "6612577"}
	, {"Name" : "Interval", "Min" : "6612577", "Max" : "6612577"}
]}
