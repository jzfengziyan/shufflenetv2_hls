...
set C_modelName {subconv_1x1_8p}
...
set C_modelArgList {
	...
	{ ShuffleConvs_2_Downs float 32 regular {array 6144 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_2_Downs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ShuffleConvs_2_DownsampleUnit__conv1r_output","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 95,"step" : 1},{"low" : 0,"up" : 7,"step" : 1},{"low" : 0,"up" : 7,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ shuffleunit1_7_outpu_address0 sc_out sc_lv 13 signal 2 } 
	{ shuffleunit1_7_outpu_ce0 sc_out sc_logic 1 signal 2 } 
	{ shuffleunit1_7_outpu_q0 sc_in sc_lv 32 signal 2 } 
	{ ShuffleConvs_2_Downs_address0 sc_out sc_lv 13 signal 3 } 
	{ ShuffleConvs_2_Downs_ce0 sc_out sc_logic 1 signal 3 } 
	{ ShuffleConvs_2_Downs_we0 sc_out sc_logic 1 signal 3 } 
	{ ShuffleConvs_2_Downs_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ShuffleConvs_2_Downs_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "ShuffleConvs_2_Downs", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6551233", "Max" : "6551233"}
	, {"Name" : "Interval", "Min" : "6551233", "Max" : "6551233"}
]}
...
set Spec2ImplPortList { 
	...
	ShuffleConvs_2_Downs { ap_memory {  { ShuffleConvs_2_Downs_address0 mem_address 1 13 }  { ShuffleConvs_2_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_2_Downs_we0 mem_we 1 1 }  { ShuffleConvs_2_Downs_d0 mem_din 1 32 } } }
}
