...
set C_modelName {subconv_1x1_32}
set C_modelType { void 0 }
set C_modelArgList {
	{ weight float 32 regular {array 576 { 1 3 } 1 1 }  }
	{ bias float 32 regular {array 24 { 1 3 } 1 1 }  }
	{ conv1_output float 32 regular {array 24576 { 1 3 } 1 1 } {global 0}  }
	{ ShuffleConvs_0_Downs float 32 regular {array 24576 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bias", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "conv1_output", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv1_output","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 31,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}], "extern" : 0} , 
 	{ "Name" : "ShuffleConvs_0_Downs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ShuffleConvs_0_DownsampleUnit__conv1r_output","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 31,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ conv1_output_address0 sc_out sc_lv 15 signal 2 } 
	{ conv1_output_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv1_output_q0 sc_in sc_lv 32 signal 2 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6735409", "Max" : "6735409"}
	, {"Name" : "Interval", "Min" : "6735409", "Max" : "6735409"}
]}
...
set Spec2ImplPortList { 
	...
	conv1_output { ap_memory {  { conv1_output_address0 mem_address 1 15 }  { conv1_output_ce0 mem_ce 1 1 }  { conv1_output_q0 mem_dout 0 32 } } }
