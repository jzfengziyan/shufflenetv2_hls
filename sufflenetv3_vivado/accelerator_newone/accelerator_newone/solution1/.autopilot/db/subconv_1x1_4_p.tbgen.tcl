...
set C_modelArgList {
	{ input_r float 32 regular {array 3456 { 1 3 } 1 1 }  }
	{ weight float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ bias float 32 regular {array 96 { 1 3 } 1 1 }  }
	{ output_r float 32 regular {array 3456 { 2 3 } 1 1 }  }
}
...
set portList { 
	...
	{ weight_address0 sc_out sc_lv 14 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ShuffleNetV2_faddbkb_x_U87", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ShuffleNetV2_fmulcud_x_U88", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ShuffleNetV2_fcmpdEe_x_U89", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1795395", "Max" : "1795395"}
	, {"Name" : "Interval", "Min" : "1795395", "Max" : "1795395"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 12 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
}
