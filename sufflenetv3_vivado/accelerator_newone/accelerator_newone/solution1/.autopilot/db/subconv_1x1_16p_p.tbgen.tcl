...
set C_modelArgList {
	...
	{ ShuffleConvs_1_Downs float 32 regular {array 15552 { 2 3 } 1 1 } {global 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_1_Downs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ShuffleConvs_1_DownsampleUnit__conv1r_output_p","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 47,"step" : 1},{"low" : 0,"up" : 17,"step" : 1},{"low" : 0,"up" : 17,"step" : 1}]}]}], "extern" : 0} , 
...
set portList { 
	...
	{ ShuffleConvs_1_Downs_address0 sc_out sc_lv 14 signal 2 } 
	{ ShuffleConvs_1_Downs_ce0 sc_out sc_logic 1 signal 2 } 
	{ ShuffleConvs_1_Downs_we0 sc_out sc_logic 1 signal 2 } 
	{ ShuffleConvs_1_Downs_d0 sc_out sc_lv 32 signal 2 } 
	{ ShuffleConvs_1_Downs_q0 sc_in sc_lv 32 signal 2 } 
	{ shuffleunit0_2_outpu_address0 sc_out sc_lv 14 signal 3 } 
	{ shuffleunit0_2_outpu_ce0 sc_out sc_logic 1 signal 3 } 
	{ shuffleunit0_2_outpu_q0 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ShuffleConvs_1_Downs_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ShuffleConvs_1_Downs", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7267107", "Max" : "7267107"}
	, {"Name" : "Interval", "Min" : "7267107", "Max" : "7267107"}
]}
...
set Spec2ImplPortList { 
	...
	ShuffleConvs_1_Downs { ap_memory {  { ShuffleConvs_1_Downs_address0 mem_address 1 14 }  { ShuffleConvs_1_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_1_Downs_we0 mem_we 1 1 }  { ShuffleConvs_1_Downs_d0 mem_din 1 32 }  { ShuffleConvs_1_Downs_q0 mem_dout 0 32 } } }
