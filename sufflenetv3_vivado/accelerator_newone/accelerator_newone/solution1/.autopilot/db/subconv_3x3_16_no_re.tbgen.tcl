...
set C_modelArgList {
	{ input_r float 32 regular {array 7776 { 1 3 } 1 1 }  }
	{ weight float 32 regular {array 216 { 1 3 } 1 1 }  }
	{ bias float 32 regular {array 24 { 1 3 } 1 1 }  }
	{ output_r float 32 regular {array 7776 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ShuffleNetV2_faddbkb_x_U32", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ShuffleNetV2_fmulcud_x_U33", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "788066", "Max" : "788066"}
	, {"Name" : "Interval", "Min" : "788066", "Max" : "788066"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 13 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
}
