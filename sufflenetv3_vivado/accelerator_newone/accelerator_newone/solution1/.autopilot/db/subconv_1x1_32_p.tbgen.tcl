...
set C_modelArgList {
	...
	{ ShuffleConvs_0_Downs float 32 regular {array 27744 { 2 3 } 1 1 } {global 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_0_Downs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ShuffleConvs_0_DownsampleUnit__conv1r_output_p","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 33,"step" : 1},{"low" : 0,"up" : 33,"step" : 1}]}]}], "extern" : 0} , 
...
set portList { 
	...
	{ ShuffleConvs_0_Downs_address0 sc_out sc_lv 15 signal 2 } 
	{ ShuffleConvs_0_Downs_ce0 sc_out sc_logic 1 signal 2 } 
	{ ShuffleConvs_0_Downs_we0 sc_out sc_logic 1 signal 2 } 
	{ ShuffleConvs_0_Downs_d0 sc_out sc_lv 32 signal 2 } 
	{ ShuffleConvs_0_Downs_q0 sc_in sc_lv 32 signal 2 } 
	{ conv1_output_p_address0 sc_out sc_lv 15 signal 3 } 
	{ conv1_output_p_ce0 sc_out sc_logic 1 signal 3 } 
	{ conv1_output_p_q0 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ShuffleConvs_0_Downs_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ShuffleConvs_0_Downs", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7451283", "Max" : "7451283"}
	, {"Name" : "Interval", "Min" : "7451283", "Max" : "7451283"}
]}
...
set Spec2ImplPortList { 
	...
	ShuffleConvs_0_Downs { ap_memory {  { ShuffleConvs_0_Downs_address0 mem_address 1 15 }  { ShuffleConvs_0_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_0_Downs_we0 mem_we 1 1 }  { ShuffleConvs_0_Downs_d0 mem_din 1 32 }  { ShuffleConvs_0_Downs_q0 mem_dout 0 32 } } }
