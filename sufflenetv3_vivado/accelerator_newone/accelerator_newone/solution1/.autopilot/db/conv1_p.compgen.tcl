...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_r \
    op interface \
    ports { output_r_address0 { O 15 vector } output_r_ce0 { O 1 bit } output_r_we0 { O 1 bit } output_r_d0 { O 32 vector } output_r_q0 { I 32 vector } } \
} "
} else {
