...
set C_modelArgList {
	{ left_r float 32 regular {array 7776 { 1 3 } 1 1 }  }
	{ output_r float 32 regular {array 15552 { 0 3 } 0 1 }  }
	{ buffer1_1_24_16x16_p float 32 regular {array 7776 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "left_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "buffer1_1_24_16x16_p", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "buffer1_1_24_16x16_p","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 17,"step" : 1},{"low" : 0,"up" : 17,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ buffer1_1_24_16x16_p_address0 sc_out sc_lv 13 signal 2 } 
	{ buffer1_1_24_16x16_p_ce0 sc_out sc_logic 1 signal 2 } 
	{ buffer1_1_24_16x16_p_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer1_1_24_16x16_p_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "buffer1_1_24_16x16_p", "role": "address0" }} , 
 	...
 	{ "name": "buffer1_1_24_16x16_p_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer1_1_24_16x16_p", "role": "q0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "32929", "Max" : "32929"}
	, {"Name" : "Interval", "Min" : "32929", "Max" : "32929"}
]}
...
set Spec2ImplPortList { 
	...
	buffer1_1_24_16x16_p { ap_memory {  { buffer1_1_24_16x16_p_address0 mem_address 1 13 }  { buffer1_1_24_16x16_p_ce0 mem_ce 1 1 }  { buffer1_1_24_16x16_p_q0 mem_dout 0 32 } } }
}
