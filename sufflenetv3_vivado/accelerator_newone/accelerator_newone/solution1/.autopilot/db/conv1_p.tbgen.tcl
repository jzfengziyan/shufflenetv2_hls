...
set C_modelArgList {
	{ input_r float 32 regular {array 3468 { 1 3 } 1 1 }  }
	{ weight float 32 regular {array 648 { 1 3 } 1 1 }  }
	{ bias float 32 regular {array 24 { 1 3 } 1 1 }  }
	{ output_r float 32 regular {array 27744 { 2 3 } 1 1 }  }
}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9147027", "Max" : "9147027"}
	, {"Name" : "Interval", "Min" : "9147027", "Max" : "9147027"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 15 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
}
