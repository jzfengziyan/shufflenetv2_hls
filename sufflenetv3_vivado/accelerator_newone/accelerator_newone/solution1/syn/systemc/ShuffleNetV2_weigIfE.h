...
#ifndef __ShuffleNetV2_weigIfE_H__
#define __ShuffleNetV2_weigIfE_H__
...
ShuffleNetV2_weigIfE_ram* meminst;


SC_CTOR(ShuffleNetV2_weigIfE) {
meminst = new ShuffleNetV2_weigIfE_ram("ShuffleNetV2_weigIfE_ram");
