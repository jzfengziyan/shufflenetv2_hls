...
wire   [10:0] tmp_3_fu_267_p2;
reg   [10:0] tmp_3_reg_854;
wire   [0:0] exitcond1_fu_222_p2;
wire  signed [10:0] tmp_23_cast_fu_291_p1;
reg  signed [10:0] tmp_23_cast_reg_859;
wire  signed [11:0] tmp_26_cast_fu_301_p1;
reg  signed [11:0] tmp_26_cast_reg_864;
reg   [6:0] bias_V_addr_reg_869;
wire   [3:0] tmp_2_fu_311_p3;
reg   [3:0] tmp_2_reg_877;
wire    ap_CS_fsm_state3;
wire   [0:0] exitcond2_fu_305_p2;
wire   [12:0] tmp_21_fu_348_p2;
reg   [12:0] tmp_21_reg_882;
...
wire   [10:0] tmp_25_fu_401_p2;
reg   [10:0] tmp_25_reg_908;
wire   [0:0] exitcond4_fu_374_p2;
wire   [14:0] tmp_29_fu_455_p2;
reg   [14:0] tmp_29_reg_913;
wire   [12:0] tmp_22_fu_465_p2;
reg   [12:0] tmp_22_reg_918;
...
reg   [1:0] tmp_18_reg_997;
wire   [0:0] p_38_i_i_fu_675_p2;
reg   [0:0] p_38_i_i_reg_1003;
wire    ap_CS_fsm_state10;
wire   [0:0] tmp_19_fu_691_p2;
reg   [0:0] tmp_19_reg_1008;
...
wire   [63:0] tmp_39_cast_fu_497_p1;
wire   [63:0] tmp_40_cast_fu_526_p1;
wire   [63:0] tmp_31_cast_fu_842_p1;
wire   [9:0] tmp_s_fu_243_p3;
wire   [7:0] tmp_1_fu_255_p3;
wire   [10:0] p_shl4_cast_fu_263_p1;
wire   [10:0] p_shl3_cast_fu_251_p1;
wire   [8:0] tmp_9_fu_273_p3;
wire   [9:0] p_shl2_cast_fu_281_p1;
wire   [9:0] tmp_cast_fu_239_p1;
wire   [9:0] tmp_10_fu_285_p2;
wire   [10:0] tmp_12_fu_295_p2;
wire   [11:0] tmp_3_cast_fu_319_p1;
wire   [11:0] tmp_14_fu_323_p2;
wire   [9:0] tmp_20_fu_328_p1;
wire   [12:0] p_shl5_cast_fu_332_p3;
wire   [12:0] p_shl6_cast_fu_340_p3;
wire   [10:0] tmp_1_cast_fu_386_p1;
wire   [10:0] tmp_23_fu_390_p2;
wire   [10:0] tmp_24_fu_395_p2;
wire   [1:0] tmp2_fu_407_p2;
wire  signed [3:0] tmp2_cast_fu_413_p1;
wire   [3:0] tmp_8_fu_417_p2;
wire   [10:0] tmp_cast_17_fu_422_p1;
wire   [10:0] tmp_26_fu_426_p2;
wire   [13:0] tmp_27_fu_431_p3;
wire   [11:0] tmp_28_fu_443_p3;
wire   [14:0] p_shl8_cast_fu_451_p1;
wire   [14:0] p_shl7_cast_fu_439_p1;
wire   [12:0] tmp_9_cast_fu_461_p1;
wire   [10:0] tmp_10_cast_fu_488_p1;
wire   [10:0] tmp_30_fu_492_p2;
wire   [1:0] tmp3_fu_502_p2;
wire  signed [3:0] tmp3_cast_fu_508_p1;
wire   [3:0] tmp_11_fu_512_p2;
wire   [14:0] tmp_12_cast_fu_517_p1;
wire   [14:0] tmp_31_fu_521_p2;
wire  signed [7:0] p_Val2_5_fu_537_p0;
wire  signed [7:0] p_Val2_5_fu_537_p1;
wire   [13:0] tmp_13_fu_551_p3;
wire  signed [15:0] tmp_16_cast_fu_559_p1;
wire   [7:0] p_Val2_7_fu_576_p4;
wire   [7:0] tmp_15_fu_586_p1;
wire   [0:0] tmp_34_fu_589_p3;
wire   [0:0] tmp_16_fu_611_p2;
wire   [0:0] Range1_all_ones_fu_640_p2;
wire   [0:0] Range1_all_zeros_fu_645_p2;
wire   [0:0] tmp_36_fu_633_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_fu_222_p2 == 1'd0))) begin
        ...
        tmp_26_cast_reg_864[11 : 1] <= tmp_26_cast_fu_301_p1[11 : 1];
        tmp_3_reg_854[10 : 1] <= tmp_3_fu_267_p2[10 : 1];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_18_reg_997 <= {{p_Val2_6_fu_563_p2[15:14]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        ...
        newsignbit_1_reg_1046 <= result_V_fu_781_p2[32'd7];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_33_reg_961 <= p_Val2_5_fu_537_p2[32'd5];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond2_fu_305_p2))) begin
        tmp_21_reg_882[12 : 1] <= tmp_21_fu_348_p2[12 : 1];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'd0 == exitcond4_fu_374_p2))) begin
        ...
        tmp_29_reg_913[14 : 1] <= tmp_29_fu_455_p2[14 : 1];
    end
end
...
assign Range1_all_ones_fu_640_p2 = ((tmp_18_reg_997 == 2'd3) ? 1'b1 : 1'b0);

assign Range1_all_zeros_fu_645_p2 = ((tmp_18_reg_997 == 2'd0) ? 1'b1 : 1'b0);
...
assign brmerge9_fu_814_p2 = (newsignbit_1_reg_1046 | isneg_not_fu_809_p2);

assign brmerge_i_i1_fu_686_p2 = (newsignbit_reg_984 | p_not_i_i_fu_680_p2);

assign brmerge_i_i_fu_805_p2 = (isneg_reg_1033 ^ newsignbit_1_reg_1046);

assign brmerge_i_i_i_fu_724_p2 = (underflow_fu_719_p2 | overflow_fu_696_p2);

assign carry_fu_617_p2 = (tmp_34_fu_589_p3 & tmp_16_fu_611_p2);
...
assign input_V_address0 = tmp_40_cast_fu_526_p1;
...
assign output_V_address0 = tmp_31_cast_fu_842_p1;

assign output_V_d0 = ((brmerge9_fu_814_p2[0:0] === 1'b1) ? result_V_mux_fu_819_p3 : p_result_V_fu_826_p3);

assign overflow_fu_696_p2 = (brmerge_i_i1_fu_686_p2 & tmp_19_fu_691_p2);

assign p_38_i_i_fu_675_p2 = (carry_reg_990 & Range1_all_ones_fu_640_p2);

assign p_41_i_i_fu_663_p2 = (signbit_reg_971 & tmp_17_fu_657_p2);

assign p_Val2_2_fu_767_p2 = ($signed(tmp_6_fu_759_p1) + $signed(tmp_7_fu_763_p1));

assign p_Val2_5_fu_537_p0 = weight_V_load_reg_946;

assign p_Val2_5_fu_537_p1 = input_V_load_reg_951;

assign p_Val2_5_fu_537_p2 = ($signed(p_Val2_5_fu_537_p0) * $signed(p_Val2_5_fu_537_p1));

assign p_Val2_6_fu_563_p2 = ($signed(tmp_16_cast_fu_559_p1) + $signed(p_Val2_5_reg_956));

assign p_Val2_7_fu_576_p4 = {{p_Val2_6_fu_563_p2[13:6]}};

assign p_Val2_8_19_fu_745_p3 = ((underflow_reg_1018[0:0] === 1'b1) ? 8'd128 : p_Val2_8_reg_978);

assign p_Val2_8_fu_597_p2 = (p_Val2_7_fu_576_p4 + tmp_15_fu_586_p1);
...
assign p_result_V_fu_826_p3 = ((underflow_1_fu_800_p2[0:0] === 1'b1) ? 8'd128 : result_V_reg_1040);

assign p_shl2_cast_fu_281_p1 = tmp_9_fu_273_p3;

assign p_shl3_cast_fu_251_p1 = tmp_s_fu_243_p3;

assign p_shl4_cast_fu_263_p1 = tmp_1_fu_255_p3;

assign p_shl5_cast_fu_332_p3 = {{tmp_20_fu_328_p1}, {3'd0}};

assign p_shl6_cast_fu_340_p3 = {{tmp_14_fu_323_p2}, {1'd0}};

assign p_shl7_cast_fu_439_p1 = tmp_27_fu_431_p3;

assign p_shl8_cast_fu_451_p1 = tmp_28_fu_443_p3;
...
assign sum_V_fu_751_p3 = ((underflow_not_fu_734_p2[0:0] === 1'b1) ? p_Val2_8_mux_fu_739_p3 : p_Val2_8_19_fu_745_p3);
...
assign tmp5_fu_730_p2 = (brmerge40_demorgan_i_reg_1013 | tmp_19_reg_1008);

assign tmp_10_cast_fu_488_p1 = n_reg_211;

assign tmp_10_fu_285_p2 = (p_shl2_cast_fu_281_p1 - tmp_cast_fu_239_p1);

assign tmp_11_fu_512_p2 = ($signed(tmp3_cast_fu_508_p1) + $signed(tmp_5_reg_890));

assign tmp_12_cast_fu_517_p1 = tmp_11_fu_512_p2;

assign tmp_12_fu_295_p2 = (p_shl3_cast_fu_251_p1 - p_shl4_cast_fu_263_p1);

assign tmp_13_fu_551_p3 = {{p_Val2_4_reg_199}, {6'd0}};

assign tmp_14_fu_323_p2 = ($signed(tmp_26_cast_reg_864) + $signed(tmp_3_cast_fu_319_p1));

assign tmp_15_fu_586_p1 = tmp_33_reg_961;

assign tmp_16_cast_fu_559_p1 = $signed(tmp_13_fu_551_p3);

assign tmp_16_fu_611_p2 = (newsignbit_fu_603_p3 ^ 1'd1);

assign tmp_17_fu_657_p2 = (tmp_36_fu_633_p3 ^ 1'd1);

assign tmp_19_fu_691_p2 = (signbit_reg_971 ^ 1'd1);

assign tmp_1_cast_fu_386_p1 = m_reg_188;

assign tmp_1_fu_255_p3 = {{co_reg_141}, {1'd0}};

assign tmp_20_fu_328_p1 = tmp_14_fu_323_p2[9:0];

assign tmp_21_fu_348_p2 = (p_shl5_cast_fu_332_p3 - p_shl6_cast_fu_340_p3);

assign tmp_22_fu_465_p2 = (tmp_21_reg_882 + tmp_9_cast_fu_461_p1);

assign tmp_23_cast_fu_291_p1 = $signed(tmp_10_fu_285_p2);

assign tmp_23_fu_390_p2 = ($signed(tmp_23_cast_reg_859) + $signed(tmp_1_cast_fu_386_p1));

assign tmp_24_fu_395_p2 = tmp_23_fu_390_p2 << 11'd2;

assign tmp_25_fu_401_p2 = (tmp_24_fu_395_p2 - tmp_23_fu_390_p2);

assign tmp_26_cast_fu_301_p1 = $signed(tmp_12_fu_295_p2);

assign tmp_26_fu_426_p2 = (tmp_3_reg_854 + tmp_cast_17_fu_422_p1);

assign tmp_27_fu_431_p3 = {{tmp_26_fu_426_p2}, {3'd0}};

assign tmp_28_fu_443_p3 = {{tmp_26_fu_426_p2}, {1'd0}};

assign tmp_29_fu_455_p2 = (p_shl8_cast_fu_451_p1 + p_shl7_cast_fu_439_p1);

assign tmp_2_fu_311_p3 = {{h_reg_152}, {1'd0}};

assign tmp_30_fu_492_p2 = (tmp_10_cast_fu_488_p1 + tmp_25_reg_908);

assign tmp_31_cast_fu_842_p1 = tmp_22_reg_918;

assign tmp_31_fu_521_p2 = (tmp_12_cast_fu_517_p1 + tmp_29_reg_913);

assign tmp_34_fu_589_p3 = p_Val2_6_fu_563_p2[32'd13];

assign tmp_36_fu_633_p3 = p_Val2_6_reg_966[32'd14];

assign tmp_39_cast_fu_497_p1 = tmp_30_fu_492_p2;

assign tmp_3_cast_fu_319_p1 = h_reg_152;

assign tmp_3_fu_267_p2 = (p_shl4_cast_fu_263_p1 + p_shl3_cast_fu_251_p1);

assign tmp_40_cast_fu_526_p1 = tmp_31_fu_521_p2;

assign tmp_4_fu_795_p2 = (newsignbit_1_reg_1046 ^ 1'd1);
...
assign tmp_9_cast_fu_461_p1 = w_reg_164;

assign tmp_9_fu_273_p3 = {{co_reg_141}, {2'd0}};

assign tmp_cast_17_fu_422_p1 = tmp_8_fu_417_p2;

assign tmp_cast_fu_239_p1 = co_reg_141;

assign tmp_fu_234_p1 = co_reg_141;

assign tmp_s_fu_243_p3 = {{co_reg_141}, {3'd0}};

assign underflow_1_fu_800_p2 = (isneg_reg_1033 & tmp_4_fu_795_p2);
...
assign weight_V_address0 = tmp_39_cast_fu_497_p1;

always @ (posedge ap_clk) begin
    tmp_3_reg_854[0] <= 1'b0;
    tmp_26_cast_reg_864[0] <= 1'b0;
    tmp_2_reg_877[0] <= 1'b0;
    tmp_21_reg_882[0] <= 1'b0;
    tmp_5_reg_890[0] <= 1'b0;
    tmp_29_reg_913[0] <= 1'b0;
end
