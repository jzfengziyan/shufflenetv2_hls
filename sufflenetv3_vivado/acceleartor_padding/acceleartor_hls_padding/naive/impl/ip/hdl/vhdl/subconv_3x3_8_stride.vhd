...
architecture behav of subconv_3x3_8_stride is 
    ...
    signal tmp_3_fu_267_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_3_reg_854 : STD_LOGIC_VECTOR (10 downto 0);
    signal exitcond1_fu_222_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_23_cast_fu_291_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_23_cast_reg_859 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_26_cast_fu_301_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_26_cast_reg_864 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_21_fu_348_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_21_reg_882 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_25_fu_401_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_25_reg_908 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_22_fu_465_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_22_reg_918 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_18_reg_997 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_19_fu_691_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_19_reg_1008 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_s_fu_243_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_1_fu_255_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl4_cast_fu_263_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_shl3_cast_fu_251_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_9_fu_273_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl2_cast_fu_281_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_cast_fu_239_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_10_fu_285_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_12_fu_295_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_3_cast_fu_319_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_14_fu_323_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_20_fu_328_p1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_23_fu_390_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_24_fu_395_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_cast_17_fu_422_p1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_9_cast_fu_461_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_10_cast_fu_488_p1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_11_fu_512_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_12_cast_fu_517_p1 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal tmp_13_fu_551_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_16_cast_fu_559_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_7_fu_576_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_15_fu_586_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_34_fu_589_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_16_fu_611_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_8_19_fu_745_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_4_fu_795_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond1_fu_222_p2 = ap_const_lv1_0))) then
                ...
                tmp_23_cast_reg_859 <= tmp_23_cast_fu_291_p1;
                    tmp_26_cast_reg_864(11 downto 1) <= tmp_26_cast_fu_301_p1(11 downto 1);
                    tmp_3_reg_854(10 downto 1) <= tmp_3_fu_267_p2(10 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                ...
                tmp_19_reg_1008 <= tmp_19_fu_691_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then
                ...
                tmp_18_reg_997 <= p_Val2_6_fu_563_p2(15 downto 14);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_lv1_0 = exitcond2_fu_305_p2))) then
                    tmp_21_reg_882(12 downto 1) <= tmp_21_fu_348_p2(12 downto 1);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (ap_const_lv1_1 = exitcond4_fu_374_p2))) then
                tmp_22_reg_918 <= tmp_22_fu_465_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (ap_const_lv1_0 = exitcond4_fu_374_p2))) then
                tmp_25_reg_908 <= tmp_25_fu_401_p2;
    ...
    Range1_all_ones_fu_640_p2 <= "1" when (tmp_18_reg_997 = ap_const_lv2_3) else "0";
    Range1_all_zeros_fu_645_p2 <= "1" when (tmp_18_reg_997 = ap_const_lv2_0) else "0";
    ...
    carry_fu_617_p2 <= (tmp_34_fu_589_p3 and tmp_16_fu_611_p2);
    ...
    input_V_address0 <= tmp_40_cast_fu_526_p1(14 - 1 downto 0);
    ...
    overflow_fu_696_p2 <= (brmerge_i_i1_fu_686_p2 and tmp_19_fu_691_p2);
    p_38_i_i_fu_675_p2 <= (carry_reg_990 and Range1_all_ones_fu_640_p2);
    p_41_i_i_fu_663_p2 <= (signbit_reg_971 and tmp_17_fu_657_p2);
    ...
    p_Val2_5_fu_537_p1 <= input_V_load_reg_951;
    ...
    p_Val2_6_fu_563_p2 <= std_logic_vector(signed(tmp_16_cast_fu_559_p1) + signed(p_Val2_5_reg_956));
    p_Val2_7_fu_576_p4 <= p_Val2_6_fu_563_p2(13 downto 6);
    p_Val2_8_19_fu_745_p3 <= 
        ap_const_lv8_80 when (underflow_reg_1018(0) = '1') else 
        p_Val2_8_reg_978;
    p_Val2_8_fu_597_p2 <= std_logic_vector(unsigned(p_Val2_7_fu_576_p4) + unsigned(tmp_15_fu_586_p1));
    ...
    p_result_V_fu_826_p3 <= 
        ...
        result_V_reg_1040;
    p_shl2_cast_fu_281_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_9_fu_273_p3),10));
    p_shl3_cast_fu_251_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_243_p3),11));
    p_shl4_cast_fu_263_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_255_p3),11));
    p_shl5_cast_fu_332_p3 <= (tmp_20_fu_328_p1 & ap_const_lv3_0);
    p_shl6_cast_fu_340_p3 <= (tmp_14_fu_323_p2 & ap_const_lv1_0);
    ...
    tmp5_fu_730_p2 <= (brmerge40_demorgan_i_reg_1013 or tmp_19_reg_1008);
    tmp_10_cast_fu_488_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n_reg_211),11));
    tmp_10_fu_285_p2 <= std_logic_vector(unsigned(p_shl2_cast_fu_281_p1) - unsigned(tmp_cast_fu_239_p1));
    tmp_11_fu_512_p2 <= std_logic_vector(signed(tmp3_cast_fu_508_p1) + signed(tmp_5_reg_890));
    tmp_12_cast_fu_517_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_fu_512_p2),15));
    tmp_12_fu_295_p2 <= std_logic_vector(unsigned(p_shl3_cast_fu_251_p1) - unsigned(p_shl4_cast_fu_263_p1));
    tmp_13_fu_551_p3 <= (p_Val2_4_reg_199 & ap_const_lv6_0);
    tmp_14_fu_323_p2 <= std_logic_vector(signed(tmp_26_cast_reg_864) + signed(tmp_3_cast_fu_319_p1));
    tmp_15_fu_586_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_33_reg_961),8));
        tmp_16_cast_fu_559_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_13_fu_551_p3),16));

    tmp_16_fu_611_p2 <= (newsignbit_fu_603_p3 xor ap_const_lv1_1);
    tmp_17_fu_657_p2 <= (tmp_36_fu_633_p3 xor ap_const_lv1_1);
    tmp_19_fu_691_p2 <= (signbit_reg_971 xor ap_const_lv1_1);
    tmp_1_cast_fu_386_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(m_reg_188),11));
    tmp_1_fu_255_p3 <= (co_reg_141 & ap_const_lv1_0);
    tmp_20_fu_328_p1 <= tmp_14_fu_323_p2(10 - 1 downto 0);
    tmp_21_fu_348_p2 <= std_logic_vector(unsigned(p_shl5_cast_fu_332_p3) - unsigned(p_shl6_cast_fu_340_p3));
    tmp_22_fu_465_p2 <= std_logic_vector(unsigned(tmp_21_reg_882) + unsigned(tmp_9_cast_fu_461_p1));
        tmp_23_cast_fu_291_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_10_fu_285_p2),11));

    tmp_23_fu_390_p2 <= std_logic_vector(signed(tmp_23_cast_reg_859) + signed(tmp_1_cast_fu_386_p1));
    tmp_24_fu_395_p2 <= std_logic_vector(shift_left(unsigned(tmp_23_fu_390_p2),to_integer(unsigned('0' & ap_const_lv11_2(11-1 downto 0)))));
    tmp_25_fu_401_p2 <= std_logic_vector(unsigned(tmp_24_fu_395_p2) - unsigned(tmp_23_fu_390_p2));
        tmp_26_cast_fu_301_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_12_fu_295_p2),12));

    tmp_26_fu_426_p2 <= std_logic_vector(unsigned(tmp_3_reg_854) + unsigned(tmp_cast_17_fu_422_p1));
    ...
    tmp_30_fu_492_p2 <= std_logic_vector(unsigned(tmp_10_cast_fu_488_p1) + unsigned(tmp_25_reg_908));
    tmp_31_cast_fu_842_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_22_reg_918),64));
    tmp_31_fu_521_p2 <= std_logic_vector(unsigned(tmp_12_cast_fu_517_p1) + unsigned(tmp_29_reg_913));
    ...
    tmp_3_fu_267_p2 <= std_logic_vector(unsigned(p_shl4_cast_fu_263_p1) + unsigned(p_shl3_cast_fu_251_p1));
    tmp_40_cast_fu_526_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_31_fu_521_p2),64));
    tmp_4_fu_795_p2 <= (newsignbit_1_reg_1046 xor ap_const_lv1_1);
    ...
    tmp_9_cast_fu_461_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(w_reg_164),13));
    tmp_9_fu_273_p3 <= (co_reg_141 & ap_const_lv2_0);
    tmp_cast_17_fu_422_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_417_p2),11));
    ...
    tmp_s_fu_243_p3 <= (co_reg_141 & ap_const_lv3_0);
    underflow_1_fu_800_p2 <= (isneg_reg_1033 and tmp_4_fu_795_p2);
