...
set C_modelArgList {
	{ right_r float 32 regular {array 7776 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ right_r_address0 sc_out sc_lv 13 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "right_r_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "right_r", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	right_r { ap_memory {  { right_r_address0 mem_address 1 13 }  { right_r_ce0 mem_ce 1 1 }  { right_r_q0 mem_dout 0 32 } } }
