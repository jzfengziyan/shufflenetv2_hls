...
set C_modelArgList {
	...
	{ conv_last_output_V int 8 regular {array 8192 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv_last_output_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "conv_last_output.V","cData": "int8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 511,"step" : 1},{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 3,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ conv_last_output_V_address0 sc_out sc_lv 13 signal 1 } 
	{ conv_last_output_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ conv_last_output_V_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_last_output_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv_last_output_V", "role": "address0" }} , 
 	{ "name": "conv_last_output_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv_last_output_V", "role": "ce0" }} , 
 	{ "name": "conv_last_output_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "conv_last_output_V", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	conv_last_output_V { ap_memory {  { conv_last_output_V_address0 mem_address 1 13 }  { conv_last_output_V_ce0 mem_ce 1 1 }  { conv_last_output_V_q0 mem_dout 0 8 } } }
}
