...
set C_modelArgList {
	{ weight_V int 8 regular {array 576 { 1 3 } 1 1 }  }
	{ bias_V int 8 regular {array 24 { 1 3 } 1 1 }  }
	{ conv1_output_p_V int 8 regular {array 27744 { 1 3 } 1 1 } {global 0}  }
	{ ShuffleConvs_0_Downs int 8 regular {array 27744 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_0_Downs", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "ShuffleConvs_0_DownsampleUnit__conv1r_output_p.V","cData": "int8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 33,"step" : 1},{"low" : 0,"up" : 33,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ conv1_output_p_V_address0 sc_out sc_lv 15 signal 2 } 
	{ conv1_output_p_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv1_output_p_V_q0 sc_in sc_lv 8 signal 2 } 
	...
	{ ShuffleConvs_0_Downs_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4253233", "Max" : "4253233"}
	, {"Name" : "Interval", "Min" : "4253233", "Max" : "4253233"}
]}
...
set Spec2ImplPortList { 
	...
	ShuffleConvs_0_Downs { ap_memory {  { ShuffleConvs_0_Downs_address0 mem_address 1 15 }  { ShuffleConvs_0_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_0_Downs_we0 mem_we 1 1 }  { ShuffleConvs_0_Downs_d0 mem_din 1 8 } } }
}
