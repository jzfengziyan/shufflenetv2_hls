...
set C_modelArgList {
	{ weight_V int 8 regular {array 9216 { 1 3 } 1 1 }  }
	{ bias_V int 8 regular {array 96 { 1 3 } 1 1 }  }
	{ shuffleunit1_7_outpu int 8 regular {array 9600 { 1 3 } 1 1 } {global 0}  }
	{ ShuffleConvs_2_Downs int 8 regular {array 9600 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_2_Downs", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "ShuffleConvs_2_DownsampleUnit__conv1r_output_p.V","cData": "int8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 95,"step" : 1},{"low" : 0,"up" : 9,"step" : 1},{"low" : 0,"up" : 9,"step" : 1}]}]}], "extern" : 0} ]}
...
set portList { 
	...
	{ weight_V_address0 sc_out sc_lv 14 signal 0 } 
	...
	{ shuffleunit1_7_outpu_address0 sc_out sc_lv 14 signal 2 } 
	{ shuffleunit1_7_outpu_ce0 sc_out sc_logic 1 signal 2 } 
	{ shuffleunit1_7_outpu_q0 sc_in sc_lv 8 signal 2 } 
	{ ShuffleConvs_2_Downs_address0 sc_out sc_lv 14 signal 3 } 
	{ ShuffleConvs_2_Downs_ce0 sc_out sc_logic 1 signal 3 } 
	{ ShuffleConvs_2_Downs_we0 sc_out sc_logic 1 signal 3 } 
	{ ShuffleConvs_2_Downs_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "weight_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4161217", "Max" : "4161217"}
	, {"Name" : "Interval", "Min" : "4161217", "Max" : "4161217"}
]}
...
set Spec2ImplPortList { 
	weight_V { ap_memory {  { weight_V_address0 mem_address 1 14 }  { weight_V_ce0 mem_ce 1 1 }  { weight_V_q0 mem_dout 0 8 } } }
	...
	ShuffleConvs_2_Downs { ap_memory {  { ShuffleConvs_2_Downs_address0 mem_address 1 14 }  { ShuffleConvs_2_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_2_Downs_we0 mem_we 1 1 }  { ShuffleConvs_2_Downs_d0 mem_din 1 8 } } }
}
