...
set C_modelArgList {
	...
	{ ShuffleConvs_2_Downs float 32 regular {array 9600 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ShuffleConvs_2_Downs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ShuffleConvs_2_DownsampleUnit__conv1r_output_p","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1},{"low" : 0,"up" : 95,"step" : 1},{"low" : 0,"up" : 9,"step" : 1},{"low" : 0,"up" : 9,"step" : 1}]}]}], "extern" : 0} ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7141057", "Max" : "7141057"}
	, {"Name" : "Interval", "Min" : "7141057", "Max" : "7141057"}
]}
...
set Spec2ImplPortList { 
	...
	ShuffleConvs_2_Downs { ap_memory {  { ShuffleConvs_2_Downs_address0 mem_address 1 14 }  { ShuffleConvs_2_Downs_ce0 mem_ce 1 1 }  { ShuffleConvs_2_Downs_we0 mem_we 1 1 }  { ShuffleConvs_2_Downs_d0 mem_din 1 32 } } }
}
