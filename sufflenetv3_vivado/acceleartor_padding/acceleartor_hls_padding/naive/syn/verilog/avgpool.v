...
wire   [12:0] tmp_449_cast_fu_150_p1;
reg   [12:0] tmp_449_cast_reg_222;
wire   [2:0] h_24_fu_160_p2;
reg   [2:0] h_24_reg_230;
wire    ap_CS_fsm_state3;
wire   [14:0] tmp_452_cast_fu_175_p3;
reg   [14:0] tmp_452_cast_reg_235;
...
reg   [2:0] w_reg_104;
wire   [63:0] tmp_453_cast_fu_204_p1;
wire    ap_CS_fsm_state6;
wire   [11:0] tmp_311_fu_142_p3;
wire   [12:0] tmp_94_cast_fu_166_p1;
wire   [12:0] tmp_312_fu_170_p2;
wire   [14:0] tmp_95_cast_fu_195_p1;
wire   [14:0] tmp_313_fu_199_p2;
reg   [13:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond2_fu_126_p2 == 1'd0))) begin
        tmp_449_cast_reg_222[11 : 2] <= tmp_449_cast_fu_150_p1[11 : 2];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond1_fu_154_p2))) begin
        tmp_452_cast_reg_235[14 : 2] <= tmp_452_cast_fu_175_p3[14 : 2];
    end
end
...
assign conv_last_output_address0 = tmp_453_cast_fu_204_p1;
...
assign tmp_311_fu_142_p3 = {{co_reg_58}, {2'd0}};

assign tmp_312_fu_170_p2 = (tmp_94_cast_fu_166_p1 + tmp_449_cast_reg_222);

assign tmp_313_fu_199_p2 = (tmp_452_cast_reg_235 + tmp_95_cast_fu_195_p1);

assign tmp_449_cast_fu_150_p1 = tmp_311_fu_142_p3;

assign tmp_452_cast_fu_175_p3 = {{tmp_312_fu_170_p2}, {2'd0}};

assign tmp_453_cast_fu_204_p1 = tmp_313_fu_199_p2;

assign tmp_94_cast_fu_166_p1 = h_reg_81;

assign tmp_95_cast_fu_195_p1 = w_reg_104;
...
always @ (posedge ap_clk) begin
    ...
    tmp_449_cast_reg_222[1:0] <= 2'b00;
    tmp_449_cast_reg_222[12] <= 1'b0;
    tmp_452_cast_reg_235[1:0] <= 2'b00;
end
