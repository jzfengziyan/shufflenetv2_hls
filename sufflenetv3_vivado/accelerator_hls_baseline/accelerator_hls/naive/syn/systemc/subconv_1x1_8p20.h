...
#ifndef _subconv_1x1_8p20_HH_
#define _subconv_1x1_8p20_HH_
...
struct subconv_1x1_8p20 : public sc_module {
    ...
    // Module declarations
    subconv_1x1_8p20(sc_module_name name);
    SC_HAS_PROCESS(subconv_1x1_8p20);

    ~subconv_1x1_8p20();

    sc_trace_file* mVcdFile;

    ShuffleNetV2_faddbkb<1,5,32,32,32>* ShuffleNetV2_faddbkb_x_U110;
    ShuffleNetV2_fmulcud<1,4,32,32,32>* ShuffleNetV2_fmulcud_x_U111;
    ShuffleNetV2_fcmpdEe<1,1,32,32,1>* ShuffleNetV2_fcmpdEe_x_U112;
    ...
    sc_signal< sc_lv<13> > output_addr_reg_445;
