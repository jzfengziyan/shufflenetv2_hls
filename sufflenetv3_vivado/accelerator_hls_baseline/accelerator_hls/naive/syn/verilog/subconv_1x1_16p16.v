...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (1'd0 == exitcond1_fu_244_p2))) begin
        output_addr_reg_433 <= tmp_194_cast_fu_265_p1;
...
assign output_r_address0 = output_addr_reg_433;

assign output_r_d0 = ((tmp_25_fu_366_p2[0:0] === 1'b1) ? result_reg_481 : 32'd0);
