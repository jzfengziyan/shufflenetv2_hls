...
reg   [11:0] output_0_addr_reg_443;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (1'd0 == exitcond1_fu_254_p2))) begin
        output_0_addr_reg_443 <= tmp_146_cast_fu_275_p1;
...
assign input_0_address0 = tmp_152_cast_fu_326_p1;

assign notlhs_fu_358_p2 = ((tmp_6_fu_344_p4 != 8'd255) ? 1'b1 : 1'b0);

assign notrhs_fu_364_p2 = ((tmp_89_fu_354_p1 == 23'd0) ? 1'b1 : 1'b0);

assign output_0_address0 = output_0_addr_reg_443;

assign output_0_d0 = ((tmp_10_fu_376_p2[0:0] === 1'b1) ? result_reg_491 : 32'd0);
