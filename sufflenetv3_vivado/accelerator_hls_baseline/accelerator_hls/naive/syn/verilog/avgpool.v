...
wire   [9:0] co_18_fu_132_p2;
reg   [9:0] co_18_reg_212;
wire    ap_CS_fsm_state2;
wire   [63:0] tmp_fu_138_p1;
reg   [63:0] tmp_reg_217;
wire   [0:0] exitcond2_fu_126_p2;
wire   [12:0] tmp_292_cast_fu_150_p1;
reg   [12:0] tmp_292_cast_reg_222;
wire   [2:0] h_18_fu_160_p2;
reg   [2:0] h_18_reg_230;
wire    ap_CS_fsm_state3;
wire   [14:0] tmp_295_cast_fu_175_p3;
reg   [14:0] tmp_295_cast_reg_235;
wire   [0:0] exitcond1_fu_154_p2;
wire   [2:0] w_18_fu_189_p2;
reg   [2:0] w_18_reg_243;
...
reg   [2:0] w_reg_104;
wire   [63:0] tmp_296_cast_fu_204_p1;
wire    ap_CS_fsm_state6;
wire   [11:0] tmp_177_fu_142_p3;
wire   [12:0] tmp_117_cast_fu_166_p1;
wire   [12:0] tmp_178_fu_170_p2;
wire   [14:0] tmp_118_cast_fu_195_p1;
wire   [14:0] tmp_179_fu_199_p2;
reg   [13:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond2_fu_126_p2 == 1'd0))) begin
        tmp_292_cast_reg_222[11 : 2] <= tmp_292_cast_fu_150_p1[11 : 2];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == exitcond1_fu_154_p2))) begin
        tmp_295_cast_reg_235[14 : 2] <= tmp_295_cast_fu_175_p3[14 : 2];
    end
end
...
assign co_18_fu_132_p2 = (co_reg_58 + 10'd1);

assign conv_last_output_address0 = tmp_296_cast_fu_204_p1;
...
assign h_18_fu_160_p2 = (h_reg_81 + 3'd1);

assign output_r_address0 = tmp_reg_217;

assign output_r_d0 = tmp_s_reg_263;

assign tmp_117_cast_fu_166_p1 = h_reg_81;

assign tmp_118_cast_fu_195_p1 = w_reg_104;

assign tmp_177_fu_142_p3 = {{co_reg_58}, {2'd0}};

assign tmp_178_fu_170_p2 = (tmp_117_cast_fu_166_p1 + tmp_292_cast_reg_222);

assign tmp_179_fu_199_p2 = (tmp_295_cast_reg_235 + tmp_118_cast_fu_195_p1);

assign tmp_292_cast_fu_150_p1 = tmp_177_fu_142_p3;

assign tmp_295_cast_fu_175_p3 = {{tmp_178_fu_170_p2}, {2'd0}};

assign tmp_296_cast_fu_204_p1 = tmp_179_fu_199_p2;

assign tmp_fu_138_p1 = co_reg_58;

assign w_18_fu_189_p2 = (w_reg_104 + 3'd1);

always @ (posedge ap_clk) begin
    tmp_reg_217[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    tmp_292_cast_reg_222[1:0] <= 2'b00;
    tmp_292_cast_reg_222[12] <= 1'b0;
    tmp_295_cast_reg_235[1:0] <= 2'b00;
end
