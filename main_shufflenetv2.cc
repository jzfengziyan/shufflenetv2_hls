...
*/
//---------------new parse parameters
int parse_shufflenetv2_parameters(char* filename)
{
	FRESULT Res;
	UINT NumBytesRead;
    SD_File = (char *)filename;
...
//--------------begin to read parameters----------------------
	...
	Res = f_read(&fil, (void*)conv1_bias, 24*sizeof(float), &NumBytesRead);
	if (Res)
	{
		xil_printf("Cant read conv1_bias from file\n\r");
		return XST_FAILURE;
	...
	Res = f_read(&fil, (void*)***ShuffleConvs_0_DownsampleUnit_conv1r_weight, 24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_DownsampleUnit_conv1r_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_DownsampleUnit_conv2r_weight, 24*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_DownsampleUnit_conv2r_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_DownsampleUnit_conv3r_weight, 24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_DownsampleUnit_conv3r_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_DownsampleUnit_conv1l_weight, 24*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_DownsampleUnit_conv1l_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_DownsampleUnit_conv2l_weight, 24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_DownsampleUnit_conv2l_bias, 24*sizeof(float), &NumBytesRead);

	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_0_conv1_weight, 24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_0_conv1_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_0_conv2_weight, 24*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_0_conv2_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_0_conv3_weight,  24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_0_conv3_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_1_conv1_weight, 24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_1_conv1_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_1_conv2_weight, 24*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_1_conv2_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_1_conv3_weight,  24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_1_conv3_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_2_conv1_weight, 24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_2_conv1_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_2_conv2_weight, 24*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_2_conv2_bias, 24*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_0_ShuffleUnit0_2_conv3_weight,  24*24*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_0_ShuffleUnit0_2_conv3_bias, 24*sizeof(float), &NumBytesRead);

	Res = f_read(&fil, (void*)***ShuffleConvs_1_DownsampleUnit_conv1r_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_DownsampleUnit_conv1r_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_DownsampleUnit_conv2r_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_DownsampleUnit_conv2r_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_DownsampleUnit_conv3r_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_DownsampleUnit_conv3r_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_DownsampleUnit_conv1l_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_DownsampleUnit_conv1l_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_DownsampleUnit_conv2l_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_DownsampleUnit_conv2l_bias, 48*sizeof(float), &NumBytesRead);

	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_0_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_0_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_0_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_0_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_0_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_0_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_1_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_1_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_1_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_1_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_1_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_1_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_2_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_2_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_2_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_2_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_2_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_2_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_3_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_3_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_3_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_3_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_3_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_3_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_4_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_4_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_4_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_4_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_4_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_4_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_5_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_5_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_5_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_5_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_5_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_5_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_6_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_6_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_6_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_6_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_6_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_6_conv3_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_7_conv1_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_7_conv1_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_7_conv2_weight,  48*1*3*3*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_7_conv2_bias, 48*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)***ShuffleConvs_1_ShuffleUnit1_7_conv3_weight,  48*48*1*1*sizeof(float), &NumBytesRead);
	Res = f_read(&fil, (void*)ShuffleConvs_1_ShuffleUnit1_7_conv3_bias, 48*sizeof(float), &NumBytesRead);
